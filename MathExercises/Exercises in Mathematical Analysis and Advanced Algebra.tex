...
使得成立$\left| f\left( x \right) \right|\leqslant slant a\left| x \right|+b$.
\end{proposition}
...
\begin{example}
设$f$在$\left[ 0,+\infty \right)$的任意闭区间上Riemann可积.对于$x\geqslant slant 0$,定义$F\left( x \right) =\int_0^x{t^{\alpha}}f\left( t+x \right) \mathrm{d}t$.
\begin{enumerate}[(1)]
...
\end{example}
\begin{note}
本题(1)中的$\lim_{x\rightarrow +\infty} f\left( x \right) =A$可以削弱为$\exists M>0,\left| f\left( x \right) \right|\leqslant slant M,x\in \left[ 0,+\infty \right) $.
\end{note}

\begin{proof}
(1)
由于$\lim_{x\rightarrow +\infty} f\left( x \right) =A$,所以
$\exists M>0,\left| f\left( x \right) \right|\leqslant slant M,x\in \left[ 0,+\infty \right) $.

取$\delta =\left[ \frac{\left( \alpha +1 \right) \varepsilon}{3M} \right] ^{\frac{1}{\alpha +1}}$
,任取$y>x \geqslant slant 0$,且$\left| y-x \right|<\delta $有
\begin{align}
...
\\
&\leqslant slant \left| \int_y^{2y}{\left( t-y \right) ^{\alpha}}f\left( t \right) \mathrm{d}t-\int_y^{2y}{\left( t-x \right) ^{\alpha}}f\left( t \right) \mathrm{d}t+\int_y^{2y}{\left( t-x \right) ^{\alpha}}f\left( t \right) \mathrm{d}t-\int_x^{2x}{\left( t-x \right) ^{\alpha}}f\left( t \right) \mathrm{d}t \right| \nonumber
\\
&\leqslant slant \left| \int_y^{2y}{\left( t-y \right) ^{\alpha}}f\left( t \right) \mathrm{d}t-\int_y^{2y}{\left( t-x \right) ^{\alpha}}f\left( t \right) \mathrm{d}t \right|+\left| \int_y^{2y}{\left( t-x \right) ^{\alpha}}f\left( t \right) \mathrm{d}t-\int_x^{2x}{\left( t-x \right) ^{\alpha}}f\left( t \right) \mathrm{d}t \right| \nonumber
\\
&\leqslant slant M\int_y^{2y}{\left| \left( t-y \right) ^{\alpha}-\left( t-x \right) ^{\alpha} \right|}\mathrm{d}t+\left| \int_{2x}^{2y}{\left( t-x \right) ^{\alpha}}f\left( t \right) \mathrm{d}t-\int_x^y{\left( t-x \right) ^{\alpha}}f\left( t \right) \mathrm{d}t \right| \nonumber
\\
&\leqslant slant M\int_y^{2y}{\left[ \left( t-y \right) ^{\alpha}-\left( t-x \right) ^{\alpha} \right]}\mathrm{d}t+M\left| \int_{2x}^{2y}{\left( t-x \right) ^{\alpha}}\mathrm{d}t \right|+M\left| \int_x^y{\left( t-x \right) ^{\alpha}}\mathrm{d}t \right| \nonumber
\\
&\leqslant slant M\int_y^{2y}{\left[ \left( t-y \right) ^{\alpha}-\left( t-x \right) ^{\alpha} \right]}\mathrm{d}t+M\int_x^{2y-x}{t^{\alpha}}\mathrm{d}t+M\int_0^{y-x}{t^{\alpha}}\mathrm{d}t \nonumber
\\
...
\\
&\leqslant slant \frac{3M}{\alpha +1}\left( y-x \right) ^{\alpha +1}<\frac{3M}{\alpha +1}\delta ^{\alpha +1}<\varepsilon  \nonumber
\end{align}
...
使得$M=G\left( 2x_2 \right) \geqslant slant G\left( 2x \right) ,x\in \left[ 0,\frac{T}{2} \right] $.

又因为$G(3)=\int_0^3{f\left( t \right) \mathrm{d}t}=2022$,且$G(2x)$以$\frac{T}{2}$为周期
,所以存在$x_1\in \left[ 0,\frac{T}{2} \right] $,使得$G(2x_1)=G(3)>0$.

因此,$M=G{\left( 2x_2 \right)}\geqslant slant G(2x_1)=G\left( 3 \right) =\int_0^3{f\left( t \right) \mathrm{d}t}>0$.
...
都有$\left| G\left( 2x_0 \right) -G\left( 2x'_{\delta'} \right) \right|\geqslant slant \varepsilon _0$.
...
K\leqslant slant \left| f\left( \xi _n \right) \right|\leqslant slant L
\end{equation}
...
\begin{equation}
\begin{split}
\frac{2\alpha}{n^{\frac{\alpha}{2}}}\left( x_0+n\frac{T}{2} \right) ^{\alpha -1}\leqslant slant \frac{2\alpha}{n^{\frac{\alpha}{2}}}{\xi _n}^{\alpha -1}\leqslant slant \frac{2\alpha}{n^{\frac{\alpha}{2}}}\left( x_0+n\frac{T}{2}+\frac{2}{n^{\frac{\alpha}{2}}} \right) ^{\alpha -1}
\end{split}
\nonumber
\end{equation}
...
\\
&\geqslant slant \left| \left( x_0+n\frac{T}{2}+\frac{2}{n^{\frac{\alpha}{2}}} \right) ^{\alpha}\int_{2\left( x_0+n\frac{T}{2} \right)}^{2\left( x_0+n\frac{T}{2}+\frac{2}{n^{\frac{\alpha}{2}}} \right)}{f\left( y \right) dy} \right|-\left| \left[ \left( x_0+n\frac{T}{2} \right) ^{\alpha}-\left( x_0+n\frac{T}{2}+\frac{2}{n^{\frac{\alpha}{2}}} \right) ^{\alpha} \right] \int_0^{2\left( x_0+n\frac{T}{2} \right)}{f\left( y \right) dy} \right|
\\
...
\\
&\geqslant slant 2\left( \frac{T}{2} \right) ^{\alpha}\left|f\left( \xi _n \right)\right| \cdot n^{\frac{\alpha}{2}}-\varepsilon 
\\
&\geqslant slant 2\left( \frac{T}{2} \right) ^{\alpha}K\cdot n^{\frac{\alpha}{2}}-\varepsilon 
\\
...
且$\int_0^{\infty}{f\left( x \right) \mathrm{d}x}\leqslant slant \frac{\left( \int_0^{+\infty}{\sqrt{\frac{f\left( x \right)}{x}}\mathrm{d}x} \right) ^2}{2}.$
\begin{proof}
...
$\forall \varepsilon>0,\exists M\geqslant slant 0,s.t. \forall A>4M,\text{有}
...
利用$f$的单调性知:$\forall x \geqslant slant 0$有
\begin{equation}
\begin{split}
\int_0^{+\infty}{\sqrt{\frac{f(x)}{x}}\mathrm{d}x}\geqslant slant \int_0^x{\sqrt{\frac{f(t)}{t}}\mathrm{d}t}\geqslant slant \sqrt{\frac{f(x)}{x}}\int_0^x{1\mathrm{d}t}=\sqrt{xf\left( x \right)}
\end{split}
\nonumber
\end{equation}
...
\begin{equation}
\begin{split}
&\int_0^{+\infty}{f\left( x \right) \mathrm{d}x=}\int_0^{+\infty}{\sqrt{xf\left( x \right)}\cdot \sqrt{\frac{f\left( x \right)}{x}}\mathrm{d}x}\leqslant slant \int_0^{+\infty}{\left( \int_0^x{\sqrt{\frac{f\left( t \right)}{t}}\mathrm{d}t} \right) \sqrt{\frac{f\left( x \right)}{x}}\mathrm{d}x}
\\
...
时总是成立
\begin{equation}
\left| f^{\prime}\left( x \right) \right|\leqslant slant \left| f\left( x \right) \right|\left| \ln f\left( x \right) \right|
\nonumber
\end{equation}
证明:$f(x)$恒为零.
\end{example}
...
\begin{align*}
\left( \beta -\alpha \right) \int_{\alpha}^1{f(x)\mathrm{d}x}=\int_{\alpha}^1{f(x)\mathrm{d}x\int_{\alpha}^1{\chi _{\left[ \alpha ,1 \right]}\left( x \right) \mathrm{d}x}}\geqslant slant \left( 1-\alpha \right) \int_{\alpha}^1{f\left( x \right) \chi _{\left[ \alpha ,1 \right]}\left( x \right) \mathrm{d}x}=\left( 1-\alpha \right) \int_{\alpha}^{\beta}{f\left( x \right) \mathrm{d}x}.
\nonumber
\end{align*}
从而
\begin{align*}
\int_{\alpha}^1{f(x)\mathrm{d}x}\geqslant slant \frac{1-\alpha}{\beta -\alpha}\int_{\alpha}^{\beta}{f\left( x \right) \mathrm{d}x}.
\nonumber
\end{align*}
于是
\begin{align*}
\int_0^1{f(x)\mathrm{d}x}\geqslant slant \int_{\alpha}^1{f(x)\mathrm{d}x}\geqslant slant \frac{1-\alpha}{\beta -\alpha}\int_{\alpha}^{\beta}{f\left( x \right) \mathrm{d}x}.
\nonumber
\end{align*}
\end{proof}
\begin{remark}
...
\begin{align*}
\left| \int_0^x{t^n\sin \left( \pi t \right) \mathrm{d}t} \right|=\int_0^x{t^n\sin \left( \pi t \right) \mathrm{d}t}\leqslant slant \int_0^1{t^n\sin \left( \pi t \right) \mathrm{d}t}\leqslant slant \int_0^1{t^n\mathrm{d}t}=\frac{1}{n+1}.
\end{align*}
...
{\color{blue}\text{证法一:}}
注意到\begin{align*}
\int_0^1{t^n\sin \left( \pi t \right) \mathrm{d}t}=\int_0^1{ \left( t^n-t^{n+1} \right) \cdot \frac{\sin \left( \pi t \right)}{1-t}  \mathrm{d}t}\leqslant slant M\int_0^1{\left( t^n-t^{n+1} \right)}\mathrm{d}t=M\left( \frac{1}{n+1}-\frac{1}{n+2} \right) =\frac{M}{\left( n+1 \right) \left( n+2 \right)}
\end{align*}
其中$M=\underset{t\in \left[ 0,1 \right]}{\mathrm{sup}}\frac{\sin \left( \pi t \right)}{1-t}$.

从而对$\forall x\in[0,1]$,有\begin{align*}
\left| \int_0^x{t^n\sin \left( \pi t \right) \mathrm{d}t} \right|=\int_0^x{t^n\sin \left( \pi t \right) \mathrm{d}t}\leqslant slant \int_0^1{t^n\sin \left( \pi t \right) \mathrm{d}t}\leqslant slant \frac{M}{\left( n+1 \right) \left( n+2 \right)}.
\end{align*}
...
\end{example}
\begin{proof}
若数列\(\{ na_n\}\)单调递增,则对\(\forall n \in \mathbb{N}_+\),都有\(na_n \geqslant slant a_1\).从而
\(a_n \geqslant slant \frac{a_1}{n}\),\(\forall n \in \mathbb{N}_+\).
...
\begin{align*}
&0 \leqslant slant na_n\ln n < na_n\ln\frac{n}{\sqrt{n}} < na_n\int_{m}^{n}\frac{1}{x}\mathrm{d}x<na_n\ln \frac{n}{m} \\
&= na_n\sum_{k = m}^{n}\int_{k}^{k + 1}\frac{1}{x}\mathrm{d}x \leqslant slant na_n\sum_{k = m}^{n}\int_{k}^{k + 1}\frac{1}{k}\mathrm{d}x\\
&= na_n\sum_{k = m}^{n}\frac{1}{k} \leqslant slant \sum_{k = m}^{n}ka_k\cdot\frac{1}{k} = \sum_{k = m}^{n}a_k < \varepsilon
\end{align*}
...
若\(F\)在\([0,1]\)取得正的最大值,最大值点为\(a\),则由\(F(0) = F(1) = 0\),可知\(a \in (0,1)\).并且\(F^{\prime}(a) = 0\),\(F^{\prime\prime}(a) \leqslant slant 0\).于是
\begin{align*}
0 < F(a) = F^{\prime\prime}(a) + F^{\prime}(a)\tan a = F^{\prime\prime}(a) \leqslant slant 0.
\end{align*}
这就是矛盾！从而\(F\)在\([0,1]\)没有正的最大值.类似的可以讨论最小值,得到\(F\)在\([0,1]\)没有负的最小值.因此\(0 \leqslant slant F(x) \leqslant slant 0\),\(\forall x \in [0,1]\).即\(F(x) \equiv 0\),\(\forall x \in [0,1]\).故\(f\)在\([0,1]\)上恒为\(0\). 
\end{proof}
...
\begin{align*}
\frac{a_n}{n}=\frac{a_{kq+r}}{n}\leqslant slant \frac{a_{kq}+a_r}{n}\leqslant slant \frac{a_{k\left( q-1 \right)}+a_k}{kq+r}+\frac{a_r}{n}\leqslant slant \cdots \leqslant slant \frac{qa_k}{kq+r}+\frac{a_r}{n}\leqslant slant \frac{a_k}{k}+\frac{a_r}{n},\forall k\in \mathbb{N} _+.
\end{align*}
令 $n\rightarrow \infty$ 并取上极限得到
\begin{align}
\underset{n\rightarrow \infty}{\overline{\lim }}\frac{a_n}{n}\leqslant slant \frac{a_k}{k}<\infty ,\forall k\in \mathbb{N} _+.\label{lemma1.2--1.1}
\end{align}
再令 $k\rightarrow \infty$ 并取下极限可得
\begin{align*}
\underset{n\rightarrow \infty}{\overline{\lim }}\frac{a_n}{n}\leqslant slant \underset{n\rightarrow \infty}{\underline{\lim }}\frac{a_k}{k}=\underset{n\rightarrow \infty}{\underline{\lim }}\frac{a_n}{n}\leqslant slant \underset{n\rightarrow \infty}{\overline{\lim }}\frac{a_n}{n}.
\end{align*}
故 $\left\{ \frac{a_n}{n} \right\}$ 收敛。注意到$\{a_n\}$非负,则$\{\frac{a_n}{n}\}$一定有下界0,从而一定存在下确界$\mathrm{inf}\left\{ \frac{a_n}{n} \right\}$.于是我们有
\begin{align*}
\mathrm{inf}\left\{ \frac{a_n}{n} \right\} \leqslant slant \frac{a_n}{n},\forall n\in \mathbb{N} _+.
\end{align*}
令 $n\rightarrow \infty$ 并取上极限，再结合 $\left\{ \frac{a_n}{n} \right\}$ 收敛和\eqref{lemma1.2--1.1}式可得
\begin{align*}
\mathrm{inf}\left\{ \frac{a_n}{n} \right\} \leqslant slant \underset{n\rightarrow \infty}{\overline{\lim }}\frac{a_n}{n}=\underset{n\rightarrow \infty}{\lim}\frac{a_n}{n}\leqslant slant \frac{a_k}{k},\forall k\in \mathbb{N} _+.
\end{align*}
再对 $k$ 取下确界即得
\begin{align*}
\mathrm{inf}\left\{ \frac{a_n}{n} \right\} \leqslant slant \underset{n\rightarrow \infty}{\lim}\frac{a_n}{n}\leqslant slant \mathrm{inf}\left\{ \frac{a_k}{k} \right\} =\mathrm{inf}\left\{ \frac{a_n}{n} \right\} .
\end{align*}
...
\begin{align*}
&f\left( x \right) =f\left( n+\left\{ x \right\} \right) \leqslant slant f\left( n \right) +f\left( \left\{ x \right\} \right),\\
&f\left( n+1 \right) =f\left( \left[ x \right] +1 \right) =f\left( x+1-\left\{ x \right\} \right) \leqslant slant f\left( x \right) +f\left( 1-\left\{ x \right\} \right) \Rightarrow f\left( x \right) \geqslant slant f\left( n+1 \right) -f\left( 1-\left\{ x \right\} \right).
\end{align*}
从而对$\forall x>1,n=\left[ x \right]$,我们都有
\begin{align*}
\frac{f\left( x \right)}{x}&\leqslant slant \frac{f\left( n \right) +f\left( \left\{ x \right\} \right)}{x}=\frac{f\left( n \right)}{n+\left\{ x \right\}}+\frac{f\left( \left\{ x \right\} \right)}{x}=\frac{f\left( n \right)}{n}+\frac{f\left( \left\{ x \right\} \right)}{x},\\
\frac{f\left( x \right)}{x}&\geqslant slant \frac{f\left( n+1 \right) -f\left( 1-\left\{ x \right\} \right)}{x}=\frac{f\left( n+1 \right)}{n+\left\{ x \right\}}+\frac{f\left( 1-\left\{ x \right\} \right)}{x}\geqslant slant \frac{f\left( n+1 \right)}{n+1}+\frac{f\left( 1-\left\{ x \right\} \right)}{x}.
\end{align*}
即
\begin{align}
\frac{f\left( n+1 \right)}{n+1}+\frac{f\left( 1-\left\{ x \right\} \right)}{x}\leqslant slant \frac{f\left( x \right)}{x}\leqslant slant \frac{f\left( n \right)}{n}+\frac{f\left( \left\{ x \right\} \right)}{x},\forall x>1,n=\left[ x \right].\label{corollary1.1-1.1}
\end{align}
...
\begin{align*}
\mathrm{inf}\left\{ \frac{f\left( n \right)}{n} \right\} =\underset{n\rightarrow \infty}{\lim}\frac{f\left( n+1 \right)}{n+1}\leqslant slant \underset{x\rightarrow +\infty}{\underline{\lim }}\frac{f\left( x \right)}{x}\leqslant slant \underset{x\rightarrow +\infty}{\overline{\lim }}\frac{f\left( x \right)}{x}\leqslant slant \underset{n\rightarrow \infty}{\lim}\frac{f\left( n \right)}{n}=\mathrm{inf}\left\{ \frac{f\left( n \right)}{n} \right\}.
\end{align*}
...
\begin{align*}
0 = f(\xi) < f(x_k) \leqslant slant f(1), \quad f'(\xi) < f'(x_k) \leqslant slant f'(1).
\end{align*}
...
\begin{align*}
\xi = x_k - (x_k - \xi) < x_{k+1} = x_k - \frac{f(x_k)}{f'(x_k)} < x_k \leqslant slant 1.
\end{align*}
...
&\leqslant slant \frac{1}{2} \left| a_n - \sqrt{b} \right|, \forall n \in \mathbb{N}_+.
\end{align*}
于是
\begin{align*}
\left| a_n - \sqrt{b} \right| &\leqslant slant \frac{1}{2} \left| a_{n-1} - \sqrt{b} \right| \leqslant slant \cdots \leqslant slant \frac{1}{2^{n-1}} \left| a_1 - \sqrt{b} \right|, \forall n \in \mathbb{N}_+.
\end{align*}
...
\begin{align*}
x_{n_{k_1}} \geqslant slant \xi, \quad x_{n_{k_2}} \leqslant slant \xi。
\end{align*}
令 $k_1, k_2 \to \infty$，再结合 $\lim_{k \to \infty} x_{n_k} = \xi - A, \lim_{k \to \infty} x_{n_k+1} = \xi + A$ 得到
\begin{align*}
\xi - A = \lim_{k_1 \to \infty} x_{n_{k_1}} \geqslant slant \xi > \xi - A, \quad \xi + A = \lim_{k_2 \to \infty} x_{n_{k_2}} \leqslant slant \xi < \xi + A。
\end{align*}
显然矛盾！又因为 $\{|x_n - \xi|\}$ 单调递减趋于 $A$，所以
\begin{align*}
|x_n - A| \geqslant slant A, \forall n \in \mathbb{N}。
\end{align*}
从而由 $x_n \in (a, b)$ 及\eqref{example1.19-1.1}式可得
\begin{align*}
A \leqslant slant |x_{n_{k_1}} - \xi| = \xi - x_{n_{k_1}} < \xi - a \Rightarrow \xi - A > a,
\\
A \leqslant slant |x_{n_{k_2}} - \xi| = x_{n_{k_2}} - \xi < b - \xi \Rightarrow \xi + A < b。
\end{align*}
因此 $\xi - A, \xi + A \in (a, b)$。
\end{enumerate}
\end{remark}
...
\end{align*}
于是 $\{|x_n - \xi|\}$ 单调递减且有下界 $0$，故由单调有界定理可知 $\lim_{n \to \infty} |x_n - \xi| = A \geqslant slant 0$ 存在。
\begin{enumerate}[(i)]
...
\[
1\leqslant slant \sqrt{\frac{1}{k+1}+1}\leqslant slant x_{k+1}=\sqrt{\frac{1}{k+1}+x_k}<\sqrt{1+2}<2.
\]
...
\end{note}
\begin{proof}
取 $m=\min \left\{ a_1,2\sqrt{\lambda} \right\}$, 再令 $M=\max \left\{ a_1,a_2,\frac{1}{\left( 1-\lambda \right) m} \right\}$。注意到 $a_1\geqslant slant m$, 假设 $a_k\geqslant slant m$, 其中 $k\in \mathbb{N}$, 则由均值不等式可得
\begin{align*}
a_{k+1}=\lambda a_k+\frac{1}{a_k}\geqslant slant 2\sqrt{\lambda}\geqslant slant m。
\end{align*}
故由数学归纳法可得 $a_n\geqslant slant m,\forall n\in \mathbb{N}$。又注意到 $a_2\leqslant slant M$, 假设 $a_l\leqslant slant M$, 由 $M=\max \left\{ a_1,a_2,\frac{1}{\left( 1-\lambda \right) m} \right\}$ 可知
\begin{align*}
M\geqslant slant \frac{1}{\left( 1-\lambda \right) m}\Rightarrow \frac{1}{m}\leqslant slant \left( 1-\lambda \right) M。
\end{align*}
于是
\begin{align*}
a_{l+1}=\lambda a_l+\frac{1}{a_l}\leqslant slant \lambda M+\frac{1}{m}\leqslant slant \lambda M+\left( 1-\lambda \right) =M。
\end{align*}
因此由数学归纳法可知 $a_n\leqslant slant M,\forall n\in \mathbb{N}$。故 $\left\{ a_n \right\}$ 有界。从而可设 $\underset{n\rightarrow \infty}{\overline{\lim }}a_n=L\in \left[ m,M \right] ,\underset{n\rightarrow \infty}{\underline{\lim }}a_n=l\in \left[ m,M \right]$。又因为 $a_{n+1}=\lambda a_n+\frac{1}{a_n},\forall n\in \mathbb{N}$, 所以令 $n\rightarrow \infty$ 并分别取上、下极限可得
\begin{align*}
L\leqslant slant \lambda L+\frac{1}{l},l\geqslant slant \lambda l+\frac{1}{L}\Rightarrow Ll\leqslant slant \frac{1}{1-\lambda},Ll\ge \frac{1}{1-\lambda}\Rightarrow Ll=\frac{1}{1-\lambda}。
\end{align*}
...
\begin{align*}
L=\lambda s+\frac{1}{s}\leqslant slant \lambda L+\frac{1}{l}=\lambda L+\left( 1-\lambda \right) L=L。
\end{align*}
因此 $L=s=l$, 故 $\underset{n\rightarrow \infty}{\lim}a_n$ 存在, 设 $\underset{n\rightarrow \infty}{\lim}a_n=a\geqslant slant m>0$, 则对 $a_{n+1}=\lambda a_n+\frac{1}{a_n}$ 两边同时取极限得到
\begin{align*}
