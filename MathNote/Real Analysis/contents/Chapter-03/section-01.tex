...
\begin{align*}
r_k \geqslant slant t\ (k = 1,2,\cdots); \quad \lim_{k \to \infty}r_k = t.
\end{align*}
...
另一方面,对$\forall x_0\in \bigcup_{k = 1}^{\infty}\{x: f(x) > r_k\}$,都存在$k_0\in \mathbb{N}$,使得$x_0\in \{x:f(x)>r_{k_0}\}$.从而$f(x_0)>r_{k_0}\geqslant  t$,于是$x_0\in \{x:f(x)>t\}$.故
\begin{align}
...
(i) \(\{x: f(x) \leqslant slant t\} = E \setminus \{x: f(x) > t\}\) \((t \in \mathbf{R})\)；

(ii) \(\{x: f(x) \geqslant slant t\} = \bigcap_{k = 1}^{\infty}\left\{x: f(x) > t - \frac{1}{k}\right\}\) \((t \in \mathbf{R})\)；

(iii) \(\{x: f(x) < t\} = E \setminus \{x: f(x) \geqslant slant t\}\) \((t \in \mathbf{R})\)；

(iv) \(\{x: f(x) = t\} = \{x: f(x) \geqslant slant t\} \cap \{x: f(x) \leqslant slant t\}\) \((t \in \mathbf{R})\)；
...
&= E \setminus \{x: f(x) \leqslant slant t\} = E \setminus \bigcap_{k = 1}^{\infty}\left\{x: f(x) < t + \frac{1}{k}\right\},
\end{align*}
...
\end{proposition}
\begin{proof}
注意到对 \(\forall x \in E\)，有 \(\chi_E(x) = 1\). 于是当 \(t < 1\) 时，有 \(\{x \in E: \chi_E(x) > t\} = E \in \mathscr{M}\)；当 \(t \geqslant slant 1\) 时，有 \(\{x \in E: \chi_E(x) > t\} = \varnothing \in \mathscr{M}\). 故 \(\chi_E(x)\) 在 \(E\) 上可测.

又注意到对 \(\forall x \in \mathbb{R}^n \backslash E\)，有 \(\chi_E(x) = 0\). 于是当 \(t < 0\) 时，有 \(\{x \in \mathbb{R}^n \backslash E: \chi_E(x) > t\} = \mathbb{R}^n \backslash E \in \mathscr{M}\)；当 \(t \geqslant slant 0\) 时，有 \(\{x \in \mathbb{R}^n \backslash E: \chi_E(x) > t\} = \varnothing \in \mathscr{M}\). 故 \(\chi_E(x)\) 在 \(\mathbb{R}^n \backslash E\) 上也可测.
...
\begin{align*}
(\text{i}) \sup_{k \geqslant slant 1}\{f_k(x)\};\quad (\text{ii})\inf_{k \geqslant slant 1}\{f_k(x)\} ;\quad (\text{iii})\varlimsup_{k \to \infty} f_k(x) ;\quad (\text{iv}) \varliminf_{k \to \infty} f_k(x)
\end{align*}
都是 \(E\) 上的可测函数.
\end{enumerate}
\end{theorem}
...
$\{x:cf(x)>t\}=E\in \mathscr{M}$;当$t\geqslant slant 0$时,有$\{x:cf(x)>t\}=\varnothing\in \mathscr{M}$.故此时仍有\(cf(x)\) 在 \(E\) 上可测.
...
\begin{cases}
E, & t < 0,\\
\{x: f(x) > \sqrt{t}\} \cup \{x: f(x) < -\sqrt{t}\}, & t \geqslant slant 0.
\end{cases}
\end{align*}
...
\item (i) 对$\forall t \in \mathbf{R}$,显然有$\left\{x: \sup_{k \geqslant slant 1}\{f_k(x)\} > t\right\} \supset \bigcup_{k = 1}^{\infty}\{x: f_k(x) > t\}.$任取$x_0\in \left\{x: \sup_{k \geqslant slant 1}\{f_k(x)\} > t\right\}$,则$ \sup_{k \geqslant slant 1}\{f_k(x_0)\} > t$
于是由上确界的定义可知,存在$k_0\in \mathbb{N}$,使得$f_{k_0}(x_0)>t$.此即$$x_0\in \{x: f_{k_0}(x) > t\}\subset \bigcup_{k = 1}^{\infty}\{x: f_k(x) > t\}.$$
故$\left\{x: \sup_{k \geqslant slant 1}\{f_k(x)\} > t\right\} \subset \bigcup_{k = 1}^{\infty}\{x: f_k(x) > t\}.$
因此
\begin{align*}
\left\{x: \sup_{k \geqslant slant 1}\{f_k(x)\} > t\right\} = \bigcup_{k = 1}^{\infty}\{x: f_k(x) > t\},
\end{align*}
从而由$\{f_k(x)\}$在$E$上可测可知\(\sup_{k \geqslant slant 1}\{f_k(x)\}\) 是 \(E\) 上的可测函数.

(ii) 由于 \(\inf_{k \geqslant slant 1}\{f_k(x)\} = -\sup_{k \geqslant slant 1}\{-f_k(x)\}\)，故可知 \(\inf_{k \geqslant slant 1}\{f_k(x)\}\) 在 \(E\) 上可测.

(iii) 只需注意到 \(\varlimsup_{k \to \infty} f_k(x) = \inf_{i \geqslant slant 1}\left(\sup_{k \geqslant slant i}[f_k(x)]\right)\) 即可.
...
\item $f^+(x),f^-(x)\geqslant slant 0,\quad \forall x\in E.$

\item $\left| f\left( x \right) \right|=f^+\left( x \right) +f^-\left( x \right) ,\quad \forall x\in E.$

\item 若$f(x)\leqslant slant g(x),x\in E$,则$f^+(x)\leqslant slant g^+(x),f^-(x)\geqslant slant g^-(x),\forall x\in E.$
\end{enumerate}
\end{lemma}
\begin{proof}
证明都是显然的.
...
对每个 \(n = 1,2,\cdots\)，作函数
\[
f_n(x,y) = f\left(x,\frac{k}{n}\right), \frac{k - 1}{n} < y \leqslant slant \frac{k}{n} \ (k = 0, \pm 1, \pm 2,\cdots).
\]
因为对任意的 \(t \in \mathbf{R}\)，显然有$\{(x,y) \in \mathbf{R}^2: f_n(x,y) < t\} 
\supset \bigcup_{k = -\infty}^{\infty}\left\{x \in \mathbf{R}: f\left(x,\frac{k}{n}\right) < t\right\} \times \left(\frac{k - 1}{n}, \frac{k}{n}\right].$任取$(x_0,y_0)\in \{(x,y) \in \mathbf{R}^2: f_n(x,y) < t\},$则$f_n(x_0,y_0)<t$.从而存在$k_0\in \mathbb{Z}$,使得$\frac{k_0-1}{n}<y_0 \leqslant  \frac{k}{n}$,并且$f(x_0,\frac{k_0}{n})=f_n(x_0,y_0)<t$.于是
\begin{align*}
...
\left[ 0,\frac{1}{t} \right) ,t\geqslant slant 1\\
\left[ 0,1 \right] ,t<1\\
...
于是由测度的单调性可得
\begin{align*}
m\left( \left\{ x\in \left[ 0,1 \right] :f\left( x \right) \ne g\left( x \right) \right\} \right) &\geqslant slant m\left( \left\{ x\in \left( 0,1 \right] :f\left( x \right) >g\left( x \right) \right\} \right) =m\left( \left\{ x\in \left( 0,1 \right] :\frac{1}{x}>g\left( x \right) \right\} \right) 
\\
&\geqslant slant m\left( \left\{ x\in \left( 0,1 \right] :\frac{1}{x}>M \right\} \right) =m\left( \left\{ x\in \left( 0,1 \right] :x<\frac{1}{M} \right\} \right) 
\\
...
\begin{align*}
m(A \setminus B) < \delta, \quad \frac{1}{k_0} \leqslant slant f(x) \leqslant slant k_0, \quad x \in B.
\end{align*}
\end{proposition}
\begin{proof}
记$A_k = \{x \in A: 1/k \leqslant slant f(x) \leqslant slant k\}$（$k = 1, 2, \cdots$），$Z_1 = \{x \in A: f(x) = 0\}$，$Z_2 = \{x \in A: f(x) = +\infty\}$，易知$m(Z_1) = m(Z_2) = 0$，且有
\begin{align*}
...
$\varphi_k(x) \leqslant slant \varphi_{k + 1}(x)$，$k = 1, 2, \cdots$，
使得
\begin{align}
\lim_{k \to \infty} \varphi_k(x) = f(x), \quad x \in E; \label{eq:3.5}
\end{align}
(2) 若$f(x)$是$E$上的可测函数，则存在可测简单函数列$\{\varphi_k(x)\}$，使得$|\varphi_k(x)| \leqslant slant |f(x)|$，且有
$\lim_{k \to \infty} \varphi_k(x) = f(x)$，$x \in E$。
若$f(x)$还是有界的，则上述的收敛是一致的。
\end{theorem}
\begin{remark}
注意$\bigcup_{j=1}^{k2^k}E_{k, j}=\bigcup_{j=1}^{k2^k}\left\{x \in E: \frac{j - 1}{2^k} \leqslant slant f(x) < \frac{j}{2^k} \right\}=\{x\in E:0\leqslant slant f(x)<k\}.$
\end{remark}
\begin{note}
...
\begin{align*}
E_{k, j} &= \left\{x \in E: \frac{j - 1}{2^k} \leqslant slant f(x) < \frac{j}{2^k} \right\}, \\
E_{k} &= \{x \in E: f(x) \geqslant slant k\}, \\
...
\one 当$0\leqslant slant f\left( x_0 \right) <k + 1$时，即$x_0\in \left\{ x\in E:0\leqslant slant f\left( x \right) <k + 1 \right\} =\bigcup_{j = 1}^{(k + 1)2^{k + 1}}E_{k + 1,j}$，则存在$j_0\in \left\{ 1,2,\cdots,(k + 1)2^{k + 1} \right\}$，使得$x_0\in E_{k + 1,j_0}=\left\{ x\in E:\frac{j_0 - 1}{2^{k + 1}}\leqslant slant f\left( x \right) <\frac{j_0}{2^{k + 1}} \right\}$，即
\begin{align}
\frac{j_0 - 1}{2^{k + 1}}\leqslant slant f\left( x_0 \right) <\frac{j_0}{2^{k + 1}}, \quad \varphi _{k + 1}\left( x_0 \right) =\frac{j_0 - 1}{2^{k + 1}}. \label{eq:100.61}
\end{align}
...
从而
\begin{align*}
\frac{j_0 - 1}{2^{k + 1}}\leqslant slant f\left( x_0 \right) <\frac{j_0}{2^{k + 1}}<\frac{\frac{j_0 + 1}{2}}{2^k}.
\end{align*}
故此时就有$x_0\in \left\{ x\in E:\frac{\frac{j_0 - 1}{2}}{2^k}\leqslant slant f\left( x \right) <\frac{\frac{j_0 + 1}{2}}{2^k} \right\} =E_{k,\frac{j_0 + 1}{2}}$。因此再结合\eqref{eq:100.61}式可得
\begin{align*}
\varphi _k\left( x_0 \right) =\frac{\frac{j_0 - 1}{2}}{2^k}=\frac{j_0 - 1}{2^{k + 1}}=\varphi _{k + 1}\left( x_0 \right) \leqslant slant f\left( x_0 \right).
\end{align*}
...
从而
\begin{align*}
\frac{\frac{j_0 - 2}{2}}{2^k}<\frac{j_0 - 1}{2^{k + 1}}\leqslant slant f\left( x_0 \right) <\frac{j_0}{2^{k + 1}}=\frac{\frac{j_0}{2}}{2^k}.
\end{align*}
故此时就有$x_0\in \left\{ x\in E:\frac{\frac{j_0 - 2}{2}}{2^k}\leqslant slant f\left( x \right) <\frac{\frac{j_0}{2}}{2^k} \right\} =E_{k,\frac{j_0}{2}}$。因此再结合\eqref{eq:100.61}式可得
\begin{align*}
\varphi _k\left( x_0 \right) =\frac{\frac{j_0 - 2}{2}}{2^k}=\frac{j_0 - 2}{2^{k + 1}}<\frac{j_0 - 1}{2^{k + 1}}=\varphi _{k + 1}\left( x_0 \right) \leqslant slant f\left( x_0 \right).
\end{align*}
(II) 当$j_0\in \left[ k2^{k + 1}+1,(k + 1)2^{k + 1} \right]$时，则由\eqref{eq:100.61}式可知，此时有
\begin{align*}
k\leqslant slant \frac{j_0 - 1}{2^{k + 1}}=\varphi _{k + 1}\left( x_0 \right) \leqslant slant f\left( x_0 \right) <\frac{j_0}{2^{k + 1}}\leqslant slant k + 1.
\end{align*}
于是此时$x_0\in \left\{ x\in E:f\left( x \right) \geqslant slant k \right\} =E_k$，从而此时$\varphi _k\left( x_0 \right) =k$。故此时就有
\begin{align*}
\varphi _k\left( x_0 \right) =k\leqslant slant \frac{j_0 - 1}{2^{k + 1}}=\varphi _{k + 1}\left( x_0 \right) \leqslant slant f\left( x_0 \right) <\frac{j_0}{2^{k + 1}}\leqslant slant k + 1.
\end{align*}
\two 当$f\left( x_0 \right) \geqslant slant k + 1$时，则此时$x_0\in E_{k + 1}\subset E_k$。从而此时就有
\begin{align*}
\varphi _k\left( x_0 \right) =k<k + 1=\varphi _{k + 1}\left( x_0 \right) \leqslant slant f\left( x_0 \right).
\end{align*}
综上所述，我们有 
\begin{gather*}
\varphi_k(x) \leqslant slant \varphi_{k + 1}(x) \leqslant slant f(x), \quad \varphi_k(x) \leqslant slant k, \\
x \in E, \quad k = 1, 2, \cdots.
\end{gather*}
现在，对任意的$x_0 \in E$，\one 若$f(x_0) \leqslant slant M$，则对$\forall k > M$，都有$x_0\in \{x\in E:0\leqslant slant f(x)<k\}=\bigcup_{j=1}^{\infty}E_{k,j}$.从而存在$j_0\in \{1,2,\cdots,k2^k\},$使得$x_0\in E_{k,j_0}$,即
\begin{align*}
\frac{j_0-1}{2^k}\leqslant slant f(x_0)<\frac{j_0}{2^k},\quad \varphi_k(x_0)=\frac{j_0-1}{2^k}.
\end{align*}
于是
\begin{align*}
0 \leqslant slant f(x_0) - \varphi_k(x_0) \leqslant slant \frac{1}{2^k},
\end{align*}
...
\end{align*}
若在$E$上有$|f(x)| \leqslant slant M$，则当$k > M$时,由(1)同理可知
\begin{align*}
\sup_{x\in E} |f^+(x) - \varphi_k^{(1)}(x)| \leqslant slant \frac{1}{2^k},\\
\sup_{x\in E} |f^-(x) - \varphi_k^{(2)}(x)| \leqslant slant \frac{1}{2^k}.
\end{align*}
于是
\begin{align*}
...
\\
&\leqslant slant \underset{x\in E}{\mathrm{sup}}\left( \left| f^+\left( x \right) -\varphi _{k}^{\left( 1 \right)}\left( x \right) \right|+\left| f^-\left( x \right) -\varphi _{k}^{\left( 2 \right)}\left( x \right) \right| \right) 
\\
&\leqslant slant \underset{x\in E}{\mathrm{sup}}\left| f^+\left( x \right) -\varphi _{k}^{\left( 1 \right)}\left( x \right) \right|+\underset{k\rightarrow \infty}{\lim}\underset{x\in E}{\mathrm{sup}}\left| f^-\left( x \right) -\varphi _{k}^{\left( 2 \right)}\left( x \right) \right|
\\
&\leqslant slant \frac{1}{2^{k-1}}\rightarrow 0,k\rightarrow \infty .
\end{align*}
...
对$\forall x_0 \in E$，则存在$k_0$，使得当$k \geqslant slant k_0$时有$x_0 \in B(0,k)$。此时可得
\begin{align*}
...
\end{align*} 
并且若$\varphi_k(x)\leqslant slant \varphi_{k+1}(x),\forall x\in E$,则当$x\in E\cap B(0,k) \subset E\cap B(0,k + 1)$时，则此时我们有
\begin{align*}
g_k(x) = \varphi_k(x) \leqslant slant \varphi_{k + 1}(x) = g_{k + 1}(x).
\end{align*}
当$x\notin E\cap B(0,k)$时，显然有
\begin{align*}
g_k(x) = 0 \leqslant slant g_{k + 1}(x).
\end{align*}
综上可得
\begin{align*}
g_k(x) \leqslant slant g_{k + 1}(x), \forall x\in E.
\end{align*} 
\end{proof}
...
\end{align*}
则由\refthe{theorem:简单函数逼近定理}同理可证$0 \leqslant slant f(x) - f_n(x) \leqslant slant 2^{-n}$以及$f_n(x)$关于$n$递增.从而可得$f_n(x) \nearrow f(x) (n \to \infty)$即得所证。 
\end{proof}
