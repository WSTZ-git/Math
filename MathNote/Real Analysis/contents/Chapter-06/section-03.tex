...
&\leqslant \left( \iint_{\mathbb{R}_+^2} [1 - g(x, y)]^2 \mathrm{d}x\mathrm{d}y \right)^{1/2} \left( \iint_{\mathbb{R}_+^2} f^2(x, y) \mathrm{d}x\mathrm{d}y \right)^{1/2} \\
&\quad + \left( \iint_{\mathbb{R}_+^2} \frac{g^2(x, y)}{(x^2 + y^2)^2} \mathrm{d}x\mathrm{d}y \right)^{1/2} \left( \iint_{\mathbb{R}_+^2} (x^2 + y^2)^2 f^2(x, y) \mathrm{d}x\mathrm{d}y \right)^{1/2},
\end{align*}
其中
\begin{align*}
