...
\item 当 $p=1$（即 $p'=+\infty$）且时，\eqref{eq::--9ru90RFUJIJR3ruu0-1} 中等号成立当且仅当
\[
|g(x)|=\|g\|_\infty \quad \text{a.e. 在 } \{x\in E: f(x)\neq 0\}\text{ 上}.
\]

\item 当 $p=+\infty$（即 $p'=1$）时，\eqref{eq::--9ru90RFUJIJR3ruu0-1} 中等号成立当且仅当
\[
...
特别地,我们有
\begin{enumerate}[(1)]
\item 当 $1<p<+\infty$时，\eqref{eq::--9ru90RFUJIJR3ruu0-3} 中等号成立当且仅当存在常数 $\lambda \geq 0$且不全为零，使得
\[
...
\[
f(x)g(x)\geq 0\quad \text{a.e. } x\in E.
\]
