...
\[
|\Delta^{(n)}| = \max \{ x_i^{(n)} - x_{i - 1}^{(n)} : 1 \leqslant slant i \leqslant slant k_n \}, \quad \lim_{n \to \infty} |\Delta^{(n)}| = 0.
\]

对每个 \( i \) 以及 \( n \)，若令

\[
M_i^{(n)} = \sup \{ f(x) : x_{i - 1}^{(n)} \leqslant slant x \leqslant slant x_i^{(n)} \},
\]

\[
m_i^{(n)} = \inf \{ f(x) : x_{i - 1}^{(n)} \leqslant slant x \leqslant slant x_i^{(n)} \},
\]
...
\begin{align*}
\underset{\delta \rightarrow 0}{\lim}\underset{x\in B\left( x_0,\delta \right)}{\mathrm{sup}}|f(x)-f(x_0)|\leqslant slant \underset{\delta \rightarrow 0}{\lim}\underset{x',x'' \in B\left( x_0,\delta \right)}{\mathrm{sup}}|f\left( x' \right) -f\left( x'' \right) |=w(x_0)=0,\mathrm{a}.\mathrm{e}.\,x_0\in \left[ a,b \right] .
\end{align*}
...
\\
&\leqslant slant \underset{\delta \rightarrow 0}{\lim}\underset{x‘\in B\left( x_0,\delta \right)}{\mathrm{sup}}|f(x‘)-f(x_0)|+\underset{\delta \rightarrow 0}{\lim}\underset{x'' \in B\left( x_0,\delta \right)}{\mathrm{sup}}|f(x'' )-f(x_0)|
\\
...
\[
\lim_{k \to \infty} f(x) \chi_{E_k}(x) = f(x), \quad |f(x) \chi_{E_k}(x)| \leqslant slant |f(x)|,
\]
