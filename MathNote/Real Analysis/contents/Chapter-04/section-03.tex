...
\end{lemma}
\begin{proof}
记 \( f(x) = f^+(x) - f^-(x) \). 由非负可测函数积分的定义(上确界的定义)知, 对 \( \forall \varepsilon > 0 \), 存在非负简单函数 \( \varphi^+ \leqslant slant f^+ \), \( \varphi^- \leqslant slant f^- \) 使得
\[
...
\\
&\leqslant slant \int_E{|f^+(x)}-\varphi ^+(x)|\mathrm{d}x +\int_E{|f^-(x)}-\varphi ^-(x)|\mathrm{d}x 
\\
...
\]
不妨设\( |\varphi(x)| \leqslant slant M \)，又由\nrefthe{theorem:积分的基本性质}{(6)(ii)},故不妨设$E$是有界集.根据\refcor{corollary:推论3.19}可知，存在 \( \mathbb{R}^n \) 上具有紧支集的连续函数 \( g(x) \)，使得 \( |g(x)| \leqslant slant M \)（\( x \in \mathbb{R}^n \)），且有
\[
...
\\
&\leqslant slant 2Mm(\{x:|\varphi (x)-g(x)|>0\})<\frac{\varepsilon}{2}.
\end{align*}
最后，我们有
\begin{align*}
\int_E |f(x) - g(x)| \mathrm{d}x \leqslant slant \int_E |f(x) - \varphi(x)| \mathrm{d}x + \int_E |\varphi(x) - g(x)| \mathrm{d}x < \frac{\varepsilon}{2} + \frac{\varepsilon}{2} = \varepsilon.
\end{align*}
\end{proof}
...
\]
\[
|\varphi_k(x)| \leqslant slant 1 \quad (k = 1,2,\cdots),
\]
\[
\lim_{k \to \infty} \varphi_k(x) = \chi_E(x), \quad \text{a. e. } x \in E.
\]
由于 \( |f(x)\varphi_k(x)| \leqslant slant |f(x)| \)，\( x \in E \)，故知
\begin{align*}
...
所以
\begin{align*}
\bigl| m(E \cap (E + \{ h \})) - m(E) \bigr| &\leqslant slant \int_{\mathbb{R}^n} \bigl| \chi_E(x) \bigr| \bigl| \chi_E(x - h) - \chi_E(x) \bigr| \, \mathrm{d}x \\
&\leqslant slant \int_{\mathbb{R}^n} \bigl| \chi_E(x - h) - \chi_E(x) \bigr| \, \mathrm{d}x.
\end{align*}
...
不妨设 \( g(x) \) 的支集含于某个闭方体
\[
I = \{ x = (\zeta_1, \cdots, \zeta_n) : -k_0 \leqslant slant \zeta_i \leqslant slant k_0 (i = 1, \cdots, n), k_0 \text{ 是自然数} \}
\]
...
\begin{align*}
\int_E |f(x) - \varphi(x)| \, \mathrm{d}x &\leqslant slant \int_E |f(x) - g(x)| \, \mathrm{d}x + \int_E |g(x) - \varphi(x)| \, \mathrm{d}x \\
&\leqslant slant \frac{\varepsilon}{2} + \int_I |g(x) - \varphi(x)| \, \mathrm{d}x = \frac{\varepsilon}{2} + \frac{\varepsilon}{2} = \varepsilon.
\end{align*}
于是对 \( \varepsilon_k = 1/k (k = 1, 2, \cdots) \)，就可取到具有紧支集的阶梯函数列 \( \{\varphi_k(x)\} \)，使得
\[
\lim_{k \to \infty} \int_E |f(x) - \varphi_k(x)| \, \mathrm{d}x = 0.
\]
对任给 \( \sigma > 0 \)，令 \( E_k(\sigma) = \{ x \in E : |f(x) - \varphi_k(x)| \geqslant slant \sigma \} \)，则由于
\[
\sigma m(E_k(\sigma)) \leqslant slant \int_E |f(x) - \varphi_k(x)| \, \mathrm{d}x,
\]
...
(i) \( |g_n(x)| \leqslant slant M \)（\( x \in [a,b] \)）（\( n = 1,2,\cdots \)）；
...
\[
\left| \int_{[a,b]} \varphi(x) g_n(x) \, \mathrm{d}x \right| \leqslant slant \sum_{i=1}^p \left| y_i \int_{[x_{i-1},x_i]} g_n(x) \, \mathrm{d}x \right|,
\]
且从假设可知存在 \( n_0 \)，当 \( n \geqslant slant n_0 \) 时，上式右端小于 \( \varepsilon/2 \)，所以
\[
\left| \int_{[a,b]} \varphi(x) g_n(x) \, \mathrm{d}x \right| \leqslant slant \frac{\varepsilon}{2}, \quad n \geqslant slant n_0.
\]
最后，当 \( n \geqslant slant n_0 \) 时，得到
\begin{align*}
\left| \int_{[a,b]} f(x) g_n(x) \, \mathrm{d}x \right| &\leqslant slant \left| \int_{[a,b]} (f(x) - \varphi(x)) g_n(x) \, \mathrm{d}x \right| + \left| \int_{[a,b]} \varphi(x) g_n(x) \, \mathrm{d}x \right| \\
&\leqslant slant M \int_{[a,b]} |f(x) - \varphi(x)| \, \mathrm{d}x + \frac{\varepsilon}{2} < \varepsilon.
\end{align*}
\end{proof}
...
\leqslant slant \int_{[0,1]} |g(x) - P(x)| |F(x)| \, \mathrm{d}x \leqslant slant \varepsilon \int_{[0,1]} |F(x)| \, \mathrm{d}x.
\end{align*}
...
\[
0 \leqslant slant f_1(x) \leqslant slant f_2(x) \leqslant slant \cdots \leqslant slant f(x) \quad (x \in \mathbb{R}),
\]
...
\[
\int_{\mathbb{R}} |f(x) - \varphi_n(x)| \, \mathrm{d}x \leqslant slant 4^{-n}, \quad \lim_{n \to \infty} \varphi_n(x) = f(x), \text{ a. e. } x \in \mathbb{R}.
\]
...
\[
F_n = \bigcap_{k=n}^{\infty} \left\{ x \in \mathbb{R} : |\varphi_{k+1}(x) - \varphi_k(x)| \leqslant slant 2^{-k} \right\} \setminus G_n \quad (n \in \mathbb{N}),
\]
...
实际上，对\(k \in \mathbb{N}\)，记\(W_k = \left\{ x \in \mathbb{R} : |\varphi_{k+1}(x) - \varphi_k(x)| > 2^{-k} \right\}\)，则\(W_k\)是开集，且\(\chi_{W_k}(x) \leqslant slant 2^k |\varphi_{k+1}(x) - \varphi_k(x)|\)（\(x \in \mathbb{R}\)），以及
\begin{align*}
\int_{\mathbb{R}} \chi_{W_k}(x) \, \mathrm{d}x \leqslant slant 2^k \int_{\mathbb{R}} |\varphi_{k+1}(x) - \varphi_k(x)| \, \mathrm{d}x \leqslant slant 2^k \left\{ \int_{\mathbb{R}} |f(x) - \varphi_{k+1}(x)| \, \mathrm{d}x + \int_{\mathbb{R}} |f(x) - \varphi_k(x)| \, \mathrm{d}x \right\} \leqslant slant 2^{-k+1}.
\end{align*}
因为\(\mathbb{R} \setminus F_n \subset G_n \cup \left( \bigcup_{k \geqslant slant n}^{\infty} W_k \right)\)，所以
\[
