...
\begin{theorem}\label{theorem:非负可测函数的性质}
\begin{enumerate}[(1)]
...
\begin{align*}
\int_{A}f(x)\mathrm{d}x=\sup_{\substack{h(x)\leq f(x)\\x\in A}}\left\{\int_{A}h(x)\mathrm{d}x\right\}
=\sup_{\substack{h(x)\chi_{A}(x)\leq f(x)\chi_{A}(x)\\x\in E}}\left\{\int_{A}h(x)\mathrm{d}x\right\}=\int_{E}f(x)\chi_{A}(x)\mathrm{d}x.
\end{align*}
...
\begin{corollary}\label{corollary:渐降函数列积分定理}
...
\end{corollary}
\begin{proof}
因为\( 0 \leqslant f(x) \leqslant f_1(x) \)，所以由\nrefthe{theorem:非负可测函数的性质}{(2)(i)}可知\( f(x) \) 在 \( E \) 上可积. 记
\[
...
\begin{align*}
\int_E{f(x)\,\mathrm{d}x}&\xlongequal{\text{\nrefthe{theorem:非负可测函数的性质}{(3)}}}\int_E{f(x)\chi _E(x)\,\mathrm{d}x}=\int_E{f(x)\chi _{E_1\cup E_2}(x)\,\mathrm{d}x}
\\
&=\int_E{f(x)[\chi _{E_1}(x)}+\chi _{E_2}(x)]\,\mathrm{d}x\xlongequal{\text{\nrefthe{theorem:非负可测函数的性质}{(3)}}}\int_{E_1}{f(x)\,\mathrm{d}x}+\int_{E_2}{f(x)\,\mathrm{d}x}
\\
&\xlongequal{\text{\nrefthe{theorem:非负可测函数的性质}{(5)(ii)}}}\int_{E_2}{f(x)\,\mathrm{d}x}=\int_{E_2}{g(x)\,\mathrm{d}x}
\\
&\xlongequal{\text{\nrefthe{theorem:非负可测函数的性质}{(5)(ii)}}}\int_{E_1}{g(x)\,\mathrm{d}x}+\int_{E_2}{g(x)\,\mathrm{d}x}=\int_E{g(x)\,\mathrm{d}x.}
\end{align*}
\end{proof}

\begin{theorem}[逐项积分定理]\label{theorem:逐项积分定理}
...
\begin{corollary}\label{corollary:积分可化为级数}
...
\end{note}
\begin{proof}
由\hyperref[theorem:逐项积分定理]{逐项积分定理}可得
\begin{align*}
...
\]
所以由\refcor{corollary:积分可化为级数}得到
\begin{align*}
...
\end{align*}
{\heiti 充分性:} 由\refcor{corollary:积分可化为级数}可得
\begin{align*}
