...
\\
&=m\left( \left\{ x\in E:0\leqslant f\left( x \right) <1 \right\} \right) +\sum_{k=0}^{\infty}{\int_{\left\{ x\in E:k\leqslant f\left( x \right) <k+1 \right\}}{f\left( x \right) \mathrm{d}x}}
\\
...
\begin{align*}
\sum_{j=\lfloor \frac{n}{2} \rfloor}^n{j^{k-1}m\left( E_j \right)}\geqslant \left( \frac{n}{2} \right) ^{k-2}m\left( E_n \right) \sum_{j=\lfloor \frac{n}{2} \rfloor}^n{j}=\frac{n^{k-2}m\left( E_n \right)}{2^{k-2}}\cdot \frac{\left( n+\frac{n}{2} \right) \frac{n}{2}}{2}=\frac{3n^km\left( E_n \right)}{2^{k+1}}\geqslant \frac{3n^km\left( E_{n+1} \right)}{2^{k+1}}.
\end{align*}
