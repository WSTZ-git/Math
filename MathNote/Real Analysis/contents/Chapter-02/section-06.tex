...
\end{align*}
记 $M = \left(\sum_{i = 1}^{n}|x_i|^2\right)^{\frac{1}{2}}$ ,从而由Cauchy不等式可得
\begin{align*}
|T(x)|&\leqslant|\xi_1||x_1| + |\xi_2||x_2| + \cdots + |\xi_n||x_n|\\
&\leqslant\left(\sum_{i = 1}^{n}|x_i|^2\right)^{\frac{1}{2}}\left(\sum_{i = 1}^{n}|\xi_i|^2\right)^{\frac{1}{2}} = M|x|.
\end{align*}
由此可知
\begin{align*}
...
= |\det T_1||\det T_2|\cdots|\det T_j|m^*(E)= |\det T|m^*(E).
\end{align*}
...
\begin{align*}
m(P_n) &= \pi r^2 \frac{\sin \frac{\pi}{n}}{\frac{\pi}{n}} \cos\frac{\pi}{n} \to \pi r^2 \quad (n \to \infty),\\
m(Q_n) &= \pi r^2 \frac{\tan\frac{\pi}{n}}{\frac{\pi}{n}} \to \pi r^2 \quad (n \to \infty),
\end{align*}
可知 \(m(D)=\pi r^2\).
