...
$$x_n = x_1 + \sum_{m=1}^{n-1} \left(x_{m+1} - x_m\right) = x_1 + \left(x_2 - x_1\right)\sum_{m=1}^{n-1} (-1)^{m-1}\prod_{k=2}^m \left(1 - \frac{1}{\sqrt{k}}\right).$$
...
故
$$\lim_{n\rightarrow \infty} x_n = x_1 + \left(x_2 - x_1\right)\sum_{m=1}^{\infty} (-1)^{m-1}\prod_{k=1}^m \left(1 - \frac{1}{\sqrt{k}}\right) < +\infty.$$
