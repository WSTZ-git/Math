...
结合
\[
0\leq\lim_{n\to\infty}\frac{\left|\sum\limits_{j\neq k} C_j\frac{1-e^{i(n+1)(\lambda_j-\lambda_k)}}{1-e^{i(\lambda_j-\lambda_k)}}\right|}{n+1}\leq\lim_{n\to\infty}\frac{\sum\limits_{j\neq k}|C_j|\frac{2}{|1-e^{i(\lambda_j-\lambda_k)}|}}{n+1}=0,
\]
