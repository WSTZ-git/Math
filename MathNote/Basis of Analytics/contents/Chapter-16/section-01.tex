...
\begin{align*}
a_n = a_N \prod_{k=N}^{n-1} \frac{a_{k+1}}{a_k} = a_N \exp\left\{ \sum_{k=N}^{n-1} \ln\frac{a_{k+1}}{a_k} \right\} > a_N \exp\left\{ \sum_{k=N}^{n-1} \frac{\mu}{k} \right\} 
\geqslant a_N \exp\left\{ \sum_{k=N}^{n-1} \int_{k-1}^k \frac{\mu}{x} \mathrm{d}x \right\} = a_N \exp\left\{ \int_{N-1}^{n-1} \frac{\mu}{x} \mathrm{d}x \right\} 
= a_N e^{\mu\ln\frac{n-1}{N-1}} = \frac{a_N}{(N-1)^\mu} (n-1)^\mu.
\end{align*}
