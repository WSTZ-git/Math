...
\left|\sum_{n = m}^{m + p} (-1)^n a_n\right| \leqslant slant a_m.
\end{equation}
\end{theorem}
\begin{note}
...
于是对于第一种情况, 设
\[
M = 2 \sup_{n \geqslant slant 1} \left| \sum_{k=1}^n a_k \right|,
\]
我们有
\[
\left| \sum_{k=n}^m a_k b_k \right| \leqslant slant M \sum_{k=n}^{m - 1} |b_k - b_{k + 1}| + M |b_m| = M b_n \to 0, \text{当} n, m \to \infty.
\]
对于第二种情况, 因为 \( \sum_{n=1}^\infty a_n \) 收敛, 故对任何 \( \varepsilon > 0 \), 当 \( n \) 充分大, 对任何 \( p \in \mathbb{N}_0 \), 必有
\[
\left| \sum_{k=n}^{n + p} a_k \right| \leqslant slant \varepsilon.
\]
于是当 \( n, m \) 充分大, 我们有
\[
\left| \sum_{k=n}^m a_k b_k \right| \leqslant slant \varepsilon \sum_{k=n}^{m - 1} |b_k - b_{k + 1}| + \varepsilon |b_m| = \varepsilon |b_m - b_n| + \varepsilon |b_m| \leqslant slant 3 \varepsilon \sup_{n \geqslant slant 1} |b_n|.
\]
...
不妨设 \( f \) 非负递减, 注意到
\[
\int_1^\infty f(x) \, \mathrm{d}x = \sum_{n=1}^\infty \int_n^{n + 1} f(x) \, \mathrm{d}x \leqslant slant \sum_{n=1}^\infty f(n) \leqslant slant f(1) + \sum_{n=2}^\infty \int_{n - 1}^n f(x) \, \mathrm{d}x = f(1) + \int_1^\infty f(x) \, \mathrm{d}x.
\]
由夹逼准则即证.
\end{proof}
...
不等式版:
\begin{enumerate}
\item 若存在 \( N \in \mathbb{N}, \delta \in (0, 1) \) 使得 \( \frac{a_{n + 1}}{a_n} \leqslant slant \delta, \forall n \geqslant slant N \), 则 \( \sum_{n=1}^\infty a_n \) 收敛;

\item 若存在 \( N \in \mathbb{N} \) 使得 \( \frac{a_{n + 1}}{a_n} \geqslant slant 1, \forall n \geqslant slant N \), 则 \( \sum_{n=1}^\infty a_n \) 发散.
\end{enumerate}
\end{theorem}
\begin{remark}
...
\[
\frac{\ln \frac{F'(n)}{a_n}}{\ln F(n)} \geqslant slant c, \forall n \geqslant slant N,
\]
则 \(\sum_{n=1}^\infty a_n\) 收敛；

\item 若存在 \( c \leqslant slant 1, N \in \mathbb{N} \) 使得
\[
\frac{\ln \frac{F'(n)}{a_n}}{\ln F(n)} \leqslant slant c, \forall n \geqslant slant N,
\]
则 \(\sum_{n=1}^\infty a_n\) 发散。
\end{enumerate}
\end{theorem}
\begin{note}
极限版和不等式版的第 1 个结果的条件是等价的，第 2 个结果不等式版条件要更弱，因为如果改 \eqref{eq::18.10--1}为 \(\varliminf_{n \to \infty} \frac{\ln \frac{F'(n)}{a_n}}{\ln F(n)} \leqslant slant 1\)，则 \(\frac{\ln \frac{F'(n)}{a_n}}{\ln F(n)}\) 仍然可能在 \( n \) 充分大严格超过 1。
\end{note}
\begin{remark}
取 \( F(x) = e^x \)，则
\[
...
\]
即 \(\sum_{n=1}^\infty \frac{F'(n)}{F(n)}\) 收敛。但 \(\sum_{n=1}^\infty \frac{F'(n)}{F(n)} \geqslant slant \sum_{n=1}^\infty \frac{F'(n)}{A}\)，这就和 \(\sum_{n=1}^\infty F'(n)\) 发散矛盾！故我们证明了 \(\eqref{eq:::18.11---11}\)。

$\mathbf{Step}\,\,\mathbf{2}$ 当 \(\eqref{eq::18.9--1}\) 成立，再利用\eqref{eq:::18.11---11}式,存在 \( c > 1, N \in \mathbb{N} \) 使得
\[
\frac{\ln \frac{F'(n)}{a_n}}{\ln F(n)} \geqslant slant c,F(N)>1, \forall n \geqslant slant N.
\]
因此
\[
\frac{F'(n)}{a_n} \geqslant slant e^{c \ln F(n)} \Rightarrow \frac{F'(n)}{F^c(n)} \geqslant slant a_n, \forall n \geqslant slant N.
\]
...
$\mathbf{Step}\,\,\mathbf{3}$ 若存在 \( c \leqslant slant 1, N \in \mathbb{N} \) 使得
\[
\frac{\ln \frac{F'(n)}{a_n}}{\ln F(n)} \leqslant slant c, F(n) \geqslant slant 1, \forall n \geqslant slant N.
\]
根据$\mathbf{Step}\,\,\mathbf{2}$，同样的我们有 \(\frac{F'(n)}{F(n)} \leqslant slant \frac{F'(n)}{F^c(n)} \leqslant slant a_n, \forall n \geqslant slant N\) 以及由\hyperref[theorem:积分判别法]{积分判别法}有
\[
...
\item 若存在 \( c > 1, N \in \mathbb{N} \) 使得
\[
\frac{\ln \frac{1}{a_n}}{\ln n} \geqslant slant c, \forall n \geqslant slant N,
\]
则 \( \sum_{n=1}^\infty a_n \) 收敛;

\item 若存在 \( c \leqslant slant 1, N \in \mathbb{N} \) 使得
\[
\frac{\ln \frac{1}{a_n}}{\ln n} \leqslant slant c, \forall n \geqslant slant N,
\]
则 \( \sum_{n=1}^\infty a_n \) 发散.
\end{enumerate}
\end{theorem}
...
\item 若存在 \( c < 1, N \in \mathbb{N} \) 使得
\[
\sqrt[n]{a_n} \leqslant slant c, \forall n \geqslant slant N,
\]
则 \(\sum_{n=1}^\infty a_n\) 收敛；

\item 若存在 \( c \geqslant slant 1 \) 和无穷多个 \( n \) 使得
\[
\sqrt[n]{a_n} \geqslant slant c,
\]
则 \(\sum_{n=1}^\infty a_n\) 发散。
\end{enumerate}
\end{theorem}
\begin{remark}
值得注意的是，对于\hyperref[theorem:级数-根值判别法]{根值判别法}，这里通过 \hyperref[theorem:Cauchy链]{Cauchy 链}的叙述，不应该是 \(\varlimsup_{n \to \infty} \sqrt[n]{a_n} > 1\)，而应该是 \(\varliminf_{n \to \infty} \sqrt[n]{a_n} > 1\)。也不应是无穷多个 \( n \)，而是任何 \( n \geqslant slant N \)。所以我们需要一些加强的证明。
\end{remark}
\begin{proof}
若存在 \( c \geqslant slant 1 \) 和无穷多个 \( n \) 使得
\[
\sqrt[n]{a_n} \geqslant slant c,
\]
则存在 \( n_k \to \infty \)，使得
\[
\sqrt[n_k]{|a_{n_k}|} \geqslant slant c \geqslant slant 1 \Rightarrow |a_{n_k}| \geqslant slant 1 \Rightarrow \lim_{k \to \infty} |a_{n_k}| \neq 0,
\]
...
不等式版:
\begin{enumerate}
\item 若存在 \( N \in \mathbb{N}, \delta > 0 \) 使得 \( K_n \geqslant slant \delta, \forall n \geqslant slant N \), 则 \( \sum_{n=1}^\infty a_n \) 收敛;

\item 若存在 \( N \in \mathbb{N} \) 使得 \( K_n \leqslant slant 0, \forall n \geqslant slant N \), 则 \( \sum_{n=1}^\infty a_n \) 发散.
\end{enumerate}
\end{theorem}
\begin{note}
...
\end{remark}
\begin{proof}
若存在 \( N \in \mathbb{N}, \delta > 0 \) 使得 \( K_n \geqslant slant \delta, \forall n \geqslant slant N \), 则
\[
\frac{1}{\delta} \left( \frac{a_n}{d_n} - \frac{a_{n + 1}}{d_{n + 1}} \right) \geqslant slant a_{n + 1}, \forall n \geqslant slant N.
\]
现在
\[
\sum_{k=N}^m a_{k + 1} \leqslant slant \sum_{k=N}^m \frac{1}{\delta} \left( \frac{a_k}{d_k} - \frac{a_{k + 1}}{d_{k + 1}} \right) = \frac{1}{\delta} \left( \frac{a_N}{d_N} - \frac{a_{m + 1}}{d_{m + 1}} \right) \leqslant slant \frac{1}{\delta} \cdot \frac{a_N}{d_N},
\]
所以 \( \sum_{n=1}^\infty a_n \) 收敛.

若存在 \( N \in \mathbb{N} \) 使得 \( K_n \leqslant slant 0, \forall n \geqslant slant N \). 则 \( \frac{a_{n + 1}}{d_{n + 1}} \geqslant slant \frac{a_n}{d_n}, \forall n \geqslant slant N \). 现在
\[
a_{n + 1} \geqslant slant \frac{a_N}{d_N} d_{n + 1}, \forall n \geqslant slant N, \sum_{n=1}^\infty d_n = +\infty \Rightarrow \sum_{n=1}^\infty a_n = +\infty,
\]
这就完成了证明.
\end{proof}
...
不等式版:
\begin{enumerate}
\item 若存在 \( N \in \mathbb{N}, \delta > 1 \) 使得 \( n \left( \frac{a_n}{a_{n + 1}} - 1 \right) \geqslant slant \delta, \forall n \geqslant slant N \), 则 \( \sum_{n=1}^\infty a_n \) 收敛;
\item 若存在 \( N \in \mathbb{N} \) 使得 \( n \left( \frac{a_n}{a_{n + 1}} - 1 \right) \leqslant slant 1, \forall n \geqslant slant N \), 则 \( \sum_{n=1}^\infty a_n \) 发散.
\end{enumerate}
\end{theorem}
\begin{proof}
...
\[
\ln n \left[ n \ln \frac{a_n}{a_{n + 1}} - 1 \right] > t, \forall n \geqslant slant N.
\]
然后
\[
\ln \frac{a_n}{a_{n + 1}} > \frac{1}{n} + \frac{t}{n \ln n}, \forall n \geqslant slant N.
\]
现在求和得
\[
\ln \frac{a_N}{a_{n + 1}} > \sum_{k=N}^n \left( \frac{1}{k} + \frac{t}{k \ln k} \right), \forall n \geqslant slant N.
\]
于是
\[
a_{n + 1} < a_N e^{-\sum\limits_{k=N}^n \left( \frac{1}{k} + \frac{t}{k \ln k} \right)}, \forall n \geqslant slant N.
\]
...
\[
t_n = \sqrt[p]{a_1 + \sqrt[p]{a_2 + \cdots + \sqrt[p]{a_n}}} \geqslant slant \sqrt[p]{0 + \sqrt[p]{0 + \cdots + \sqrt[p]{a_n}}} = a_n^{\frac{1}{p^n}}
\]
和 \( \{t_n\}_{n = 1}^{\infty} \) 有界知 \( a_n^{\frac{1}{p^n}} \) 有界。

{\heiti 充分性:} 若 \( a_n^{\frac{1}{p^n}} \) 有界, 则设 \( a_n^{\frac{1}{p^n}} \leqslant slant M, \, \forall n \in \mathbb{N} \), 于是我们有 \( a_n \leqslant slant M^{p^n}, \, \forall n \in \mathbb{N} \)。因此
\begin{align*}
t_n &= \sqrt[p]{a_1 + \sqrt[p]{a_2 + \cdots + \sqrt[p]{a_n}}} \leqslant slant \sqrt[p]{M^{p} + \sqrt[p]{M^{p^2} + \cdots + \sqrt[p]{M^{p^n}}}} \\
&= M\sqrt[p]{1 + \sqrt[p]{1 + \cdots + \sqrt[p]{1}}} \leqslant slant M \lim_{n \to \infty} \underbrace{\sqrt[p]{1 + \sqrt[p]{1 + \cdots + \sqrt[p]{1}}}}_{n \text{ 个根号}},
\end{align*}
...
\[
0 \leqslant slant 2n a_{2n} \leqslant slant 2 \sum_{k = n + 1}^{2n} a_k, \, 0 \leqslant slant (2n - 1) a_{2n - 1} \leqslant slant 2n a_{2n - 1} \leqslant slant 2 \sum_{k = n}^{2n - 1} a_k.
\]
现在由 Cauchy 收敛准则知
\[
...
我们有
\begin{align*}
\sum_{\sqrt{n} - 1 \leqslant slant k \leqslant slant n - 1} a_k &= \sum_{\sqrt{n} - 1 \leqslant slant k \leqslant slant n - 1} \frac{k a_k}{k} \geqslant slant n a_n \sum_{\sqrt{n} - 1 \leqslant slant k \leqslant slant n - 1} \frac{1}{k} \geqslant slant n a_n \sum_{\sqrt{n} - 1 \leqslant slant k \leqslant slant n - 1} \int_{k}^{k + 1} \frac{1}{x} \mathrm{d}x \\
&= n a_n \int_{\lfloor \sqrt{n} \rfloor}^{n} \frac{1}{x} \mathrm{d}x = n a_n \ln \frac{n}{\lfloor \sqrt{n} \rfloor} \geqslant slant n a_n \ln \frac{n}{\sqrt{n}} = \frac{1}{2} n a_n \ln n \geqslant slant 0,
\end{align*}
利用 Cauchy 收敛准则和夹逼准则我们得到 \( \lim_{n \to \infty} n \ln n \cdot a_n = 0 \)。

\item 不妨设 \( n \ln n \cdot a_n \) 递减, 否则考虑 \( -a_n \) 即可. 若 \( \lim_{n \to \infty} (n \ln n \cdot a_n) = c \neq 0 \). 注意到 \( \sum_{n = 2}^{\infty} \frac{1}{n \ln n} \) 发散, \( \sum_{n = 2}^{\infty} a_n \) 收敛, 这就和比较判别法矛盾! 因此 \( \lim_{n \to \infty} (n \ln n \cdot a_n) = 0 \), 从而 \( a_n \geqslant slant 0 \)。

注意到
\begin{align*}
\sum_{[\ln n] \leqslant slant k \leqslant slant n} a_k &= \sum_{[\ln n] \leqslant slant k \leqslant slant n} \frac{k \ln k \cdot a_k}{k \ln k} \geqslant slant n \ln n \cdot a_n \sum_{[\ln n] \leqslant slant k \leqslant slant n} \frac{1}{k \ln k} \\
&\geqslant slant n \ln n \cdot a_n \sum_{[\ln n] \leqslant slant k \leqslant slant n} \int_{k}^{k + 1} \frac{1}{x \ln x} \mathrm{d}x = n \ln n \cdot a_n \int_{[\ln n]}^{n + 1} \frac{1}{x \ln x} \mathrm{d}x \\
&= n \ln n \cdot a_n \cdot \ln \frac{\ln (n + 1)}{\ln [\ln n]} \geqslant slant n \ln n \cdot a_n \cdot \ln \frac{\ln n}{\ln \ln n} \sim n \ln n \cdot \ln \ln n \cdot a_n,
\end{align*}
...
\[
|a_n(s)| \leqslant slant c_n, \sum_{n = 1}^{\infty} c_n < \infty,
\]
...
\end{theorem}
\begin{proof}
事实上由极限保号性，我们知道 \( |b_n| \leqslant slant c_n, n = 1, 2, \cdots \)，因此 \( \sum_{n = 1}^{\infty} b_n \) 绝对收敛，从而
\begin{align*}
\left| \sum_{n = 1}^{\infty} a_n(s) - \sum_{n = 1}^{\infty} b_n \right| &\leqslant slant \left| \sum_{n = 1}^{m} (a_n(s) - b_n) \right| + \sum_{n = m + 1}^{\infty} |a_n(s) - b_n| \\
&\leqslant slant \left| \sum_{n = 1}^{m} (a_n(s) - b_n) \right| + 2 \sum_{n = m + 1}^{\infty} c_n.
\end{align*}
对 \( s \) 取极限得
\[
\lim_{s} \left| \sum_{n = 1}^{\infty} a_n(s) - \sum_{n = 1}^{\infty} b_n \right| \leqslant slant 2 \sum_{n = m + 1}^{\infty} c_n.
\]
...
并且
\[
\left| \left( 1-\frac{k}{n} \right) ^n\chi _{\{1,2,\cdots ,n-1\}}(k) \right|\leqslant slant e^{n\ln \left( 1-\frac{k}{n} \right)}\leqslant slant e^{n\cdot \left( -\frac{k}{n} \right)}=e^{-k}.
\]
...
\end{note}
\begin{proof}
若 \( \sum_{n = 1}^{\infty} b_n \) 收敛，那么由于 \( 0 \leqslant slant a_n(s) \leqslant slant b_n \)，取控制级数 \( \sum_{n = 1}^{\infty} b_n \) 即可使用\hyperref[theorem:级数的控制收敛定理]{控制收敛定理}得到
\[
\lim_{s} \sum_{n = 1}^{\infty} a_n(s) = \sum_{n = 1}^{\infty} b_n.
\]
...
\[
\sum_{n = 1}^{N} b_n = \lim_{s} \sum_{n = 1}^{N} a_n(s) \leqslant slant \lim_{s} \sum_{n = 1}^{\infty} a_n(s) = m < \infty,
\]
矛盾！我们完成了Levi定理的证明。
\end{proof}
...
\[
\sum_{n = 1}^{\infty} \varliminf_{s} a_n(s) \leqslant slant \varliminf_{s} \sum_{n = 1}^{\infty} a_n(s).
\]
\end{lemma}
\begin{note}
本定理即使级数发散，极限数列发散，也能使用。
\end{note}
\begin{proof}
不妨设 \( s \to +\infty \)，考虑 \( g_n(s) \triangleq \inf_{t \geqslant slant s} a_n(t) \)，则 \( g_n \) 关于趋于方向递增非负，所以由\hyperref[theorem:级数的Levi定理]{级数的Levi定理}知
\[
\sum_{n = 1}^{\infty} \varliminf_{s} a_n(s) = \sum_{n = 1}^{\infty} \lim_{s} g_n(s) = \lim_{s} \sum_{n = 1}^{\infty} g_n(s) = \lim_{s} \sum_{n = 1}^{\infty} \inf_{t \geqslant slant s} a_k(t) \leqslant slant \varliminf_{s} \sum_{n = 1}^{\infty} a_k(s),
\]
这就完成了证明。
\end{proof}
...
\item 注意到
\[
\sum_{m = 1}^{\infty} \left| \sum_{n = 1}^{N} a_{m,n} \right| \leqslant slant \sum_{m = 1}^{\infty} \sum_{n = 1}^{\infty} |a_{m,n}| < \infty,
\]
...
\end{align}
事实上，对每个 \( n \in \mathbb{N} \)，存在唯一的 \( m \in \mathbb{N} \)，使得 \( n_m < n \leqslant slant n_{m + 1} \)，此时
\[
\sum_{j = 1}^{n} a_j = \sum_{k = 1}^{m - 1} \sum_{j = n_k + 1}^{n_{k + 1}} a_j + \sum_{j = n_m + 1}^{n} a_j.
\]
则当 \( a_j \geqslant slant 0, n_m < j \leqslant slant n_{m + 1} \)，我们有
\begin{align}
\sum_{j = 1}^{n} a_j \geqslant slant \sum_{k = 1}^{m - 1} \sum_{j = n_k + 1}^{n_{k + 1}} a_j, \sum_{j = 1}^{n} a_j = \sum_{k = 1}^{m} \sum_{j = n_k + 1}^{n_{k + 1}} a_j - \sum_{j = n + 1}^{n_{m + 1}} a_j \leqslant slant \sum_{k = 1}^{m} \sum_{j = n_k + 1}^{n_{k + 1}} a_j. \label{eq:::---12380-18.16}
\end{align}
若 \( a_j \leqslant slant 0, n_m < j \leqslant slant n_{m + 1} \)，可得 \eqref{eq:::---12380-18.16} 的类似式
\begin{align}
\sum_{k = 1}^{m} \sum_{j = n_k + 1}^{n_{k + 1}} a_j \leqslant slant \sum_{j = 1}^{n} a_j \leqslant slant \sum_{k = 1}^{m - 1} \sum_{j = n_k + 1}^{n_{k + 1}} a_j. \label{eq:::---12380-18.17}
\end{align}
...
\begin{cases} 
\text{收敛}, & p > 1 \\
\text{和} \sum_{n = 1}^{\infty} a_n \text{同敛散}, & 0 < p \leqslant slant 1 
\end{cases}. 
\end{align*}
\end{proposition}
\begin{note}
...
当 \( p > 1 \)，注意到
\[
\sum_{n = 2}^{\infty} \frac{a_n}{S_n^p} = \sum_{n = 2}^{\infty} \frac{S_n - S_{n - 1}}{S_n^p} = \sum_{n = 2}^{\infty} \int_{S_{n - 1}}^{S_n} \frac{1}{S_n^p} \mathrm{d}x \leqslant slant \sum_{n = 2}^{\infty} \int_{S_{n - 1}}^{S_n} \frac{1}{x^p} \mathrm{d}x = \int_{S_1}^{\sum\limits_{n = 1}^{\infty} a_n} \frac{1}{x^p} \mathrm{d}x,
\]
可以看到无论 \( \sum_{n = 1}^{\infty} a_n \) 收敛性如何都有 \( \sum_{n = 1}^{\infty} \frac{a_n}{S_n^p} \) 收敛。

当 \( 0 < p \leqslant slant 1 \)，若 \( \sum_{n = 1}^{\infty} a_n \) 收敛，则有 \( \frac{a_n}{S_n^p} \sim \frac{a_n}{\left( \sum\limits_{n = 1}^{\infty} a_n \right)^p}=ca_n, n \to \infty \)，其中$c$是某个常数,故 \( \sum_{n = 1}^{\infty} \frac{a_n}{S_n^p} \) 收敛。当 \( \sum_{n = 1}^{\infty} a_n \) 发散，我们对任何充分大的 \( m, k \in \mathbb{N} \) 都有
\[
1 - \frac{S_k}{S_{k + m}} = \frac{S_{k + m} - S_k}{S_{k + m}} = \sum_{n = k + 1}^{k + m} \frac{a_n}{S_{k + m}} \leqslant slant \sum_{n = k + 1}^{k + m} \frac{a_n}{S_n} \leqslant slant \sum_{n = k + 1}^{k + m} \frac{a_n}{S_n^p}.
\]
...
我们有
\[
0 \leqslant slant \lim_{x \to 1^-} \frac{b_n x^n}{\sum\limits_{k=0}^{\infty} b_k x^k} = \lim_{x \to 1^-} \frac{b_n x^n}{g(x)} = 0.
\]
...
我们有
\[
0 \leqslant slant \frac{b_n x^n}{\sum\limits_{k=0}^{\infty} b_k x^k} \leqslant slant \frac{b_n x^n}{b_n x^n + b_{n+1} x^{n+1}} = \frac{b_n}{b_n + b_{n+1} x},
\]
...
\[
\sum_{k=2}^{n-1}{\frac{1}{\left( n-k \right) \ln k}}\geqslant slant \sum_{k=2}^{n-1}{\frac{1}{\left( n-k \right) \ln \left( n-1 \right)}}=\frac{\sum\limits_{k=1}^{n-2}{\frac{1}{k}}}{\ln \left( n-1 \right)}\rightarrow 1,n\rightarrow \infty .
\]
另一方面，对$\forall \varepsilon \in (0,1)$，我们有
\begin{align*}
\sum_{k=2}^{n-1}{\frac{1}{\left( n-k \right) \ln k}}&\leqslant slant \sum_{2\leqslant slant k\leqslant slant \varepsilon n}{\frac{1}{\left( n-k \right) \ln k}}+\sum_{\varepsilon n\leqslant slant k\leqslant slant n-1}{\frac{1}{\left( n-k \right) \ln k}}
\\
&\leqslant slant \frac{1}{n\left( 1-\varepsilon \right)}\sum_{2\leqslant slant k\leqslant slant \varepsilon n}{\frac{1}{\ln 2}}+\sum_{\varepsilon n\leqslant slant k\leqslant slant n-1}{\frac{1}{\left( n-k \right) \ln \varepsilon n}}
\\
&\leqslant slant \frac{\varepsilon n}{n\left( 1-\varepsilon \right) \ln 2}+\frac{\sum\limits_{\varepsilon n\leqslant slant k\leqslant slant n-1}{\frac{1}{k}}}{\ln \varepsilon +\ln n}.
\end{align*}
令$n\rightarrow \infty$得
\[
\varlimsup_{n\rightarrow \infty}\sum_{k=2}^{n-1}{\frac{1}{\left( n-k \right) \ln k}}\leqslant slant \frac{\varepsilon}{\left( 1-\varepsilon \right) \ln 2}+1.
\]
再令$\varepsilon \rightarrow 0^+$得
\[
\varlimsup_{n\rightarrow \infty}\sum_{k=2}^{n-1}{\frac{1}{\left( n-k \right) \ln k}}\leqslant slant 1.
\]
...
事实上，我们有
\[
\left| \sum_{k = 0}^{n} \frac{(-1)^n}{\sqrt{(n - k + 1)(k + 1)}} \right| = \sum_{k = 0}^{n} \frac{1}{\sqrt{(n - k + 1)(k + 1)}} \geqslant slant \sum_{k = 0}^{n} \frac{1}{\sqrt{\left(n - \frac{n}{2} + 1\right)\left(\frac{n}{2} + 1\right)}} = \frac{n + 1}{\frac{n}{2} + 1} \to 2,
\]
...
\begin{align*}
\lim\limits_{n\to\infty} \left| \sum\limits_{i=0}^{n} a_i B_{n-i} \right| \leqslant slant \lim\limits_{n\to\infty} \sum\limits_{i=0}^{n} |a_i| \cdot |B_{n-i}| = \sum\limits_{i=0}^{\infty} |a_i| \cdot 0 = 0
\end{align*}
这就证明了$\sum\limits_{n=0}^{\infty} c_n$收敛.

2. 若$\sum\limits_{n=0}^{\infty} a_n,\sum\limits_{n=0}^{\infty} b_n$都绝对收敛.注意到
\begin{align*}
\sum\limits_{k=0}^{n} |c_k| \leqslant slant \sum\limits_{k=0}^{n} \sum\limits_{i=0}^{k} |a_i b_{k-i}| = \sum\limits_{i=0}^{n} \sum\limits_{k=i}^{n} |a_i b_{k-i}| = \sum\limits_{i=0}^{n} \left( |a_i| \sum\limits_{k=i}^{n} |b_{k-i}| \right)
\end{align*}
于是由\refpro{proposition:命题:3.422164}就有
\begin{align*}
\sum\limits_{k=0}^{\infty} |c_k| \leqslant slant \lim\limits_{n\to\infty} \sum\limits_{i=0}^{n} \left( |a_i| \sum\limits_{k=i}^{n} |b_{k-i}| \right) = \sum\limits_{i=0}^{\infty} |a_i| \cdot \sum\limits_{i=0}^{\infty} |b_i| < \infty
\end{align*}
...
现在
\begin{align*}
\left| \sum\limits_{k=1}^{n} (-1)^k a_k \sum\limits_{j=0}^{k-1} (-1)^{n-j} b_{n-j} \right| &\leqslant slant \sum\limits_{k=1}^{n} a_k \left| \sum\limits_{j=0}^{k-1} (-1)^{n-j} b_{n-j} \right| \\
&\leqslant slant \sum\limits_{k=1}^{n} a_k b_{n - k + 1} \leqslant slant \sum\limits_{k=0}^{n+1} a_k b_{n - k + 1} = c_{n+1}
\end{align*}
