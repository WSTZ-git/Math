...
\begin{example}
设$f_0(x)\in R[a,b],\ f_0(x)>0,\forall x\in [a,b]$,且
\begin{align*}
f_n(x)=\sqrt{\int_0^x f_{n-1}(t)\mathrm{d}t},
\end{align*}
证明:
\begin{align*}
\lim\limits_{n\to\infty}f_n(x)=\frac{x}{2},\quad \forall x\in [a,b].
\end{align*}
\end{example}
\begin{proof}
若$a<0$, 则
\begin{align*}
f_{1}^{2}\left( a \right) =\int_0^a{f_0\left( t \right) \mathrm{d}t}=-\int_a^0{f_0\left( t \right) \mathrm{d}t}\leqslant 0.
\end{align*}
从而$f_1\left( a \right) =0$, 即
\begin{align*}
0=f_1\left( a \right) =\sqrt{\int_0^a{f_0\left( t \right) \mathrm{d}t}}\Longleftrightarrow \int_0^a{f_0\left( t \right) \mathrm{d}t}=0,
\end{align*}
这与$f_0\left( x \right) >0\left( \forall x\in \left[ a,b \right] \right)$矛盾! 故$a\geqslant 0$.

再记$f\left( x \right) =\frac{x}{2}$, 则
\begin{align*}
\sqrt{\int_0^x{f\left( t \right) \mathrm{d}t}}=f\left( x \right) ,\quad \forall x\in \left[ a,b \right] .
\end{align*}
由$f_0,f\in R\left[ a,b \right]$知, 存在$M>0$, 使得
\begin{align*}
\left| f_0\left( x \right) -f\left( x \right) \right|\leqslant M,\quad \forall x\in \left[ a,b \right] .
\end{align*}
\begin{enumerate}[(i)]
\item 当$a>0$时, 由题设知$f_0\left( x \right) >0,\forall x\in \left[ a,b \right]$. 假设$f_n\left( x \right) >0,\forall x\in \left[ a,b \right]$. 则
\begin{align*}
f_{n+1}\left( x \right) =\sqrt{\int_0^x{f_n\left( t \right) \mathrm{d}t}}>0,\quad \forall x\in \left[ a,b \right] .
\end{align*}
由数学归纳法可得
\begin{align*}
f_n\left( x \right) >0,\forall x\in \left[ a,b \right] ,n\in \mathbb{N} .
\end{align*}
假设$\left| f_n\left( x \right) -f\left( x \right) \right|\leqslant \frac{2}{a}\cdot \frac{Mx^n}{n!},\forall x\in \left[ a,b \right]$. 从而
\begin{align*}
\left| f_{n+1}\left( x \right) -f\left( x \right) \right|&=\left| \sqrt{\int_0^x{f_n\left( t \right) \mathrm{d}t}}-\sqrt{\int_0^x{f\left( t \right) \mathrm{d}t}} \right|=\frac{\left| \int_0^x{f_n\left( t \right) \mathrm{d}t}-\int_0^x{f\left( t \right) \mathrm{d}t} \right|}{\sqrt{\int_0^x{f_n\left( t \right) \mathrm{d}t}}+\sqrt{\int_0^x{f\left( t \right) \mathrm{d}t}}} \\
&\leqslant \frac{\int_0^x{\left| f_n\left( x \right) -f\left( x \right) \right|\mathrm{d}t}}{\sqrt{\int_0^x{f_n\left( t \right) \mathrm{d}t}}+\sqrt{\int_0^x{f\left( t \right) \mathrm{d}t}}}\leqslant \frac{\int_0^x{\frac{Mx^n}{n!}\mathrm{d}t}}{\sqrt{\int_0^x{f\left( t \right) \mathrm{d}t}}}=\frac{\frac{Mx^{n+1}}{\left( n+1 \right) !}}{f\left( x \right)} \\
&=\frac{2}{x}\cdot \frac{Mx^{n+1}}{\left( n+1 \right) !}\leqslant \frac{2}{a}\cdot \frac{Mx^{n+1}}{\left( n+1 \right) !}.
\end{align*}
因此
\begin{align*}
\lim\limits_{n\rightarrow \infty}\sup\limits_{x\in \left[ a,b \right]}\left| f_{n+1}\left( x \right) -f\left( x \right) \right|\leqslant \lim\limits_{n\rightarrow \infty}\left[ \frac{2}{a}\cdot \frac{Mx^{n+1}}{\left( n+1 \right) !} \right] =0.
\end{align*}
故此时$\{ f_n \}$在$\left[ a,b \right]$上一致收敛到$f\left( x \right) =\frac{x}{2}$.

\item 当$a=0$时, 此时
\begin{align*}
f_n\left( 0 \right) =\sqrt{\int_0^0{f_{n-1}\left( t \right) \mathrm{d}t}}=0=f\left( 0 \right) ,\quad \forall n\in \mathbb{N} .
\end{align*}
故$\lim\limits_{n\rightarrow \infty}f_n\left( 0 \right) =f\left( 0 \right)$. 再考虑任意$x\in \left( 0,b \right]$, 由题设知$f_0\left( x \right) >0,\forall x\in \left( 0,b \right]$. 假设$f_n\left( x \right) >0,\forall x\in \left( 0,b \right]$. 则
\begin{align*}
f_{n+1}\left( x \right) =\sqrt{\int_0^x{f_n\left( t \right) \mathrm{d}t}}>0,\quad \forall x\in \left( 0,b \right] .
\end{align*}
由数学归纳法可得
\begin{align*}
f_n\left( x \right) >0,\forall x\in \left( 0,b \right] ,n\in \mathbb{N} .
\end{align*}
假设$\left| f_n\left( x \right) -f\left( x \right) \right|\leqslant \frac{2}{x}\cdot \frac{Mx^n}{n!},\forall x\in \left( 0,b \right]$. 从而
\begin{align*}
\left| f_{n+1}\left( x \right) -f\left( x \right) \right|&=\left| \sqrt{\int_0^x{f_n\left( t \right) \mathrm{d}t}}-\sqrt{\int_0^x{f\left( t \right) \mathrm{d}t}} \right|=\frac{\left| \int_0^x{f_n\left( t \right) \mathrm{d}t}-\int_0^x{f\left( t \right) \mathrm{d}t} \right|}{\sqrt{\int_0^x{f_n\left( t \right) \mathrm{d}t}}+\sqrt{\int_0^x{f\left( t \right) \mathrm{d}t}}} \\
&\leqslant \frac{\int_0^x{\left| f_n\left( x \right) -f\left( x \right) \right|\mathrm{d}t}}{\sqrt{\int_0^x{f_n\left( t \right) \mathrm{d}t}}+\sqrt{\int_0^x{f\left( t \right) \mathrm{d}t}}}\leqslant \frac{\int_0^x{\frac{Mx^n}{n!}\mathrm{d}t}}{\sqrt{\int_0^x{f\left( t \right) \mathrm{d}t}}} \\
&=\frac{\frac{Mx^{n+1}}{\left( n+1 \right) !}}{f\left( x \right)}=\frac{2}{x}\cdot \frac{Mx^{n+1}}{\left( n+1 \right) !}.
\end{align*}
令$n\rightarrow \infty$, 得
\begin{align*}
\lim\limits_{n\rightarrow \infty}\left| f_{n+1}\left( x \right) -f\left( x \right) \right|\leqslant \lim\limits_{n\rightarrow \infty}\left[ \frac{2}{x}\cdot \frac{Mx^{n+1}}{\left( n+1 \right) !} \right] =0.
\end{align*}
故此时$\lim\limits_{n\rightarrow \infty}f_n\left( x \right) =f\left( x \right) ,\forall x\in \left( 0,b \right]$. 
\end{enumerate}
综上所述, 我们有
\begin{align*}
\left( \mathrm{i} \right) \text{当}a>0\text{时},\text{有}f_n\left( x \right) \rightrightarrows f\left( x \right) ,\,\,\forall x\in \left[ a,b \right] ;\quad \left( \mathrm{ii} \right) \text{当}a=0\text{时},\text{有}\lim_{n\rightarrow \infty} f_n\left( x \right) =f\left( x \right) ,\,\,\forall x\in \left[ a,b \right] .
\end{align*}
