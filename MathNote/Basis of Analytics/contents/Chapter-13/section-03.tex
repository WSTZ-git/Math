...
\[
\ln M - \ln m = \ln f(y) - \ln f(x) = \int_{x}^{y} \frac{f'(t)}{f(t)} \, dt \leqslant \int_{0}^{1} \frac{1}{f(t)} \, dt = \beta.
\]  
...
\begin{align}
\int_{0}^{t} f^n(x) \, dx \leqslant \frac{e^{(n + 1)\beta_1(t)} - 1}{n + 1} f^{n + 1}(t), \label{5.1.39}
\end{align}  
\begin{align}
\int_{t}^{1} f^n(x) \, dx \leqslant \frac{e^{(n + 1)\beta_2(t)} - 1}{n + 1} f^{n + 1}(t). \label{5.1.40}
\end{align}  
将以上两式相加，可得  
\begin{align}
\int_{0}^{1} f^n(x) \, dx \leqslant \frac{e^{(n + 1)\beta_1(t)} + e^{(n + 1)\beta_2(t)} - 2}{n + 1} f^{n + 1}(t). \label{5.1.41}
\end{align}  
...
\[
\int_{0}^{1} f^n(x) \, dx \leqslant \frac{e^{(n + 1)(\beta_1(t) + \beta_2(t))} - 1}{n + 1} f^{n + 1}(t) = \frac{e^{(n + 1)\beta} - 1}{n + 1} f^{n + 1}(t),
\]  
