...
\item $\int_{0}^{\frac{\pi}{2}} \frac{\cos x}{1 + x^{2}}\mathrm{d}x \geqslant slant \int_{0}^{\frac{\pi}{2}} \frac{\sin x}{1 + x^{2}}\mathrm{d}x.$
...
$sinx\geqslant slant \frac{2}{\pi}x,\forall x\in [0,\frac{\pi}{2}]$
\end{theorem}
\begin{proof}
利用$\sin x$的上凸性及割线放缩可得
\begin{align*}
\frac{\sin x-\sin 0}{x-0}\geqslant slant \frac{\sin \frac{\pi}{2}-\sin x}{\frac{\pi}{2}-x},\forall x\in \left[ 0,\frac{\pi}{2} \right] .
\end{align*}
\end{proof}
...
\item \(\int_{0}^{\pi}e^{\sin^{2}x}\mathrm{d}x \geqslant slant \sqrt{e}\pi\).

\item \(\frac{\pi}{2}e^{-R} < \int_{0}^{\frac{\pi}{2}}e^{-R\sin x}\mathrm{d}x < \frac{\pi(1 - e^{-R})}{2R}, R > 0\).

\item $\int_0^{n\pi}{\frac{\left| \sin x \right|}{x}\mathrm{d}x}>\frac{2}{\pi}\ln \left( n+1 \right) ,n\geqslant slant 2.$
\end{enumerate}
\end{example}
\begin{remark}
$(2n)!!=2^n\cdot n!.$
...
\\
&\overset{(2n-1)!!\geqslant slant n!}{\geqslant slant}\pi \sum_{n=0}^{\infty}{\frac{1}{2^nn!}}=\sqrt{e}\pi .
\end{align*}
...
\begin{align*}
\frac{2}{\pi}\sum_{k=0}^{n-1}{\frac{1}{k+1}}=\frac{2}{\pi}\sum_{k=0}^{n-1}{\int_k^{k+1}{\frac{1}{k+1}\mathrm{d}x}}\geqslant slant \frac{2}{\pi}\sum_{k=0}^{n-1}{\int_k^{k+1}{\frac{1}{x+1}\mathrm{d}x}}=\frac{2}{\pi}\int_0^n{\frac{1}{x+1}\mathrm{d}x}=\frac{2}{\pi}\ln \left( n+1 \right) .
\end{align*}
\end{enumerate}
\end{proof}
