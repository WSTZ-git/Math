...
\end{remark}
\begin{proof}
{\color{blue}证法一:}反证，若\(|f'(x)| \leqslant \frac{4}{(b - a)^2}\int_{a}^{b}\left|f(x)\right| \mathrm{d}x\triangleq M\)，则\hyperlink{example0.5----:不妨设的原因}{不妨设\(\int_{a}^{b}f(x)\mathrm{d}x > 0\)}，由 Hermite 插值定理可知，存在\(\theta_1 \in (a, x)\)，\(\theta_2 \in (x, b)\)，使得
\begin{align*}
...
{\color{blue}证法二:}记上式右端为 \( M \)。假设对一切 \( c \in [a,b] \) 有 \( |f'(c)| \leqslant M \)，下面推出矛盾。首先根据微分中值定理，对于 \( x \in \left[ a, \frac{a + b}{2} \right] \) 存在 \( \xi \in (a,x) \)，使
\[
f(x) = f(x) - f(a) = f'(\xi)(x - a),
\]
由假设，有
\begin{align}
|f(x)| \leqslant M(x - a), \quad x \in \left[ a, \frac{a + b}{2} \right], \label{eq:::23523523424jrioj53311}
\end{align}
因而
\begin{align}
\int_{a}^{\frac{a + b}{2}} |f(x)| \, \mathrm{d}x \leqslant \frac{1}{2} \left( \frac{b - a}{2} \right)^2 M. \label{eq:::23523523424jrioj53312}
\end{align}
...
由假设，有
\begin{align}
|f(x)| \leqslant M(b - x), \quad x \in \left[ \frac{a + b}{2}, b \right], 
\end{align}
因而
\begin{align}
\int_{\frac{a + b}{2}}^{b} |f(x)| \, \mathrm{d}x \leqslant \frac{1}{2} \left( \frac{b - a}{2} \right)^2 M. \label{eq:::23523523424jrioj53314}
\end{align}
将式 \(\eqref{eq:::23523523424jrioj53312}\) 与式 \(\eqref{eq:::23523523424jrioj53314}\) 相加可得
\[
\int_{a}^{b} |f(x)| \, \mathrm{d}x \leqslant \left( \frac{b - a}{2} \right)^2 M = \int_{a}^{b} |f(x)| \, \mathrm{d}x.
\]
这说明式 \(\eqref{eq:::23523523424jrioj53312}\) 与式 \(\eqref{eq:::23523523424jrioj53314}\) 必须是等式，因而式 \(\eqref{eq:::23523523424jrioj53311}\) 与式 \(\eqref{eq:::23523523424jrioj53313}\) 必须成为等式。于是
\[
f^2(x) = 
\begin{cases} 
