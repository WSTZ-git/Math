...
\end{align*}
由$f$的连续性知$E_n$是一列闭集，根据条件有$\bigcup\limits_{n=1}^{\infty}{E_n}=\left[ 1,+\infty \right).$于是由Baire纲定理知，存在$N\in \mathbb{N}$及$\left( u,v \right) \subseteq \left[ 1,+\infty \right)$，使得$\left( u,v \right) \subseteq E_N.$即对$\forall k\geqslant N,\forall x\in \left( u,v \right)$有
\begin{align*}
