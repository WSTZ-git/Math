...
从而\(\varlimsup_{n \to +\infty} a_n b_n \geqslant slant \lim_{n \to +\infty} a_{n_k} b_{n_k} = ab\).
又由上下极限的性质,可知\(\varlimsup_{n \to +\infty} a_n b_n \leqslant slant \varlimsup_{n \to +\infty} a_n \cdot \varlimsup_{n \to +\infty} b_n = ab\).
...
\begin{align*}
f_1(n,\delta) \leqslant slant a_n \leqslant slant f_2(n,\delta),\forall n > N .
\end{align*}
于是当\(n > \max\{N,N'\}\)时,对\(\forall \eta > 0\),我们都有
\begin{align*}
A - \eta < g_1(\delta) - \frac{\eta}{2} < f_1(n,\delta) \leqslant slant a_n \leqslant slant f_2(n,\delta) < g_2(\delta) + \frac{\eta}{2} < A + \eta.
\end{align*}
