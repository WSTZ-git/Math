...
我们有如下的
\begin{enumerate}
\item $\varlimsup_{n \to \infty} (a_n + b_n) \leqslant  \varlimsup_{n \to \infty} a_n + \varlimsup_{n \to \infty} b_n.$

\item  $-\varlimsup_{n \to \infty} a_n = \varliminf_{n \to \infty} (-a_n).$

\item  $\varliminf_{n \to \infty} (a_n + b_n) \geqslant  \varliminf_{n \to \infty} a_n + \varliminf_{n \to \infty} b_n.$

\item\hypertarget{上极限的性质命题(4)}{4}.若\(\lim_{n \to +\infty} b_n = b\),\(\varlimsup_{n \to +\infty} a_n = a\),则\(\varlimsup_{n \to +\infty} a_n b_n = ab\).
\end{enumerate}
\end{proposition}
\begin{note}
...
\item 由于\(\varlimsup_{n \to +\infty} a_n = a\),因此我们可设\(\lim_{k \to +\infty} a_{n_k} = a\).
...
\[
f_1(n,\varepsilon) \leqslant  a_n \leqslant  f_2(n,\varepsilon), \forall n \geqslant  N,
\]
这里
\[
...
上式两边令$n\to+\infty$,则有
\begin{align*}
\underset{n\rightarrow +\infty}{{\varliminf }}f_1(n,\varepsilon )\leqslant \underset{n\rightarrow +\infty}{{\varliminf }}a_n,\underset{n\rightarrow +\infty}{{\varlimsup }}a_n\leqslant \underset{n\rightarrow +\infty}{{\varlimsup }}f_2(n,\varepsilon ),\forall \varepsilon >0.
\end{align*}
由$\varepsilon$的任意性,两边令$\varepsilon\to 0^+$,可得
\begin{align*}
A=\underset{\varepsilon \rightarrow 0^+}{\lim}\underset{n\rightarrow +\infty}{{\varliminf }}f_1(n,\varepsilon )\leqslant \underset{n\rightarrow +\infty}{{\varliminf }}a_n,\underset{n\rightarrow +\infty}{{\varlimsup }}a_n\leqslant \underset{\varepsilon \rightarrow 0^+}{\lim}\underset{n\rightarrow +\infty}{{\varlimsup }}f_2(n,\varepsilon )=A.
\end{align*}
又显然有$\underset{n\rightarrow +\infty}{{\varliminf }}a_n\leqslant \underset{n\rightarrow +\infty}{{\varlimsup }}a_n$,于是
\begin{align*}
A=\underset{\varepsilon \rightarrow 0^+}{\lim}\underset{n\rightarrow +\infty}{{\varliminf }}f_1(n,\varepsilon )\leqslant \underset{n\rightarrow +\infty}{{\varliminf }}a_n\leqslant \underset{n\rightarrow +\infty}{{\varlimsup }}a_n\leqslant \underset{\varepsilon \rightarrow 0^+}{\lim}\underset{n\rightarrow +\infty}{{\varlimsup }}f_2(n,\varepsilon )=A.
\end{align*}
