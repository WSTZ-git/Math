...
设$\Omega \subset \mathbb{R}^{n+m}$是开集，函数$F:\Omega \to \mathbb{R}^m$，$F=(F_1,F_2,\dots,F_m)$，其中每个$F_i=F_i(x_1,\dots,x_n,y_1,\dots,y_m)$. 记自变量为$(x,y)\in \mathbb{R}^n\times \mathbb{R}^m$. 假设：
\begin{enumerate}[(1)]
