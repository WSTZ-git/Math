...
\]
则对 \( \mathbb{x}_0 \in V \) 满足 \( \frac{\partial f}{\partial x_i}(\mathbb{x}_0) = 0, i = 1, 2, \cdots, n \) 有
\begin{enumerate}
\item \( Hf(\mathbb{x}_0) \) 是正定的, 则 \( \mathbb{x}_0 \) 是 \( f \) 严格极小值点;

\item \( Hf(\mathbb{x}_0) \) 是负定的, 则 \( \mathbb{x}_0 \) 是 \( f \) 严格极大值点;

\item \( Hf(\mathbb{x}_0) \) 是不定的(既不是正定,也不是负定), 则 \( \mathbb{x}_0 \) 不是 \( f \) 极值点;

\item 若 \( \mathbb{x}_0 \) 是 \( f \) 极小值点, 则 \( Hf(\mathbb{x}_0) \) 是半正定的;

\item 若 \( \mathbb{x}_0 \) 是 \( f \) 极大值点, 则 \( Hf(\mathbb{x}_0) \) 是半负定的.
\end{enumerate}
\end{theorem}
\begin{proof}
