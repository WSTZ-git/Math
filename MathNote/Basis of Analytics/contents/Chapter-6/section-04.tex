...
\end{note}
\begin{remark}
\hypertarget{找这两个数列的方法}{\textbf{\ref{example5.5(6)}中找这两个数列$\boldsymbol{x}_{\boldsymbol{n}}^{\prime}=\sqrt{\mathbb{2}\boldsymbol{n\pi }},\boldsymbol{x}_{\boldsymbol{n}}^{\prime\prime}=\sqrt{\mathbb{2}\boldsymbol{n\pi }}+\frac{\mathbb{1}}{\sqrt{\boldsymbol{n}}}$的方式:}}待定 $c_n$，令 $x_{n}^{\prime} = \sqrt{2n\pi}$，$x_{n}^{\prime\prime} = \sqrt{2n\pi} + c_n$，我们希望
\[
...
\end{example}
\begin{note}
\hypertarget{找两个数列的方式123}{\textbf{找这两个数列$\boldsymbol{x}_{\boldsymbol{n}}^{\prime}=\mathbb{2}\boldsymbol{n\pi },\boldsymbol{x}_{\boldsymbol{n}}^{\prime\prime}=\mathbb{2}\boldsymbol{n\pi }+\boldsymbol{n}^{\mathbb{1}-\boldsymbol{\alpha }}$的方法:}}
