...
\end{note}
\begin{proof}
当$n=2$时,由Jensen下凸的定义立得.假设当$n=k$时,\eqref{equation-Jesen不等式特例}式成立.现在考虑$n=k+1$时,记
\begin{align*}
...
\end{align*}
由数学归纳法知\eqref{equation-Jesen不等式特例}式成立.

再证明不等式\eqref{equation-Jesen不等式}，当\(m = 2\)，设有理数\(\frac{p}{q}\in[0,1],q>0\)，运用不等式\eqref{equation-Jesen不等式特例}，我们有
\[
