...
\begin{align*}
f_n(x)\geqslant slant 0,\forall n\in \mathbb{N}_1.
\end{align*}
...
又由于对 \(\forall x\in [a,b]\)，都有 \(f_n(x)\) 关于 \(n\) 单调递减，因此 \(U_n\subset U_{n + 1},\forall n\in \mathbb{N}_1\)。这是因为对 \(\forall x\in U_n\)，都有 \(f_{n + 1}(x)\leqslant slant f_n(x)<\varepsilon\)，于是 \(x\in U_{n + 1}\)。
...
故对 \(\forall n\geqslant slant N\)，由 \(U_n\subset U_{n + 1},\forall n\in \mathbb{N}_1\) 可知，\([a,b]\subset U_N\subset U_n\)，即对 \(\forall n\geqslant slant N\),都有 \(f_n(x)<\varepsilon,\forall x\in [a,b]\)。
...
\begin{align}
|f(y)-f(x)|<\varepsilon,\forall |y - x|\leqslant slant \delta.\label{equationDnin0.2-1.1}
\end{align}
设 \(a = x_0<x_1<\cdots <x_m = b\)，使得 \(x_i - x_{i + 1}\leqslant slant \delta,i = 0,1,2,\cdots,m\)。
由 \(\lim_{n\rightarrow \infty}f_n(x)=f(x)\) 可知，存在 \(N\in \mathbb{N}\)，使得当 \(n\geqslant slant N\) 时，有
\begin{align}
|f_n(x_i)-f(x_i)|<\varepsilon,\forall i\in \{0,1,2,\cdots,m\}.\label{equationDnin0.2-1.2}
\end{align}
对 \(\forall x\in [a,b]\)，当 \(n\geqslant slant N\) 时，一定存在 \(i\in \{1,2,\cdots,m\}\)，使得 \(x\in [x_{i - 1},x_i]\)。
从而当 \(n\geqslant slant N\) 时，利用\eqref{equationDnin0.2-1.1}和 \eqref{equationDnin0.2-1.2} 式以及 \(f_n\) 的单调性可得
\begin{align*}
|f_n(x)-f(x)|&\leqslant slant |f_n(x)-f_n(x_i)|+|f_n(x_i)-f(x_i)|+|f(x_i)-f(x)|<|f_n(x_{i + 1})-f_n(x_i)|+\varepsilon+\varepsilon\\
&\leqslant slant |f_n(x_{i + 1})-f(x_{i + 1})|+|f(x_{i + 1})-f(x_i)|+|f(x_i)-f_n(x_i)|+2\varepsilon\\
