...
\begin{remark}
\begin{enumerate}
\item $\mathbf{Step}\mathbb{1}$考虑微分方程\(y'=\frac{2x - y}{x}\), 解得\(y=\frac{c}{x}+x\).

$\mathbf{Step}\mathbb{2}$分离常数\(c\)得\(c = x(y - x)\), 常数变易得构造函数\(c(x)=x(f(x)-x)\).

\item $\mathbf{Step}\mathbb{1}$考虑微分方程\(y'=\frac{xy}{1 - x}\), 解得\(y=\frac{ce^{-x}}{x - 1}\).

$\mathbf{Step}\mathbb{2}$分离常数\(c\)得\(c = e^{x}(x - 1)y\), 常数变易得构造函数\(c(x)=e^{x}(x - 1)f(x)\).

\item $\mathbf{Step}\mathbb{1}$考虑微分方程\(y'=\lambda\left[y-\frac{x}{2}\right]+\frac{1}{2}\), 解得\(y = ce^{\lambda x}+\frac{x}{2}\).

$\mathbf{Step}\mathbb{2}$分离常数\(c\)得\(c=\frac{y-\frac{x}{2}}{e^{\lambda x}}\), 常数变易得构造函数\(c(x)=\frac{f(x)-\frac{x}{2}}{e^{\lambda x}}\).
\end{enumerate}
\end{remark}
\begin{proof}
\begin{enumerate}
