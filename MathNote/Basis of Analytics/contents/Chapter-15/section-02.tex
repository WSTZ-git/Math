...
\begin{example}
设$f \in C^1[0,+\infty), f(0) > 0, f'(x) \geqslant 0, \forall x \in [0,+\infty)$。已知
\begin{align*}
\int_0^{+\infty} \frac{1}{f(x) + f'(x)} \mathrm{d}x < +\infty,
\end{align*}
求证
\begin{align*}
\int_0^{+\infty} \frac{1}{f(x)} \mathrm{d}x < +\infty.
\end{align*}
\end{example}
\begin{proof}
由$f'(x) \geqslant 0$知$f(x)$在$[0,+\infty)$上递增，又$f(0) > 0$，故$\lim_{x \to +\infty} f(x) \in [f(0), +\infty)$，从而$\lim_{x \to +\infty} \frac{1}{f(x)} < +\infty$。于是
\begin{align*}
\int_0^{+\infty} \frac{1}{f(x) + f'(x)} \mathrm{d}x - \int_0^{+\infty} \frac{1}{f(x)} \mathrm{d}x &\leqslant \int_0^{+\infty} \left| \frac{1}{f(x) + f'(x)} - \frac{1}{f(x)} \right| \mathrm{d}x = \int_0^{+\infty} \frac{f'(x)}{|f(x) + f'(x)| |f(x)|} \mathrm{d}x \\
&\leqslant \int_0^{+\infty} \frac{f'(x)}{f^2(x)} \mathrm{d}x = \left. \frac{1}{f(x)} \right|_{+\infty}^0 = \frac{1}{f(0)} - \lim_{x \to +\infty} \frac{1}{f(x)} < +\infty.
\end{align*}
因此
\begin{align*}
\int_0^{+\infty} \frac{1}{f(x)} \mathrm{d}x &\leqslant \int_0^{+\infty} \frac{1}{f(x) + f'(x)} \mathrm{d}x + \left( \int_0^{+\infty} \frac{1}{f(x) + f'(x)} \mathrm{d}x - \int_0^{+\infty} \frac{1}{f(x)} \mathrm{d}x \right) < +\infty.
\end{align*}
