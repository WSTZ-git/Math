...
\end{note}
\begin{proof}
对\(\forall x\geqslant slant a\),一定存在\(n\in\mathbb{N}\),使得\(n\leqslant slant x < n + 1\).从而可得
...
\item 若$|f(x)| > \frac{1}{x\ln x}, \forall x > e$，则由$\int_{e}^{\infty}\frac{1}{x\ln x}\mathrm{d}x = +\infty$可得$\int_e^{\infty}{\left| f\left( x \right) \right|\mathrm{d}x}=+\infty $矛盾! 故存在$x_1 > e$使得$|f(x_1)| \leqslant slant \frac{1}{x_1\ln x_1}$.
同样的，如果$|f(x)| > \frac{1}{2x\ln x}, \forall x > x_1 + 1$，同理可得矛盾！因此必然存在$x_2 > x_1 + 1$使得$|f(x_2)| \leqslant slant \frac{1}{2x_2\ln x_2}$. 依次下去我们得到
\begin{align*}
|f(x_n)| \leqslant slant \frac{1}{nx_n\ln x_n}, n = 1,2,\cdots,
\end{align*}
即
\begin{align*}
...
\end{proposition}
\begin{note}
本题不可直接洛必达. 这个命题是\refpro{proposition:级数收敛平均级数必收敛}的连续版本, 在那里我们先 abel 变换再 Stolz 定理, 于是在这里我们先分部积分再洛必达.
\end{note}
\begin{proof}
...
从而
\begin{align*}
Af(A)\geqslant slant \int_A^{2A}{f(x)\,\mathrm{d}x},\quad \frac{A}{2}f(A)\leqslant slant \int_{\frac{A}{2}}^A{f(x)\,\mathrm{d}x.}
\end{align*}
进而
\begin{align*}
\int_A^{2A}{f(x)\,\mathrm{d}x}\leqslant slant Af(A)\leqslant slant 2\int_{\frac{A}{2}}^A{f(x)\,\mathrm{d}x}.
\end{align*}
...
\leqslant  \int_{\sqrt{A}}^A\frac{xf(x)}{x}\,\mathrm{d}x 
= \int_{\sqrt{A}}^A f(x)\,\mathrm{d}x,
\\ 
\int_A^{A^2} f(x)\,\mathrm{d}x = \int_A^{A^2}\frac{xf(x)}{x}\,\mathrm{d}x 
\leqslant  Af(A)\int_A^{A^2}\frac{1}{x}\,\mathrm{d}x 
= A\ln A f(A).
\end{align*}
从而
\begin{align*}
\int_A^{A^2} f(x)\,\mathrm{d}x \leqslant  A\ln A f(A) 
\leqslant  2\int_{\sqrt{A}}^A f(x)\,\mathrm{d}x
\end{align*}
...
由 \(f\) 有界可得 \(\lim\limits_{x \to +\infty}xf'(x)\leqslant slant 0\)。否则，若 \(\lim\limits_{x \to +\infty}xf'(x)>0\)，则存在 \(C > 0\)，使得
\begin{align}
...
于是由 \(\lim\limits_{x \to +\infty}xf'(x)\leqslant slant 0\) 可知存在 \(X > \max\{a,0\}\)，使得
\begin{align*}
xf'(x)\leqslant slant 0 \Rightarrow f'(x)\leqslant slant 0, \quad x\in (X, +\infty).
\end{align*}
...
\begin{align*}
\left| \int_{f\left( X \right)}^A{\sin y}\mathrm{d}y \right|\leqslant slant 2,\forall A\geqslant slant f\left( X \right) .
\end{align*}
...
\begin{cases} 
\text{收敛}, & -\infty \leqslant slant p < -1 \\
\text{发散}, & -1 < p \leqslant slant +\infty
\end{cases}.
\end{align*}
\end{enumerate}
\end{example}
...
\begin{align*}
\ell -\varepsilon \leqslant slant \frac{f\left( x_0+x \right)}{f\left( x \right)}\leqslant slant \ell +\varepsilon ,\forall x\geqslant slant X.
\end{align*}
...
故
\begin{align*}
\ell -\varepsilon \leqslant slant \frac{a_{n+1}}{a_n}\leqslant slant \ell +\varepsilon ,\forall n>\frac{X-a}{x_0}.
\end{align*}
...
\begin{align*}
p-\varepsilon \leqslant slant \frac{\ln f\left( x \right)}{\ln x}\leqslant slant p+\varepsilon \Longleftrightarrow x^{p-\varepsilon}\leqslant slant f\left( x \right) \leqslant slant x^{p+\varepsilon}.
\end{align*}
于是
\begin{align*}
\frac{1}{x^{-p+\varepsilon}}\leqslant slant f\left( x \right) \leqslant slant \frac{1}{x^{-p-\varepsilon}},\forall x>X.
\end{align*}
再由比较判别法即得结论.
\end{enumerate}
\end{proof}
...
\begin{align*}
\frac{1}{x^{-p}}\leqslant slant f(x)\leqslant slant \frac{1}{x^{-p}},\forall x>X.
\end{align*}
因为$X$是与$\varepsilon$有关的.因此只有固定$\varepsilon$时,才有$\frac{1}{x^{-p+\varepsilon}}\leqslant slant f\left( x \right) \leqslant slant \frac{1}{x^{-p-\varepsilon}},\forall x>X$成立.故再利用比较判别法式,不能令$\varepsilon\to 0$.
\end{remark}
...
于是
\begin{align*}
\int_0^{\infty} \left| \frac{1}{f(x) + f'(x)} - \frac{1}{f(x)} \right| \, \mathrm{d}x = \int_0^{\infty} \frac{f'(x)}{f(x) \left[ f(x) + f'(x) \right]} \, \mathrm{d}x \leqslant slant \int_0^{\infty} \frac{f'(x)}{f^2(x)} \, \mathrm{d}x = \int_0^{\infty} \frac{1}{f^2(x)} \, df(x) = \frac{1}{f(0)} - \frac{1}{f(+\infty)} < +\infty.
\end{align*}
注意到
\begin{align*}
\frac{1}{f(x)} \leqslant slant \left| \frac{1}{f(x)} - \frac{1}{f(x) + f'(x)} \right| + \frac{1}{f(x) + f'(x)}.
\end{align*}
又$\int_0^{\infty} \frac{1}{f(x) + f'(x)} \, \mathrm{d}x < +\infty$,故$\int_0^{\infty} \frac{1}{f(x)} \, \mathrm{d}x < \infty$.
\end{proof}

\begin{example}
设非负函数$f \in C(\mathbb{R})$使得对任何$k \in \mathbb{N}$都有$\int_{-\infty}^{\infty} e^{-\frac{|x|}{k}} f(x) \mathrm{d}x \leqslant slant M$, 证明$\int_{-\infty}^{\infty} f(x) \mathrm{d}x$收敛且$\int_{-\infty}^{\infty} f(x) \mathrm{d}x \leqslant slant M$.
\end{example}
\begin{note}
利用拟合法的想法证明反常积分收敛.
\end{note}
\begin{proof}
{\color{blue} 证法一:}$\forall a < b$, 注意到 $1 - x \leqslant slant e^{-x}, \forall x \in \mathbb{R}$. 从而对 $\forall k \in \mathbb{N}$, 都有
\begin{align*}
\int_a^b \left( 1 - \frac{|x|}{k} \right) f(x) \, \mathrm{d}x \leqslant slant \int_a^b e^{-\frac{|x|}{k}} f(x) \, \mathrm{d}x \leqslant slant M.
\end{align*}
于是
\begin{align*}
\int_a^b f(x) \, \mathrm{d}x \leqslant slant \frac{1}{k} \int_a^b |x| f(x) \, \mathrm{d}x + M.
\end{align*}
令 $k \to +\infty$ 得 $\int_a^b f(x) \, \mathrm{d}x \leqslant slant M$. 再由 $a, b$ 的任意性可得 $\int_{-\infty}^{+\infty} f(x) \, \mathrm{d}x \leqslant slant M$.

{\color{blue} 证法二:}由\hyperref[Real Analysis-lemma:Fatou引理]{Fatou引理}可得
\begin{align*}
\int_{-\infty}^{+\infty}{f\left( x \right) \mathrm{d}x}=\int_{-\infty}^{+\infty}{\underset{k\rightarrow +\infty}{\underline{\lim }}e^{-\frac{\left| x \right|}{k}}f\left( x \right) \mathrm{d}x}\leqslant slant \underset{k\rightarrow +\infty}{\underline{\lim }}\int_{-\infty}^{+\infty}{e^{-\frac{\left| x \right|}{k}}f\left( x \right) \mathrm{d}x}\leqslant slant M.
\end{align*}
\end{proof}
...
\begin{align*}
|f'(x)| \leqslant slant M, \forall x \geqslant slant 0, \int_0^{\infty} |f(x)|^2 \mathrm{d}x < \infty.
\end{align*}
证明
\begin{align*}
...
由条件可得
\begin{align*}
\int_0^{+\infty} \left| f^2(x) f'(x) \right| \, \mathrm{d}x \leqslant slant M \int_0^{+\infty} \left| f(x) \right|^2 \, \mathrm{d}x < +\infty.
\end{align*}
...
由Cauchy不等式得
\begin{align*}
\int_0^{+\infty}|f(x)f''(x)|\,\mathrm{d}x\leqslant slant\sqrt{\int_0^{+\infty}|f(x)|^2\,\mathrm{d}x\int_0^{+\infty}|f''(x)|^2\,\mathrm{d}x}<+\infty.
\end{align*}
