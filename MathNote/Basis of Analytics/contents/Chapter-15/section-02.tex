...
\end{align*}
令 \(x \to +\infty\)，则由 \(\lim\limits_{x \to +\infty}f(x)\) 存在可得 \(\int_a^{+\infty}f'(t)\,dt\) 收敛。又 \(xf'(x)\) 单调，于是由\nrefpro{proposition:反常积分收敛的基本结论1}{(2)}可知 \(\lim\limits_{x \to +\infty}x\ln x f'(x)=0\)。 
...
\begin{align*}
\int_c^{\infty}{f\left( x \right) \mathrm{d}x}=\int_{\ln c}^{\infty}{f\left( e^t \right) e^tdt}.
\end{align*}
\begin{align*}
