...
(1) $\cos ^{2n+1}x$可以写成$\cos x,\cos 2x,\cdots ,\cos (2n+1)x$的线性组合 ,即$\cos ^{2n+1}x\in L(\cos x,\cos 2x,\cdots ,\cos (2n+1)x)$ ,也即$\cos ^{2n+1}x=\sum_{k=1}^{2n+1}{a_k\cos kx}$ ,其中$a_k\in \mathbb{R}$ ,$k=1,2,\cdots ,2n+1$.
...
\begin{align*}
\cos ^{2n+1}x&=\cos ^2x\cdot \cos ^{2n-1}x=\frac{1+\cos 2x}{2}\cdot \sum_{k=1}^{2n-1}{a_k\cos kx}\\
&=\frac{1}{2}\sum_{k=1}^{2n-1}{a_k\cos kx}+\frac{1}{2}\sum_{k=1}^{2n-1}{a_k\cos 2x\cos kx}=\sum_{k=1}^{2n-1}{\frac{a_k}{2}\cos kx}+\sum_{k=1}^{2n-1}{\frac{a_k}{4}[\cos (k+2)x+\cos (k-2)x]}\\
&=\frac{a_1}{4}(\cos 2x+\cos x)+\frac{a_2}{4}(\cos 4x+1)+\sum_{k=3}^{2n-1}{\frac{a_k}{4}[\cos (k+2)x+\cos (k-2)x]}+\sum_{k=1}^{2n-1}{\frac{a_k}{2}\cos kx}\\
&=\frac{a_1}{4}(\cos 2x+\cos x)+\frac{a_2}{2}\cos 2x+\sum_{k=3}^{2n-1}{\frac{a_k}{4}[\cos (k+2)x+\cos (k-2)x]}+\sum_{k=1}^{2n-1}{\frac{a_k}{2}\cos kx}
\end{align*}  
故$\cos ^{2n+1}x\in L(\cos x,\cos 2x,\cdots ,\cos (2n+1)x)$  
...
从而此时  
\begin{align*}
\int_1^{\infty}{\frac{\cos ^px-\cos ^qx}{x}\mathrm{d}x}&=\int_1^{\infty}{\frac{\sum_{k=1}^p{p_k\cos kx}-\sum_{k=1}^q{q_k\cos kx}}{x}\mathrm{d}x}\\
&=\sum_{k=1}^q{(p_k-q_k)\int_1^{\infty}{\frac{\cos kx}{x}\mathrm{d}x}}+\sum_{k=q+1}^p{p_k\int_1^{\infty}{\frac{\cos kx}{x}\mathrm{d}x}} .\label{100.36}
\end{align*}  
...
于是  
\begin{align*}
\int_1^{\infty}{\frac{\cos ^px-\cos ^qx}{x}\mathrm{d}x}&=\int_1^{\infty}{\frac{\frac{1}{2^{p-1}}\sum_{k=0}^{\frac{p}{2}-1}{\mathrm{C}_{p}^{k}\cos 2\left( \frac{p}{2}-k \right) x}-\sum_{k=1}^q{q_k\cos kx}+\frac{\mathrm{C}_{p}^{\frac{p}{2}}}{2^p}}{x}\mathrm{d}x}\\
&=\int_1^{\infty}{\frac{\frac{1}{2^{p-1}}\sum_{k=0}^{\frac{p}{2}-1}{\mathrm{C}_{p}^{k}\cos 2\left( \frac{p}{2}-k \right) x}-\sum_{k=1}^q{q_k\cos kx}}{x}\mathrm{d}x}+\frac{\mathrm{C}_{p}^{\frac{p}{2}}}{2^p}\int_1^{\infty}{\frac{1}{x}\mathrm{d}x}.
\end{align*}  
