...
\begin{example}
设 $f(x) \in C^1(\mathbb{R}), |f(x)| \leq 1, f'(x) > 0$，证明：对任意 $b > a > 0$ 有
\begin{align*}
...
&\leq \frac{1}{n + \frac{1}{b^2}} + \frac{1}{n + \frac{1}{a^2}} + \frac{2}{a^3 \left(n + \frac{1}{b^2}\right)^2} \int_a^b f\left(nx - \frac{1}{x}\right) \mathrm{d}x \\
&\leq \frac{1}{n + \frac{1}{b^2}} + \frac{1}{n + \frac{1}{a^2}} + \frac{2(b - a)}{a^3 \left(n + \frac{1}{b^2}\right)^2} \rightarrow 0, \, n \rightarrow \infty.
\end{align*}
...
\end{align*}
于是由\hyperref[lemma:Riemann引理]{Riemman引理}可知
\begin{align*}
...
\end{align*}
求导有$p'(x)=\frac{1-xe^{-x}-e^{-x}}{x^2},p'(0)=\frac{1}{2}$，所以$\left|\int_0^\infty p'(x)\cos nx\mathrm{d}x\right|\leq\int_0^\infty \frac{1-xe^{-x}-e^{-x}}{x^2}\mathrm{d}x<\infty.$
