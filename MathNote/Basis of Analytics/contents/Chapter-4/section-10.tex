...
实际上,通过蛛网图分析,也能得到使得$\{x_n\}$发散的临界点$x_1$满足$g(x_1)=x_2,g(x_2)=x_1$,即$g(g(x_1))=x_1$.于是就有
\begin{align}
