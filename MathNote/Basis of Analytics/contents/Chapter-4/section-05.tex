...
\begin{align*}
\underset{n\rightarrow \infty}{{\varliminf }} \frac{y_{n + 1} - y_n}{x_{n + 1} - x_n} \leqslant slant \underset{n\rightarrow \infty}{{\varliminf }} \frac{y_n}{x_n} \leqslant slant \underset{n\rightarrow \infty}{{\varlimsup }} \frac{y_n}{x_n} \leqslant slant \underset{n\rightarrow \infty}{{\varlimsup }} \frac{y_{n + 1} - y_n}{x_{n + 1} - x_n}.
\end{align*}
...
\underset{n\rightarrow \infty}{{\varlimsup }} \frac{y_n}{x_n} \leqslant slant \underset{n\rightarrow \infty}{{\varlimsup }} \frac{y_{n + 1} - y_n}{x_{n + 1} - x_n}.
\end{align}
...
\(\frac{y_{n + 1} - y_n}{x_{n + 1} - x_n} \leqslant slant A + \varepsilon, \forall n \geqslant slant N\).

利用\(x_n\)严格递增时,成立\(y_{n + 1} - y_n \leqslant slant (A + \varepsilon)(x_{n + 1} - x_n), n \geqslant slant N\),然后求和得
\begin{align*}
\sum\limits_{j = N}^{n - 1} (y_{j + 1} - y_j) \leqslant slant (A + \varepsilon) \sum\limits_{j = N}^{n - 1} (x_{j + 1} - x_j), \forall n \geqslant slant N + 1.
\end{align*}
即
\begin{align*}
y_n - y_N \leqslant slant (A + \varepsilon)(x_n - x_N), \forall n \geqslant slant N + 1.
\end{align*}
令$n\to+\infty$,取上极限就得
\begin{align*}
\underset{n\rightarrow \infty}{{\varlimsup }} \frac{y_n}{x_n} = \underset{n\rightarrow \infty}{{\varlimsup }} \frac{\frac{y_n}{x_n} - \frac{y_N}{x_n}}{1 - \frac{x_N}{x_n}} = \underset{n\rightarrow \infty}{{\varlimsup }} \frac{y_n - y_N}{x_n - x_N} \leqslant slant A + \varepsilon.
\end{align*}
...
\begin{theorem}[反向Stolz定理]\label{theorem:反向Stolz定理}
对某个 $C > 0$, 如果有 $n(a_n - a_{n-1}) \geqslant slant -C, \forall n \geqslant slant 2,$ 且
\begin{align*}
...
\end{theorem}
\begin{note}
反向洛必达本身是习题, 作为定理去应用的机会非常少.
\end{note}
\begin{note}
不妨设 $a = 0$, 记
\begin{align*}
b_1 = a_1,\ b_n = a_n - a_{n-1},\ \forall n \geqslant slant 2,\ S_n = a_1 + a_2 + \cdots + a_n.
\end{align*}
...
&\leqslant slant \frac{|S_{n+m}| + |S_n|}{m} + \frac{1}{m} \left[ m \frac{C}{n + 1} + (m - 1) \frac{C}{n + 2} + \cdots + \frac{C}{n + m} \right].
\end{align*}
然后想办法取合适的 $m$ 即可.
\end{note}
\begin{proof}
...
b_1 = a_1,\ b_n = a_n - a_{n-1},\ \forall n \geqslant slant 2,\ S_n = a_1 + a_2 + \cdots + a_n.
\end{align*}
我们有 $b_n \geqslant slant -\frac{C}{n}$.

对任何 $\varepsilon \in (0,1)$, 存在 $N \in \mathbb{N}$, 使得 $|S_n| \leqslant slant n \varepsilon, \forall n \geqslant slant N$, 于是当 $n \geqslant slant N$, 有
\begin{align}
...
&\leqslant slant \frac{|S_{n + [n\sqrt{\varepsilon}]}| + |S_n|}{[n\sqrt{\varepsilon}]} + \frac{1}{[n\sqrt{\varepsilon}]} \left( [n\sqrt{\varepsilon}] \frac{C}{n + 1} + ([n\sqrt{\varepsilon}] - 1) \frac{C}{n + 2} + \cdots + \frac{C}{n + [n\sqrt{\varepsilon}]} \right) \notag \\
&\leqslant slant \frac{|S_{n + [n\sqrt{\varepsilon}]}| + |S_n|}{[n\sqrt{\varepsilon}]} + \frac{1}{[n\sqrt{\varepsilon}]} \left( [n\sqrt{\varepsilon}] \frac{C}{n} + ([n\sqrt{\varepsilon}] - 1) \frac{C}{n} + \cdots + \frac{C}{n} \right) \notag \\
&= \frac{|S_{n + [n\sqrt{\varepsilon}]}| + |S_n|}{[n\sqrt{\varepsilon}]} + \frac{[n\sqrt{\varepsilon}] + 1}{2n} C \notag \\
&\leqslant slant \frac{2n \varepsilon}{[n\sqrt{\varepsilon}]} + \frac{[n\sqrt{\varepsilon}] + 1}{2n} C + \varepsilon, \label{eq:9.130}
\end{align}
于是我们得到
\begin{align*}
\varlimsup_{n \to \infty} a_n \leqslant slant 2\sqrt{\varepsilon} + \frac{C}{2}\sqrt{\varepsilon} + \varepsilon.
\end{align*}

另外一方面, 当 $n \geqslant slant \frac{N}{1 - \sqrt{\varepsilon}} > N$, 有 $n - [n\sqrt{\varepsilon}] \geqslant slant n(1 - \sqrt{\varepsilon}) \geqslant slant N$, 因此
\begin{align}
...
&\geqslant slant \frac{S_n - S_{n - [n\sqrt{\varepsilon}]}}{[n\sqrt{\varepsilon}]} - \frac{([n\sqrt{\varepsilon}] - 1) \frac{C}{n} + ([n\sqrt{\varepsilon}] - 2) \frac{C}{n} + \cdots + \frac{C}{n - [n\sqrt{\varepsilon}] + 2}}{[n\sqrt{\varepsilon}]} \notag \\
&\geqslant slant \frac{S_n - S_{n - [n\sqrt{\varepsilon}]}}{[n\sqrt{\varepsilon}]} - \frac{C}{(n - [n\sqrt{\varepsilon}]) [n\sqrt{\varepsilon}]} \left( ([n\sqrt{\varepsilon}] - 1) + ([n\sqrt{\varepsilon}] - 2) + \cdots + 1 \right) \notag \\
&\geqslant slant \frac{|S_n| + |S_{n - [n\sqrt{\varepsilon}]}|}{[n\sqrt{\varepsilon}]} - \frac{C}{2} \frac{[n\sqrt{\varepsilon}] - 1}{n - [n\sqrt{\varepsilon}]} \notag \\
&\geqslant slant -\frac{2n \varepsilon}{[n\sqrt{\varepsilon}]} - \frac{C}{2} \frac{[n\sqrt{\varepsilon}] - 1}{n - [n\sqrt{\varepsilon}]} + \varepsilon, \label{eq:9.131}
\end{align}
于是我们得到
\begin{align*}
\varliminf_{n \to \infty} a_n \geqslant slant -2\sqrt{\varepsilon} - \frac{C}{2} \frac{\sqrt{\varepsilon}}{1 - \sqrt{\varepsilon}} + \varepsilon.
\end{align*}
由 $\varepsilon$ 任意性即得
\begin{align*}
...
若$\lim_{n \to \infty} \sqrt[n]{a_n} = l\in \mathbb{R}$,$a_n > 0$,并且对某个 $C > 0$, 如果有 $n(a_n - a_{n-1}) \geqslant slant -C, \forall n \geqslant slant 2,$,则$\lim_{n \to \infty}\frac{a_{n+1}}{a_n} = l$.
\end{proposition}
\begin{proof}
...
\[
\sum_{k = 1}^n\frac{n + 1}{2^k(n + 1 - k)}\geqslant slant \sum_{k = 1}^N\frac{n + 1}{2^k(n + 1 - k)},\forall n > N.
\]
上式两边同时令 \(n\rightarrow \infty\) 并取下极限，得到
\begin{align*}
\varliminf_{n\rightarrow \infty}\sum_{k = 1}^n\frac{n + 1}{2^k(n + 1 - k)}\geqslant slant \varliminf_{n\rightarrow \infty}\sum_{k = 1}^N\frac{n + 1}{2^k(n + 1 - k)}
...
\end{align*}
令 \(N\rightarrow \infty\)，则 \(\varliminf_{n\rightarrow \infty}\sum_{k = 1}^n\frac{n + 1}{2^k(n + 1 - k)}\geqslant slant \lim_{N\rightarrow \infty}\frac{\frac{1}{2}(1 - \frac{1}{2^N})}{1 - \frac{1}{2}} = 1\).

另一方面，我们有
\[
\sum_{k = 1}^n\frac{n + 1}{2^k(n + 1 - k)}\leqslant slant \sum_{k = 1}^n\frac{1}{2^k(n + 1 - n)}=\sum_{k = 1}^n\frac{1}{2^k}=\frac{\frac{1}{2}(1 - \frac{1}{2^n})}{1 - \frac{1}{2}},\forall n\in \mathbb{N}_+.
\]
上式两边同时令 \(n\rightarrow \infty\) 并取上极限，得到
\[
\varlimsup_{n\rightarrow \infty}\sum_{k = 1}^n\frac{n + 1}{2^k(n + 1 - k)}\leqslant slant \varlimsup_{n\rightarrow \infty}\frac{\frac{1}{2}(1 - \frac{1}{2^n})}{1 - \frac{1}{2}} = 1.
\]
故
\[
1\leqslant slant \varliminf_{n\rightarrow \infty}\sum_{k = 1}^n\frac{n + 1}{2^k(n + 1 - k)}\leqslant slant \varlimsup_{n\rightarrow \infty}\sum_{k = 1}^n\frac{n + 1}{2^k(n + 1 - k)}\leqslant slant 1.
\]
...
由Stolz公式可得
\begin{align*}
\lim_{n\rightarrow \infty}\frac{\sum\limits_{k=1}^n{\frac{1}{k^{\alpha}}}}{n^{1-\alpha}}&=\lim_{n\rightarrow \infty}\frac{\frac{1}{\left( n+1 \right) ^{\alpha}}}{\left( n+1 \right) ^{1-\alpha}-n^{1-\alpha}}=\lim_{n\rightarrow \infty}\frac{1}{n^{1-\alpha}\left( n+1 \right) ^{\alpha}}\cdot \frac{1}{\left( 1+\frac{1}{n} \right) ^{1-\alpha}-1}
\\&=\lim_{n\rightarrow \infty}\frac{1}{n}\cdot \frac{1}{\frac{1-\alpha}{n}}=\frac{1}{1-\alpha}.
\end{align*}
\end{proof}
...
\end{example}
\begin{proof}
归纳易证\(x_n\)单调递增,如果\(x_n\)有界则设\(x_n\leqslant  A<\infty\)，代入条件可知\(x_{n + 1}-x_n=\frac{1}{\sqrt{nx_n}}\geqslant \frac{1}{A\sqrt{n}}\)，从而$x_{n+1}=\sum_{k=1}^n{\left( x_{k+1}-x_k \right)}\geqslant slant \sum_{k=1}^n{\frac{1}{A\sqrt{n}}}$.而这个不等式右边发散,故$x_n$也发散,矛盾.所以\(x_n\)单调递增趋于无穷，下面用Stolz公式求极限
\begin{align*}
...
\item 由\(\sin x\leqslant slant x\),\(\forall x\in\mathbb{R}\)可知\(x_{n + 1}\leqslant slant x_n\),\(\forall n\in\mathbb{N}\).又由于\(0 < x_1 < \pi\)及\(0 < x_{n + 1} = \sin x_n < 1\),\(\forall n\in\mathbb{N}_+\),故归纳可得\(0\leqslant slant x_n\leqslant slant 1\),\(\forall n\geqslant slant 2\).因此\(\{x_n\}\)极限存在,设\(\lim_{n\rightarrow\infty}x_n = a < \infty\).从而对\(x_{n + 1} = \sin x_n\)两边同时令\(n\rightarrow\infty\)可得
\[
...
\item 由条件可知\(x_{n + 1}=x_n+\frac{1}{x_n}\geqslant slant x_n\),\(\forall n\in\mathbb{N}_+\).又\(x_1 = 1 > 0\),故归纳可得\(x_n > 0\),\(\forall n\in\mathbb{N}_+\).由单调有界定理可知数列\(\{x_n\}\)的极限要么是\(+\infty\),要么是有限数.假设\(\lim_{n\rightarrow\infty}x_n = a <\infty\),则对\(x_{n + 1}=x_n+\frac{1}{x_n}\)两边同时令\(n\rightarrow\infty\),可得\(a = a+\frac{1}{a}\Rightarrow\frac{1}{a}=0\)矛盾.故\(\lim_{n\rightarrow\infty}x_n = +\infty\).于是由\(Stolz\)定理可得
\begin{align*}
...
\end{example}
\begin{solution}
由于$a_{n + 1} = a_n + \frac{1}{S_n},\forall n\in \mathbb{N}_+$,并且$a_1>0$,故由数学归纳法可知$a_n>0,\forall n\in \mathbb{N}_+$.又$a_2=a_1+a_1>a_1$,再根据递推式,可以归纳得到数列$\{a_n\}$单调递增.因此,数列$\{a_n\}$要么$\underset{n\rightarrow \infty}{\lim}a_n=a<\infty $,要么$\underset{n\rightarrow \infty}{\lim}a_n=+\infty $.由条件可知\(a_{n + 1}-a_n=\frac{1}{S_n}\geqslant slant\frac{1}{na_1}=\frac{1}{n}\),\(\forall n\in\mathbb{N}_+\).从而对\(\forall n\in\mathbb{N}_+\),都有
\[
a_n=a_n - a_{n - 1}+a_{n - 1}-a_{n - 2}+\cdots+a_2 - a_1\geqslant slant\frac{1}{n - 1}+\frac{1}{n - 2}+\cdots+1=\sum_{k = 1}^{n - 1}\frac{1}{k}.
\]
...
\begin{align*}
1&=n + 1 - n\leqslant slant n + 1-\frac{na_n}{a_{n + 1}}=n + 1-\frac{na_n}{a_n+\frac{1}{S_n}}=1+\frac{\frac{n}{a_nS_n}}{1+\frac{1}{a_nS_n}}\\
&=1+\frac{n}{1 + a_nS_n}\leqslant slant1+\frac{n}{1 + a_1S_n}=1+\frac{n}{1 + S_n}.
\end{align*}
...
&\leqslant slant\left|\frac{\sum\limits_{k = 1}^{[x]-X}[f(x - k + 1)-f(x - k)]}{g(x)}\right|+\left|\frac{f(x - [x]+X)}{g(x)}\right|\\
&\stackrel{\eqref{theorem4.5-equation:13.24}\text{式}}{\leqslant slant}\varepsilon\frac{\sum\limits_{k = 1}^{[x]-X}[g(x - k + 1)-g(x - k)]}{|g(x)|}+\left|\frac{f(x - [x]+X)}{g(x)}\right|\\
&=\varepsilon\frac{g(x)-g(x - [x]+X)}{|g(x)|}+\left|\frac{f(x - [x]+X)}{g(x)}\right|\\
&\stackrel{\eqref{theorem4.5-equation:13.24}\text{式}g>0}\leqslant slant \varepsilon+\left|\frac{f(x - [x]+X)}{g(x)}\right|.
\end{align*}
于是利用\(f\)在\([X,X + 1]\)有界及$X\leqslant slant x-[x]+X<X+1$,我们有
\[
\varlimsup_{x\rightarrow +\infty}\left|\frac{f(x)}{g(x)}\right|\leqslant slant\varepsilon,
\]
由\(\varepsilon\)任意性即得
\[
...
&\leqslant slant\frac{\sum\limits_{k = 1}^{n}|f(x + k - 1)-f(x + k)|}{g(x)}+\frac{|f(x + n)|}{g(x)}\\
&\leqslant slant\varepsilon\frac{\sum\limits_{k = 1}^{n}[g(x + k - 1)-g(x + k)]}{g(x)}+\frac{|f(x + n)|}{g(x)}\\
&=\varepsilon\frac{g(x)-g(x + n)}{g(x)}+\frac{|f(x + n)|}{g(x)}\\
&\leqslant slant\varepsilon+\frac{|f(x + n)|}{g(x)}.
\end{align*}
再利用$\lim_{x\rightarrow +\infty}f(x)=\lim_{x\rightarrow +\infty}g(x)=0$得
\[
\lim_{n\rightarrow\infty}\frac{|f(x + n)|}{g(x)}=0\Rightarrow\left|\frac{f(x)}{g(x)}\right|\leqslant slant\varepsilon,\forall x>X.
\]
从而结论得证. 
\end{enumerate}
\end{proof}
...
\end{align*}
其中$x\leqslant slant \theta_x \leqslant slant x+\pi$.从而$\theta_x \sim x,x\rightarrow +\infty$.于是
\begin{align*}
...
\end{align}
其中\(x\leqslant slant \theta _x\leqslant slant x+\pi\).从而$\theta _x\sim x,x\rightarrow +\infty $.再结合\eqref{example4.27(2)-1.1}式可得
\begin{align*}
...
\frac{\int_0^n{(t}-[t])\mathrm{d}t}{n+1}\leqslant slant \frac{1}{x}\int_0^x{(t}-[t])\mathrm{d}t\leqslant slant \frac{\int_0^{n+1}{(t}-[t])\mathrm{d}t}{n},\forall x>0.
\end{align}
又由数列Stolz定理可知
\begin{align}
