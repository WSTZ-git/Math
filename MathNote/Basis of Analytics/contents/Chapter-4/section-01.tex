...
\begin{gather*}
f\left( x \right) =\sum_{k=0}^n{\frac{f^{\left( k \right)}\left( x_0 \right)}{k!}\left( x-x_0 \right) ^k}+o\left( \left( x-x_0 \right) ^n \right) ,
\\
f\left( x \right) =\sum_{k=0}^{n-1}{\frac{f^{\left( k \right)}\left( x_0 \right)}{k!}\left( x-x_0 \right) ^k}+O\left( \left( x-x_0 \right) ^n \right) .
\end{gather*}
