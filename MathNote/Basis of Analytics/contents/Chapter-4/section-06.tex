...
\begin{align}
x\leqslant \sqrt[3]{x+\sqrt[3]{x}},\quad \forall x\in (0,x_0];\quad x\geqslant \sqrt[3]{x+\sqrt[3]{x}},\quad \forall x\in [x_0,+\infty).\label{eq:21.1}
\end{align}
...
\end{align*}
由数学归纳法知$\{a_n\}$有界.设$L=\varlimsup\limits_{n\rightarrow \infty}a_n,l=\varliminf\limits_{n\rightarrow \infty}a_n$,由递推式及\eqref{eq:21.1}式知
\begin{align*}
