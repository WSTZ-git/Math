...
&=\left|\int_{\alpha - [\alpha ]}^{\beta - [\beta ]}{g(t)\mathrm{d}t}\right|\leqslant slant \sup_{\mathbb{R}}|g|.
\end{align*}
故
\begin{align}\label{equation:4.1-2.1} 
\left|\int_{\alpha}^{\beta}{g(xy)\mathrm{d}y}\right|\xlongequal{\text{令}t = xy}\frac{1}{x}\left|\int_{x\alpha}^{x\beta}{g(t)\mathrm{d}t}\right|\leqslant slant \frac{\sup\limits_{\mathbb{R}}|g|}{x}, \quad \forall x > 0, \forall \beta > \alpha > 0.  
\end{align}
...
\sum_{i = 1}^n{\left(\sup_{[t_{i - 1},t_i]}f - \inf_{[t_{i - 1},t_i]}f\right)(t_i - t_{i - 1})}\leqslant slant \frac{\varepsilon}{3\sup\limits_{\mathbb{R}}|g|}.
\end{align}
...
\begin{align*}
\left|\int_{-\infty}^{+\infty}{f(y)g(xy)\mathrm{d}y}\right|&\leqslant slant \left|\int_{-N}^N{f(y)g(xy)\mathrm{d}y}\right|+\left|\int_{|y| > N}{f(y)g(xy)\mathrm{d}y}\right|
\overset{\eqref{equation:4.1-2.2}}{\leqslant slant}\left|\sum_{j = 1}^n{\int_{t_{j - 1}}^{t_j}{f(y)g(xy)\mathrm{d}y}}\right|+\frac{\varepsilon}{3\sup\limits_{\mathbb{R}}|g|}\cdot \sup\limits_{\mathbb{R}}|g|\\
&\leqslant slant \sum_{j = 1}^n{\left|\int_{t_{j - 1}}^{t_j}{[f(y) - \inf_{[t_{j - 1},t_j]}f]g(xy)\mathrm{d}y}\right|}+\sum_{j = 1}^n{\left|\int_{t_{j - 1}}^{t_j}{\inf_{[t_{j - 1},t_j]}f\cdot g(xy)\mathrm{d}y}\right|}+\frac{\varepsilon}{3}\\
&\overset{\eqref{equation:4.1-2.1}}{\leqslant slant}\sum_{j = 1}^n{\int_{t_{j - 1}}^{t_j}{[f(y) - \inf_{[t_{j - 1},t_j]}f]\mathrm{d}y}}\cdot \sup\limits_{\mathbb{R}}|g|+\frac{\sup\limits_{\mathbb{R}}|g|}{x}\sum_{j = 1}^n{\int_{t_{j - 1}}^{t_j}{|\inf_{[t_{j - 1},t_j]}f|\mathrm{d}y}}+\frac{\varepsilon}{3}\\
&\leqslant slant \sum_{j = 1}^n{\int_{t_{j - 1}}^{t_j}{(\sup\limits_{[t_{i - 1},t_i]}f - \inf_{[t_{j - 1},t_j]}f)\mathrm{d}y}}\cdot \sup\limits_{\mathbb{R}}|g|+\frac{\sup\limits_{\mathbb{R}}|g|}{x}\sum_{j = 1}^n{\int_{t_{j - 1}}^{t_j}{|\inf_{[t_{j - 1},t_j]}f|\mathrm{d}y}}+\frac{\varepsilon}{3}\\
...
\begin{align}
\int_0^{2\pi}{f\left( x \right) \left| \sin \left( nx \right) \right|\mathrm{d}x}&=\sum_{i=1}^{2n}{\int_{t_{i-1}}^{t_i}{f\left( x \right) \left| \sin \left( nx \right) \right|\mathrm{d}x}}\leqslant slant \sum_{i=1}^{2n}{\int_{t_{i-1}}^{t_i}{\underset{\left[ t_{i-1},t_i \right]}{\mathrm{sup}}f\cdot \left| \sin \left( nx \right) \right|\mathrm{d}x}}\xlongequal{\eqref{example4.61-1.1} \text{式}}\frac{2}{n}\sum_{i=1}^{2n}{\underset{\left[ t_{i-1},t_i \right]}{\mathrm{sup}}f}
\nonumber
\\
...
另一方面,我们有
\begin{align}
\int_0^{2\pi}{f\left( x \right) \left| \sin \left( nx \right) \right|\mathrm{d}x}&=\sum_{i=1}^{2n}{\int_{t_{i-1}}^{t_i}{f\left( x \right) \left| \sin \left( nx \right) \right|\mathrm{d}x}}\geqslant slant \sum_{i=1}^{2n}{\int_{t_{i-1}}^{t_i}{\underset{\left[ t_{i-1},t_i \right]}{\mathrm{inf}}f\cdot \left| \sin \left( nx \right) \right|\mathrm{d}x}}\xlongequal{\eqref{example4.61-1.1}\text{式}}\frac{2}{n}\sum_{i=1}^{2n}{\underset{\left[ t_{i-1},t_i \right]}{\mathrm{inf}}f}
\nonumber
\\
...
\[
\left| \frac{1}{2\sin \frac{t}{2}} \right|\geqslant slant \left| \frac{1}{2\cdot \frac{2}{\pi}\cdot \frac{t}{2}} \right|=\frac{\pi}{2t}>0.
\]
