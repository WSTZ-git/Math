...
不妨设\(f\)递减，则一方面，我们有
\begin{align*}
\frac{1}{n}\sum_{k=1}^{n-1}f\left(\frac{k}{n}\right) \geqslant slant \sum_{k=1}^{n-1}\int_{\frac{k}{n}}^{\frac{k+1}{n}}f(x) \, \mathrm{d}x = \int_{\frac{1}{n}}^1 f(x) \, \mathrm{d}x.
\end{align*}
令\(n \to \infty\)，则
\begin{align*}
\lim_{n \to \infty} \frac{1}{n}\sum_{k=1}^{n-1}f\left(\frac{k}{n}\right) \geqslant slant \int_0^1 f(x) \, \mathrm{d}x.
\end{align*}
另一方面，我们有
\begin{align*}
\frac{1}{n}\sum_{k=1}^{n-1}f\left(\frac{k}{n}\right) \leqslant slant \sum_{k=1}^{n-1}\int_{\frac{k-1}{n}}^{\frac{k}{n}}f(x) \, \mathrm{d}x = \int_{0}^{1-\frac{1}{n}} f(x) \, \mathrm{d}x.
\end{align*}
令\(n \to \infty\)，则
\begin{align*}
\lim_{n \to \infty} \frac{1}{n}\sum_{k=1}^{n-1}f\left(\frac{k}{n}\right) \leqslant slant \int_0^1 f(x) \, \mathrm{d}x.
\end{align*}
故
\begin{align*}
...
{\color{blue}解法二:}注意到
\[
0\leqslant \left|\sum_{i = 1}^{n}\frac{1}{n+\frac{i^{2}+1}{n}}-\sum_{i = 1}^{n}\frac{1}{n+\frac{i^{2}}{n}}\right|\leqslant slant\sum_{i = 1}^{n}\frac{1}{n\left(n+\frac{i^{2}+1}{n}\right)\left(n+\frac{i^{2}}{n}\right)}\leqslant slant\sum_{i = 1}^{n}\frac{1}{n^{3}}=\frac{1}{n^{2}}\rightarrow0,n\rightarrow\infty,
\]
故
\[
...
&\leqslant slant\sum_{i = 1}^{2n}\frac{4n^{2}-1}{n^{2}\left(n^{2}+\frac{1}{i}\right)}
\leqslant slant\sum_{i = 1}^{2n}\frac{4n^{2}-1}{n^{4}}
=\frac{2n(4n^{2}-1)}{n^{4}},
\end{align*}
于是
\[
0\leqslant slant\lim_{n\rightarrow\infty}\left|\sum_{i = 1}^{2n}\frac{i + 4}{n^{2}+\frac{1}{i}}\sin^{4}\frac{\pi i}{n}-\sum_{i = 1}^{2n}\frac{i}{n^{2}}\sin^{4}\frac{\pi i}{n}\right|\leqslant slant\lim_{n\rightarrow\infty}\frac{2n(4n^{2}-1)}{n^{4}} = 0.
\]
因此
\begin{align*}
...
一方面,注意到\(\sum\limits_{k = 0}^{n}\frac{\cos\sqrt{\frac{k}{n}}}{2^k} \leqslant slant \sum\limits_{k = 0}^{n}\frac{1}{2^k} = \frac{1 - \frac{1}{2^{n + 1}}}{1 - \frac{1}{2}}\),于是
$\varlimsup_{n \to +\infty}\sum\limits_{k = 0}^{n}\frac{\cos\sqrt{\frac{k}{n}}}{2^k} \leqslant slant \varlimsup_{n \to +\infty}\frac{1 - \frac{1}{2^{n + 1}}}{1 - \frac{1}{2}} = 2$.

另一方面,注意到对\(\forall N \in \mathbb{N}_+\),都有\(\sum\limits_{k = 0}^{n}\frac{\cos\sqrt{\frac{k}{n}}}{2^k} \geqslant slant \sum\limits_{k = 0}^{N}\frac{\cos\sqrt{\frac{k}{n}}}{2^k}\),$\forall n>N$.从而
\begin{align*}
\varliminf_{n \to +\infty}\sum\limits_{k = 0}^{n}\frac{\cos\sqrt{\frac{k}{n}}}{2^k} \geqslant slant \varliminf_{n \to +\infty}\sum\limits_{k = 0}^{N}\frac{\cos\sqrt{\frac{k}{n}}}{2^k} = \sum\limits_{k = 0}^{N}\varliminf_{n \to +\infty}\frac{\cos\sqrt{\frac{k}{n}}}{2^k} = \sum\limits_{k = 0}^{N}\lim_{n \to +\infty}\frac{\cos\sqrt{\frac{k}{n}}}{2^k} = \sum\limits_{k = 0}^{N}\frac{1}{2^k},\forall N \in \mathbb{N}_+.
\end{align*}

于是令\(N \to +\infty\),得到\(\varliminf_{n \to +\infty}\sum\limits_{k = 0}^{n}\frac{\cos\sqrt{\frac{k}{n}}}{2^k} \geqslant slant \lim_{N \to +\infty}\sum\limits_{k = 0}^{N}\frac{1}{2^k} = 2\).

综上所述,我们有\(2 \leqslant slant \varliminf_{n \to +\infty}\sum\limits_{k = 0}^{n}\frac{\cos\sqrt{\frac{k}{n}}}{2^k} \leqslant slant \varlimsup_{n \to +\infty}\sum\limits_{k = 0}^{n}\frac{\cos\sqrt{\frac{k}{n}}}{2^k} \leqslant slant 2\).故\(\lim_{n \to +\infty}\sum\limits_{k = 0}^{n}\frac{\cos\sqrt{\frac{k}{n}}}{2^k} = 2\). 
...
\[
\sum\limits_{k = 1}^{n}\left(\frac{k}{n}\right)^n = \sum\limits_{k = 1}^{n}e^{n\ln\left(1 - \frac{k - 1}{n}\right)} \leqslant  \sum\limits_{k = 1}^{n}e^{n\cdot\left(-\frac{k - 1}{n}\right)} = \sum\limits_{k = 1}^{n}e^{1 - k},  \forall n \in \mathbb{N}_+.
\]
...
另一方面,注意到\(\sum\limits_{k = 1}^{n}\left(\frac{k}{n}\right)^n = \sum\limits_{k = 1}^{n}e^{n\ln\left(1 - \frac{k - 1}{n}\right)} \geqslant  \sum\limits_{k = 1}^{N}e^{n\ln\left(1 - \frac{k - 1}{n}\right)}\),\(\forall N \in \mathbb{N}_+\).两边同时对\(n\)取下极限,可得对\(\forall N \in \mathbb{N}_+\),都有
\begin{align*}
&\underset{n\rightarrow +\infty}{{\varliminf }}\sum\limits_{k=1}^n{\left( \frac{k}{n} \right) ^n}\geqslant slant \underset{n\rightarrow +\infty}{{\varliminf }}\sum\limits_{k=1}^N{e^{n\ln \left( 1-\frac{k-1}{n} \right)}}=\underset{n\rightarrow +\infty}{\lim}\sum\limits_{k=1}^N{e^{n\ln \left( 1-\frac{k-1}{n} \right)}}
\\
...
\end{align*}
从而$\left( 1-\frac{1}{x^2} \right) ^n\left( 1+\frac{1}{x} \right) =e^{n\ln \left( 1-\frac{1}{x^2} \right) +\ln \left( 1+\frac{1}{x} \right)}\leqslant slant e^0=1,\forall x = k + 1\in[2,n]$,故$a_{k + 1}\leqslant  a_k,\forall 1\leqslant  k\leqslant  n$.
于是\(\frac{(k + 1)^{n + 1}}{k^n}=a_k\geqslant  a_n=\frac{(n + 1)^{n + 1}}{n^n}\)，也即\(S_n\)单调递增。
注意
\begin{align*}
S_n&=\sum_{k = 1}^{n - 1}\left(\frac{k}{n}\right)^n=\sum_{k = 1}^{n - 1}\left(1-\frac{k}{n}\right)^n=\sum_{k = 1}^{n - 1}e^{n\ln\left(1-\frac{k}{n}\right)}\leqslant \sum_{k = 1}^{n - 1}e^{-k}\leqslant \sum_{k = 1}^{\infty}e^{-k}=\frac{1}{e - 1}
\end{align*}
所以单调有界，极限一定存在，设为\(S\)。
对任意正整数\(n>m\)，先固定\(m\)，对\(n\)取极限有
\begin{align*}
S_n&=\sum_{k = 1}^{n - 1}\left(1-\frac{k}{n}\right)^n\geqslant \sum_{k = 1}^{m}\left(1-\frac{k}{n}\right)^n\Rightarrow S=\lim_{n\rightarrow\infty}S_n\geqslant \sum_{k = 1}^{m}\lim_{n\rightarrow\infty}\left(1-\frac{k}{n}\right)^n=\sum_{k = 1}^{m}e^{-k}
\end{align*}
这对任意正整数\(m\)均成立，再令\(m\rightarrow\infty\)有\(S\geqslant \frac{1}{e - 1}\)，从而所求极限为\(\frac{1}{e - 1}\)。
\end{solution}
...
又由于
\begin{align*}
\frac{1}{\sqrt{n}}\sum_{k = 1}^{n}\left(\frac{1}{1 + \frac{\sqrt{k}}{n}} - 1 + \frac{\sqrt{k}}{n}\right)=\frac{1}{\sqrt{n}}\sum_{k = 1}^{n}\frac{k}{n^{2}}\frac{1}{1 + \frac{\sqrt{k}}{n}}\leqslant \frac{1}{\sqrt{n}}\sum_{k = 1}^{n}\frac{k}{n^{2}}\leqslant \frac{1}{\sqrt{n}}\to0.
\end{align*}
因此
\begin{align*}
...
所以
\[
\frac{n + 1}{2n\left(\sqrt{1 + \frac{1}{n}} + 1\right)}=\sum_{k = 1}^{n}\frac{\frac{k}{n^{2}}}{\sqrt{1 + \frac{1}{n}} + 1}\leqslant \sum_{k = 1}^{n}\left(\sqrt{1 + \frac{k}{n^{2}}} - 1\right)\leqslant \sum_{k = 1}^{n}\frac{k}{2n^{2}}=\frac{n + 1}{4n}
\]
...
由于
\[
\frac{1}{n}\sum_{k=1}^n{\left( \frac{1}{\sqrt{1+\frac{k}{n^2}}}-1+\frac{k}{2n^2} \right)}=\sum_{k=1}^n{\left( \frac{1}{\sqrt{n^2+k}}+\frac{k}{2n^3} \right)}-1\leqslant slant \sum_{k=1}^n{\left( \frac{1}{n}+\frac{k}{2n^3} \right)}-1=\frac{n+1}{4n^2}\rightarrow 0,n\rightarrow \infty.
\]
因此
\begin{align*}
...
注意到
\[
-\frac{n+1}{2\left( n+1+\sqrt{n^2+n} \right)}=\sum_{k=1}^n{\frac{-k}{n^2+n+n\sqrt{n^2+n}}}\leqslant slant \sum_{k=1}^n{\frac{-k}{n^2+k+n\sqrt{n^2+k}}}\leqslant slant \sum_{k=1}^n{\frac{-k}{2n^2}}=-\frac{n+1}{4n},\forall n\in \mathbb{N}_+.
\]
...
(a):设\(\{t_{nk}\}_{1\leqslant slant k\leqslant slant n} \subset [0, +\infty)\)满足\(\lim_{n \to \infty} \sum\limits_{k = 1}^{n} t_{nk} = 1\)和\(\lim_{n \to \infty} t_{nk} = 0\).若\(\lim_{n \to \infty} a_n = a \in \mathbb{R}\).证明
...
\begin{align*}
\left| \sum\limits_{k=1}^n{t_{nk}a_k} \right|=\left| \sum\limits_{k=1}^N{t_{nk}a_k}+\sum\limits_{k=N+1}^n{t_{nk}a_k} \right|\leqslant slant \left| \sum\limits_{k=1}^N{t_{nk}a_k} \right|+\sum\limits_{k=N+1}^n{\left| t_{nk}a_k \right|}.
\end{align*}
令$n\to+\infty$,得到
\begin{align*}
\underset{n\rightarrow +\infty}{{\varlimsup }}\left| \sum\limits_{k=1}^n{t_{nk}a_k} \right|\leqslant slant \underset{n\rightarrow +\infty}{{\varlimsup }}\left| \sum\limits_{k=1}^N{t_{nk}a_k} \right|+\underset{n\rightarrow +\infty}{{\varlimsup }}\sum\limits_{k=N+1}^n{\left| t_{nk}a_k \right|}\leqslant slant \mathop {\mathrm{sup}} \limits_{k\geqslant slant N+1}\left| a_k \right|\cdot \underset{n\rightarrow +\infty}{{\varlimsup }}\sum\limits_{k=1}^n{t_{nk}}=\mathop {\mathrm{sup}} \limits_{k\geqslant slant N+1}\left| a_k \right|,\forall N\in \mathbb{N} .
\end{align*}
由$N$的任意性,再令$N\to+\infty$,可得
\begin{align*}
\underset{n\rightarrow +\infty}{{\varlimsup }}\left| \sum\limits_{k=1}^n{t_{nk}a_k} \right|\leqslant slant \underset{N\rightarrow +\infty}{\lim}\mathop {\mathrm{sup}} \limits_{k\geqslant slant N+1}\left| a_k \right|=\underset{n\rightarrow +\infty}{{\varlimsup }}\left| a_n \right|=\underset{n\rightarrow +\infty}{{\varlimsup }}a_n=\underset{n\rightarrow +\infty}{\lim}a_n=0.
\end{align*}
...
\begin{align*}
\left| \sum\limits_{k=1}^{\infty}{t_{nk}a_k} \right|=\left| \sum\limits_{k=1}^N{t_{nk}a_k}+\sum\limits_{k=N+1}^{\infty}{t_{nk}a_k} \right|\leqslant slant \left| \sum\limits_{k=1}^N{t_{nk}a_k} \right|+\sum\limits_{k=N+1}^{\infty}{\left| t_{nk}a_k \right|}.
\end{align*}
令$n\to+\infty$,得到
\begin{align*}
\underset{n\rightarrow +\infty}{{\varlimsup }}\left| \sum\limits_{k=1}^{\infty}{t_{nk}a_k} \right|\leqslant slant \underset{n\rightarrow +\infty}{{\varlimsup }}\left| \sum\limits_{k=1}^N{t_{nk}a_k} \right|+\underset{n\rightarrow +\infty}{{\varlimsup }}\sum\limits_{k=N+1}^{\infty}{\left| t_{nk}a_k \right|}\leqslant slant \mathop {\mathrm{sup}} \limits_{k\geqslant slant N+1}\left| a_k \right|\cdot \underset{n\rightarrow +\infty}{{\varlimsup }}\sum\limits_{k=1}^{\infty}{t_{nk}}=\mathop {\mathrm{sup}} \limits_{k\geqslant slant N+1}\left| a_k \right|,\forall N\in \mathbb{N} .
\end{align*}
由$N$的任意性,再令$N\to+\infty$,可得
\begin{align*}
\underset{n\rightarrow +\infty}{{\varlimsup }}\left| \sum\limits_{k=1}^{\infty}{t_{nk}a_k} \right|\leqslant slant \underset{N\rightarrow +\infty}{\lim}\mathop {\mathrm{sup}} \limits_{k\geqslant slant N+1}\left| a_k \right|=\underset{n\rightarrow +\infty}{{\varlimsup }}\left| a_n \right|=\underset{n\rightarrow +\infty}{{\varlimsup }}a_n=\underset{n\rightarrow +\infty}{\lim}a_n=0.
\end{align*}
...
设\(\lim_{n \to \infty} a_n = a\)且\(b_n \geqslant slant 0\).记\(S_n = \sum\limits_{k = 1}^{n} b_k\),若\(\lim_{n \to \infty} S_n = S\).证明
\begin{align*}
...
\begin{align*}
0\leqslant slant \left| \sum\limits_{k=1}^n{a_kt_{nk}} \right|\leqslant slant \left| \sum\limits_{k=1}^N{a_kt_{nk}} \right|+\left| \sum\limits_{k=N+1}^n{a_kt_{nk}} \right|\leqslant slant \left| \sum\limits_{k=1}^N{a_kt_{nk}} \right|+\underset{k\ge N+1}{\mathrm{sup}}\left| a_k \right|\sum\limits_{k=N+1}^n{t_{nk}}\leqslant slant \left| \sum\limits_{k=1}^N{a_kt_{nk}} \right|+\underset{k\ge N+1}{\mathrm{sup}}\left| a_k \right|\sum\limits_{k=1}^n{t_{nk}}.
\end{align*}
令$n\to+\infty$,则
\begin{align*}
\underset{n\rightarrow +\infty}{{\varlimsup }}\left| \sum\limits_{k=1}^n{a_kt_{nk}} \right|\leqslant slant \underset{n\rightarrow +\infty}{\lim}\left( \underset{k\ge N+1}{\mathrm{sup}}\left| a_k \right|\sum\limits_{k=1}^n{t_{nk}} \right) =\underset{k\ge N+1}{\mathrm{sup}}\left| a_k \right|,\forall N\in \mathbb{N} .
\end{align*}
再令$N\to +\infty$,可得
\begin{align*}
\underset{n\rightarrow +\infty}{{\varlimsup }}\left| \sum\limits_{k=1}^n{a_kt_{nk}} \right|\leqslant slant \underset{N\rightarrow +\infty}{\lim}\underset{k\ge N+1}{\mathrm{sup}}\left| a_k \right|=\underset{n\rightarrow +\infty}{{\varlimsup }}\left| a_k \right|=\underset{n\rightarrow +\infty}{\lim}\left| a_k \right|=\underset{n\rightarrow +\infty}{\lim}a_k=0.
\end{align*}
...
令$n\to+\infty$,则
\begin{align*}
\underset{n\rightarrow \infty}{{\varlimsup }}\left| \frac{1}{n}\sum\limits_{k=1}^n{a_kb_{n-k+1}} \right|\leqslant slant \mathop {\mathrm{sup}} \limits_{k\ge N+1}|a_k|\cdot \underset{n\rightarrow \infty}{{\varlimsup }}\frac{\sum\limits_{k=1}^n{\left| b_k \right|}}{n}\leqslant slant \mathop {\mathrm{sup}} \limits_{k\ge N+1}|a_k|\cdot \underset{n\rightarrow \infty}{{\varlimsup }}b_n=0.
\end{align*}
...
\[
\frac{m}{n}\leqslant slant \frac{\sqrt{\sqrt{n}\ln n}}{n}\rightarrow 0,n\rightarrow \infty.
\]
\[
\sum_{k = 2}^m\frac{n^{\frac{1}{k}}}{n}\leqslant slant \frac{(m - 1)\sqrt{n}}{n}\leqslant slant \frac{\sqrt{\sqrt{n}\ln n}}{\sqrt{n}}=\sqrt{\frac{\ln n}{\sqrt{n}}}\rightarrow 0,n\rightarrow \infty.
\]
因此 \(\lim_{n\rightarrow \infty}\frac{m}{n}=\lim_{n\rightarrow \infty}\sum_{k = 2}^m\frac{n^{\frac{1}{k}}}{n}=0\)。并且一方面，我们有
\begin{align*}
\sum_{k=m}^n{\frac{n^{\frac{1}{k}}}{n}}&=\frac{1}{n}\sum_{k=m}^n{\int_{k-1}^k{n^{\frac{1}{k}}\mathrm{d}x}}\leqslant slant \frac{1}{n}\sum_{k=m}^n{\int_{k-1}^k{n^{\frac{1}{x}}\mathrm{d}x}}=\frac{1}{n}\int_{m-1}^n{n^{\frac{1}{x}}\mathrm{d}x}
\\
&=\frac{1}{n}\int_{\frac{1}{n}}^{\frac{1}{m-1}}{\frac{n^x}{x^2}\mathrm{d}x}\leqslant slant \frac{n^{\frac{1}{m-1}}}{n}\int_{\frac{1}{n}}^{\frac{1}{m-1}}{\frac{1}{x^2}\mathrm{d}x}=\frac{n^{\frac{1}{m-1}}}{n}\left( n-m+1 \right) .
\end{align*}
另一方面，我们有
\begin{align*}
\sum_{k=m}^n{\frac{n^{\frac{1}{k}}}{n}}&=\frac{1}{n}\sum_{k=m}^n{\int_k^{k+1}{n^{\frac{1}{k}}\mathrm{d}x}}\geqslant slant \frac{1}{n}\sum_{k=m}^n{\int_k^{k+1}{n^{\frac{1}{x}}\mathrm{d}x}}=\frac{1}{n}\int_m^{n+1}{n^{\frac{1}{x}}\mathrm{d}x}
\\
&=\frac{1}{n}\int_{\frac{1}{n+1}}^{\frac{1}{m}}{\frac{n^x}{x^2}\mathrm{d}x}\leqslant slant \frac{n^{\frac{1}{m}}}{n}\int_{\frac{1}{n+1}}^{\frac{1}{m}}{\frac{1}{x^2}\mathrm{d}x}=\frac{n^{\frac{1}{m}}}{n}\left( n-m+1 \right) .
\end{align*}
又注意到
\begin{align*}
...
故
\[
1=\varliminf_{n\rightarrow \infty}\frac{n^{\frac{1}{m}}}{n}(n - m + 1)\leqslant slant \varliminf_{n\rightarrow \infty}\sum_{k = m}^n\frac{n^{\frac{1}{k}}}{n}\leqslant slant \varlimsup_{n\rightarrow \infty}\sum_{k = m}^n\frac{n^{\frac{1}{k}}}{n}\leqslant slant \varlimsup_{n\rightarrow \infty}\frac{n^{\frac{1}{m - 1}}}{n}(n - m + 1)=1.
\]
...
\end{remark}
\begin{note}
在\([0,1)\)上\(x - [x]-\frac{1}{2}=x - \frac{1}{2}\),它也是\(x - \frac{1}{2}\)做周期\(1\)延拓得到的函数.故$-\frac{1}{2}\leqslant slant x-[x]-\frac{1}{2}\leqslant slant \frac{1}{2},\forall x\in \mathbb{R} .$
\end{note}
\begin{proof}
\begin{align*}
...
\end{proof}
\begin{remark}
\hypertarget{remark:利用0阶E-M公式精细估阶的构造}{假设已知}$f'(x)$在$\mathbb{R}$上连续,记\(b_1(x)=x - [x]-\frac{1}{2}\),使用0阶E-M公式后,由于$-\frac{1}{2}\leqslant slant x-[x]-\frac{1}{2}\leqslant slant \frac{1}{2},\forall x\in \mathbb{R}$,因此直接将$b_1(x)$放大成$\frac{1}{2}$就可以得到原级数的一个较为粗略的估计.具体例题见\hyperref[example:4.461111]{例题\ref{example:4.461111}}.
...
\\
b_2(x)=\frac{1}{2}\left( x-\left[ x \right] \right) ^2-\frac{1}{2}\left( x-\left[ x \right] \right) +\frac{1}{12},b_2\left( x \right) =\int_0^x{b_1\left( y \right) \mathrm{d}y},\left| b_2\left( x \right) \right|\leqslant slant \frac{1}{12},\forall x\in \mathbb{R}.
\end{gather*}
...
根据上述$b_n(x)$的定义和算法,可知$b_n(x)$是连续且周期为1的函数.而连续的周期函数一定有界,故一定存在$M_n>0$,使得对$\forall x\in \mathbb{R}$,有$\left| b_n(x) \right|\leqslant slant M_n$.
\end{note}
\begin{remark}
...
\\
b_1\left( x \right) =x-\left[ x \right] -\frac{1}{2},\left| b_1\left( x \right) \right|\leqslant slant \frac{1}{2},x\in \mathbb{R} .
\\
\\
b_2\left( x \right) =\frac{1}{2}x^2-\frac{1}{2}x+\frac{1}{12},x\in \left[ 0,1 \right) .
\\
b_2\left( x \right) =\frac{1}{2}\left( x-\left[ x \right] \right) ^2-\frac{1}{2}\left( x-\left[ x \right] \right) +\frac{1}{12},\left| b_2\left( x \right) \right|\leqslant slant \frac{1}{12},x\in \mathbb{R} .
\\
\\
b_3\left( x \right) =\frac{x^3}{6}-\frac{x^2}{4}+\frac{x}{12},x\in \left[ 0,1 \right) .
\\
b_3\left( x \right) =\frac{\left( x-\left[ x \right] \right) ^3}{6}-\frac{\left( x-\left[ x \right] \right) ^2}{4}+\frac{\left( x-\left[ x \right] \right)}{12},\left| b_3\left( x \right) \right|\leqslant slant \frac{2\sqrt{3}-3}{36},x\in \mathbb{R} .
\\
\\
b_4\left( x \right) =\frac{x^4}{24}-\frac{x^3}{12}+\frac{x^2}{24}-\frac{1}{720},x\in \left[ 0,1 \right) .
\\
b_4\left( x \right) =\frac{\left( x-\left[ x \right] \right) ^4}{24}-\frac{\left( x-\left[ x \right] \right) ^3}{12}+\frac{\left( x-\left[ x \right] \right) ^2}{24}-\frac{1}{720},\left| b_4\left( x \right) \right|\leqslant slant \frac{1}{720},x\in \mathbb{R} .
\end{gather*}
\end{conclusion}
...
\[
\sum_{k = 1}^n\frac{1}{k}=\sum_{k = 1}^n\int_{k}^{k + 1}\frac{1}{k}\mathrm{d}x\geqslant slant\sum_{k = 1}^n\int_{k}^{k + 1}\frac{1}{x}\mathrm{d}x=\int_{1}^{n + 1}\frac{1}{x}\mathrm{d}x=\ln(n + 1).
\]
另一方面,对\(\forall n\in\mathbb{N}\)我们也有
\[
\sum_{k = 1}^n\frac{1}{k}=1+\sum_{k = 2}^n\int_{k - 1}^{k}\frac{1}{k}\mathrm{d}x\leqslant slant1+\sum_{k = 2}^n\int_{k - 1}^{k}\frac{1}{x}\mathrm{d}x=1+\int_{1}^{n}\frac{1}{x}\mathrm{d}x=1+\ln n.
\]
于是对\(\forall n\in\mathbb{N}\)都有
\[
\ln(n + 1)\leqslant slant\sum_{k = 1}^n\frac{1}{k}\leqslant slant1+\ln n.
\]
从而对\(\forall n\in\mathbb{N}\)都有
\[
\frac{\ln(n + 1)}{\ln n}\leqslant slant\frac{\sum\limits_{k = 1}^n\frac{1}{k}}{\ln n}\leqslant slant\frac{1}{\ln n}+1.
\]
...
\end{align}
因为\(\int_1^n\left(x - [x]-\frac{1}{2}\right)\frac{1}{x^2}\mathrm{d}x\leqslant slant\int_1^n\frac{1}{2x^2}\mathrm{d}x\),而\(\lim_{n\rightarrow\infty}\int_1^n\frac{1}{2x^2}\mathrm{d}x\)存在,所以可设
\[
...
&\leqslant slant\ln n+\frac{1}{2n}+\frac{1}{2}-C+\int_n^{+\infty}\frac{1}{2x^2}\mathrm{d}x\\
...
\end{align}
由\hyperlink{remark:利用0阶E-M公式精细估阶的构造}{$b_n(x)$的构造和分部积分}可知,上述结果只是对$\sum_{k=1}^n{\frac{1}{k}}$的一个最粗糙的估计.实际上,我们可以利用分部积分得到更加精细的估计.记$b_1(x)=x-[x]-\frac{1}{2},b_2\left( x \right) =\frac{1}{2}\left( x-\left[ x \right] \right) ^2-\frac{1}{2}\left( x-\left[ x \right] \right) +\frac{1}{12}$.则\hyperlink{b2性质}{不难发现}$b_2(x)$是连续且周期为1的函数,$b_2(x)$是$b_1(x)$在$\mathbb{R}$上的一个原函数,并且$|b_2(x)|\leqslant  \frac{1}{12},x\in \mathbb{R}$.
...
\end{align}
又由$\left| b_2\left( x \right) \right|\leqslant slant \frac{1}{12},\forall x\in \mathbb{R} $可知
\begin{align*}
\left| 2\int_n^{+\infty}{\frac{b_2\left( x \right)}{x^3}\mathrm{d}x}-\frac{b_2\left( n \right)}{n^2} \right|\leqslant slant 2\left| \int_n^{+\infty}{\frac{b_2\left( x \right)}{x^3}\mathrm{d}x} \right|+\frac{\left| b_2\left( n \right) \right|}{n^2}\leqslant slant \frac{1}{6}\left| \int_n^{+\infty}{\frac{1}{x^3}\mathrm{d}x} \right|+\frac{1}{12n^2}=\frac{1}{6n^2},\forall n\in \mathbb{N} .
\end{align*}
即
...
因为
\[
\left|\int_{1}^{m}\left(x - [x] - \frac{1}{2}\right)\frac{1 - \ln x}{x^2}\mathrm{d}x\right|\leqslant slant\frac{1}{2}\left|\int_{1}^{m}\frac{1 - \ln x}{x^2}\mathrm{d}x\right|, \forall m\in\mathbb{N}.
\]
...
\end{align}
注意到\(0\leqslant slant\left|\left(x - [x] - \frac{1}{2}\right)f^\prime(x)\right|\leqslant slant\frac{1}{2}\left|f^\prime(x)\right|\),并且\(\int_1^{\infty}\left|f^\prime(x)\right|\mathrm{d}x\)收敛,因此\(\int_1^{\infty}\left|\left(x - [x] - \frac{1}{2}\right)f^\prime(x)\right|\mathrm{d}x\)也收敛.从而\(\int_1^{\infty}\left(x - [x] - \frac{1}{2}\right)f^\prime(x)\mathrm{d}x\)也收敛,故由\(Henie\)归结原则可知\(\lim_{n\rightarrow +\infty}\int_1^n\left(x - [x] - \frac{1}{2}\right)f^\prime(x)\mathrm{d}x\)存在.
...
于是对\(\forall x\geqslant slant1\),一定存在\(n\in\mathbb{N}\),使得\(n\leqslant slant x < n + 1\).从而可得
...
\int_n^x f(x)\mathrm{d}x\leqslant slant\int_n^x\left|f(x)\right|\mathrm{d}x\leqslant slant\int_n^{n + 1}\left|f(x)\right|\mathrm{d}x\leqslant slant\sup_{y\geqslant slant n}\left|f(y)\right|.
\end{align}
对\eqref{equation:4.481.2}式两边同时令\(x\rightarrow +\infty\),则\(n\rightarrow +\infty\).进而可得
\[
\lim_{x\rightarrow +\infty}\int_n^x f(x)\mathrm{d}x\leqslant slant\lim_{n\rightarrow +\infty}\sup_{y\geqslant slant n}\left|f(y)\right|={\varlimsup_{x\rightarrow +\infty}}\left|f(x)\right|.
\]
...
\[
\lim_{x\rightarrow +\infty}\int_n^x f(x)\mathrm{d}x\leqslant slant{\varlimsup_{x\rightarrow +\infty}}\left|f(x)\right|=0.
\]
...
\item 注意到对\(\forall n\geqslant slant 2\)且\(n\in\mathbb{N}\),都有
\begin{align}\label{equation:4.471}
\sum_{k = 2}^n\frac{1}{k\ln k}&=\sum_{k = 2}^n\int_{k}^{k + 1}\frac{1}{k\ln k}\mathrm{d}x
\geqslant slant\sum_{k = 2}^n\int_{k}^{k + 1}\frac{1}{x\ln x}\mathrm{d}x
...
\leqslant slant\sum_{k = 2}^n\int_{k - 1}^{k}\frac{1}{x\ln x}\mathrm{d}x
=\int_{1}^{n}\frac{1}{x\ln x}\mathrm{d}x
=\ln\ln n.
\end{align}
从而对\(\forall n\geqslant slant 2\)且\(n\in\mathbb{N}\),由\eqref{equation:4.471}\eqref{equation:4.472}式可得
\[
\ln\ln(n + 1) - \ln\ln 2\leqslant slant\sum_{k = 2}^n\frac{1}{k\ln k}\leqslant slant\ln\ln n.
\]
于是对\(\forall n\geqslant slant 2\)且\(n\in\mathbb{N}\),我们有
\[
\frac{\ln\ln(n + 1) - \ln\ln 2}{\ln\ln n}\leqslant slant\frac{\sum\limits_{k = 2}^n\frac{1}{k\ln k}}{\ln\ln n}\leqslant slant 1.
\]
...
=-1 + \sum_{n = 0}^{\infty}\int_{n}^{n + 1}x^{n^2}\mathrm{d}t
\geqslant slant -1 + \sum_{n = 0}^{\infty}\int_{n}^{n + 1}x^{t^2}\mathrm{d}t
=-1 + \lim_{n\rightarrow\infty}\int_{0}^{n}x^{t^2}\mathrm{d}t.
\end{align}
同时也有
\begin{align}\label{equation:4.482}
\sum_{n = 1}^{\infty}x^{n^2}&=\sum_{n = 1}^{\infty}\int_{n - 1}^{n}x^{n^2}\mathrm{d}t
\leqslant slant\sum_{n = 1}^{\infty}\int_{n - 1}^{n}x^{t^2}\mathrm{d}t
...
\begin{align*}
-1+\frac{\sqrt{\pi}}{2\sqrt{-\ln x}}=-1+\lim_{n\rightarrow \infty} \int_1^n{x^{t^2}\mathrm{d}t}\leqslant slant \sum_{n=1}^{\infty}{x^{n^2}}\leqslant slant \lim_{n\rightarrow \infty} \int_0^n{x^{t^2}\mathrm{d}t}=\frac{\sqrt{\pi}}{2\sqrt{-\ln x}}.
\end{align*}
即
\[
-\sqrt{-\ln x}+\frac{\sqrt{\pi}}{2}\leqslant slant\sqrt{-\ln x}\sum_{n = 1}^{\infty}x^{n^2}\leqslant slant\frac{\sqrt{\pi}}{2},\forall x\in(0,1).
\]
