...
{\color{blue}解法二:}注意到
\[
0\leqslant \left|\sum_{i = 1}^{n}\frac{1}{n+\frac{i^{2}+1}{n}}-\sum_{i = 1}^{n}\frac{1}{n+\frac{i^{2}}{n}}\right|\leqslant\sum_{i = 1}^{n}\frac{1}{n\left(n+\frac{i^{2}+1}{n}\right)\left(n+\frac{i^{2}}{n}\right)}\leqslant\sum_{i = 1}^{n}\frac{1}{n^{3}}=\frac{1}{n^{2}}\rightarrow0,n\rightarrow\infty,
\]
故
\[
...
注意
\begin{align*}
S_n=\sum_{k=1}^{n-1}{\left( \frac{k}{n} \right) ^n}=\sum_{k=1}^{n-1}{\left( \frac{n-k+1}{n} \right) ^n}=\sum_{k=1}^{n-1}{e^{n\ln \left( 1-\frac{k-1}{n} \right)}}\leqslant \sum_{k=1}^{n-1}{e^{1-k}}\leqslant \sum_{k=1}^{\infty}{e^{1-k}}=\frac{e}{e-1}.
\end{align*}
所以单调有界，极限一定存在，设为\(S\)。
对任意正整数\(n>m\)，先固定\(m\)，对\(n\)取极限有
\begin{align*}
S_n=\sum_{k=1}^{n-1}{\left( \frac{n-k+1}{n} \right) ^n}\geqslant \sum_{k=1}^m{\left( \frac{n-k+1}{n} \right) ^n\Rightarrow S}=\lim_{n\rightarrow \infty} S_n\geqslant \sum_{k=1}^m{\lim_{n\rightarrow \infty} \left( \frac{n-k+1}{n} \right) ^n}=\sum_{k=1}^m{e^{1-k}}
...
注意到
\begin{align}
\lim_{n\rightarrow \infty} \left( \sum\limits_{k=1}^n{\frac{1}{\sqrt{n^2+k}}} \right) ^n=\lim_{n\rightarrow \infty} e^{n\ln \sum\limits_{k=1}^n{\frac{1}{\sqrt{n^2+k}}}}=\lim_{n\rightarrow \infty} e^{n\ln \left( \frac{1}{n}\sum_{k=1}^n{\frac{1}{\sqrt{1+\frac{k}{n^2}}}} \right)}. \label{example4.14-1.0}
\end{align}
...
注意到
\[
-\frac{n+1}{2\left( n+1+\sqrt{n^2+n} \right)}=\sum_{k=1}^n{\frac{-k}{n^2+n+n\sqrt{n^2+n}}}\leqslant \sum_{k=1}^n{\frac{-k}{n^2+k+n\sqrt{n^2+k}}}\leqslant \sum_{k=1}^n{\frac{-k}{2n^2}}=-\frac{n+1}{4n},\forall n\in \mathbb{N}.
\]
...
\\
&=\frac{1}{n}\int_{\frac{1}{n+1}}^{\frac{1}{m}}{\frac{n^x}{x^2}\mathrm{d}x}\geqslant \frac{n^{\frac{1}{m}}}{n}\int_{\frac{1}{n+1}}^{\frac{1}{m}}{\frac{1}{x^2}\mathrm{d}x}=\frac{n^{\frac{1}{m}}}{n}\left( n-m+1 \right) .
\end{align*}
又注意到
\begin{align*}
...
\begin{example}
设 $\lim\limits_{n\rightarrow +\infty}\frac{a_n}{n^2}=a$,$\lim\limits_{n\rightarrow +\infty}\frac{b_n}{n^2}=b$．证明极限 $\lim\limits_{n\rightarrow +\infty}\frac{1}{n^5}\sum_{k=0}^n a_k b_{n-k}$ 存在并求其值．
\end{example}
\begin{proof}
...
\begin{align*}
\frac{\sum\limits_{k=0}^n a_kb_{n-k}}{n^5}=\frac{ab\sum\limits_{k=N+1}^{n-N-1} (n-k)^2k^2}{n^5},\quad \forall n>N_1.
\end{align*}
注意到
\begin{align*}
...
故
\begin{align*}
\lim\limits_{n\rightarrow \infty}\frac{\sum\limits_{k=0}^n a_kb_{n-k}}{n^5}=\frac{ab}{30}.
\end{align*}
...
对 $k \in \mathbb{N}$, 我们有
\begin{align*}
b_1(x) &\sim -\frac{1}{\pi} \sum_{n=1}^\infty \frac{\sin(2n\pi x)}{n}, \\
b_{2k}(x) &= \frac{2(-1)^{k+1}}{(2\pi)^{2k}} \sum_{n=1}^\infty \frac{\cos(2n\pi x)}{n^{2k}}, \\
b_{2k+1}(x) &= \frac{2(-1)^{k+1}}{(2\pi)^{2k+1}} \sum_{n=1}^\infty \frac{\sin(2n\pi x)}{n^{2k+1}}.
\end{align*}
\end{proposition}
\begin{remark}
$b_1(x)$ 的傅立叶级数并不总是收敛到 $b_1(x)$. 事实上, 由狄利克雷收敛定理, 我们知道
$$-\frac{1}{\pi} \sum_{n=1}^\infty \frac{\sin(2n\pi x)}{n} = \begin{cases} 
b_1(x), & x \text{不是整数} \\
0, & x \text{是整数} 
\end{cases}.$$
\end{remark}
...
\begin{align*}
\zeta(x) \triangleq \sum_{n=1}^\infty \frac{1}{n^x},\,x > 1 \quad \text{或} \quad
...
\begin{align*}
\sum_{k=a}^b f(k) - \int_a^b f(x) \mathrm{d}x &= \frac{f(b) + f(a)}{2} + \sum_{k=1}^m \left[ f^{(2k-1)}(b) - f^{(2k-1)}(a) \right] b_{2k}(0) - \int_a^b b_{2m}(x) f^{(2m)}(x) \mathrm{d}x.
\end{align*}
\end{theorem}
\begin{proof}
由\refthe{theorem:0阶Euler-Maclaurin公式(0阶E-M公式)},我们有
\begin{align}
\sum_{k=a}^b f(k) &= \int_a^b f(x) \mathrm{d}x + \frac{f(a) + f(b)}{2} + \int_a^b b_1(x) f'(x) \mathrm{d}x. \label{eq:::----9.46-9.46-9.46}
\end{align}
现在利用 $b_2$ 周期性和分部积分得
\begin{align*}
...
\begin{align*}
\sum_{k=a}^b f(k) - \int_a^b f(x) \mathrm{d}x 
&= \frac{f(b) + f(a)}{2} + \sum_{k=2}^m \left[ f^{(k-1)}(b) - f^{(k-1)}(a) \right] b_k(0) + (-1)^{m+1} \int_a^b b_m(x) f^{(m)}(x) \mathrm{d}x.
\end{align*}
...
\geqslant -1 + \sum_{n = 0}^{\infty}\int_{n}^{n + 1}x^{t^2}\mathrm{d}t
...
\leqslant\sum_{n = 1}^{\infty}\int_{n - 1}^{n}x^{t^2}\mathrm{d}t
...
\begin{align*}
-1+\frac{\sqrt{\pi}}{2\sqrt{-\ln x}}=-1+\lim_{n\rightarrow \infty} \int_1^n{x^{t^2}\mathrm{d}t}\leqslant \sum_{n=1}^{\infty}{x^{n^2}}\leqslant \lim_{n\rightarrow \infty} \int_0^n{x^{t^2}\mathrm{d}t}=\frac{\sqrt{\pi}}{2\sqrt{-\ln x}}.
\end{align*}
即
\[
