...
\[
b_2(x)=\int_0^x{b_1(y)\mathrm{d}y}, \quad |b_2(x)|\leqslant slant\frac{1}{12}, \forall x\in\mathbb{R}.
\]
...
\end{align*}
又因为\(|b_2(x)|\leqslant slant\frac{1}{12}\),\(\forall x\in\mathbb{R}\).所以对\(\forall n\in\mathbb{N}\),我们有
\[
\left|\frac{b_2(n)}{n} - \int_n^{+\infty}\frac{b_2(x)}{x^2}\mathrm{d}x\right|\leqslant slant\frac{1}{12}\left(\frac{1}{n}+\int_n^{+\infty}\frac{1}{x^2}\mathrm{d}x\right)=\frac{1}{6n}.
\]
