...
\item\label{theorem:单位群整除的基本性质-9} 若 \( a|b, a|c \)，则 \( a|(b + c) \).
\end{enumerate}
\end{theorem}
\begin{proof}
\begin{enumerate}[(1)]
...
\begin{gather*}
a=up_{1}^{n_1}p_{2}^{n_2}\cdots p_{r}^{n_r},\quad n_i\in \mathbf{N}\cup \{0\};
\\
b=vp_1^{m_1}p_2^{m_2}\cdots p_r^{m_r}, \quad m_i \in \mathbf{N}\cup \{0\}.
\end{gather*}
...
\begin{align*}
a=uq_1^{n_1}q_2^{n_2}\cdots q_r^{n_r},\quad n_i\in \mathbf{N}.
\end{align*}
