...
\item\label{theorem:单位群整除的基本性质-2} 若$a\sim b$,则$ac\sim bc.$
...
\item 由$a\sim b$知$b=ad,a=be(d,e\in R)$,则$bc=adc,ac=bec$,故$ac\mid bc,bc\mid ac$,即$ac\sim bc.$
...
\item\label{lemma:最大公因子条件的基本结论-4} \( c(a, b) \sim (ca, cb) \)；
