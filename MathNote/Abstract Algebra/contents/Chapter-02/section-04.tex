...
\end{align}
若$b = 0$,则由\eqref{eq:::::::---:io0fjow::--q8hro2h3r2.5.}式得$a = 0$.若$a = 0$,则由\eqref{eq:::::::---:io0fjow::--q8hro2h3r2.5.}式得$b^2 d = 0$,而$d \neq 0$,于是$b = 0$.从而$a,b$都不为0,所以$d = \frac{a^2}{b^2} > 0$.又$d$是不等于1的整数,故$d > 1$.由于等式\eqref{eq:::::::---:io0fjow::--q8hro2h3r2.5.}的左边是一平方数,因此$d$必定也是个平方数.这与$d$无平方因子的假设相矛盾.于是$a + b\sqrt{d} = 0$当且仅当$a,b$全为0,即$N(0) = 0$,且由$N(\alpha) = |a^2 - db^2| = 0$得$a^2 = db^2$,故$a = b = 0$,即$\alpha = 0$.
...
&= (aa' + bb'd)^2 - d(ab' + ba')^2,
\end{align*}
所以$N(\alpha)N(\beta) = N(\alpha\beta)$.
