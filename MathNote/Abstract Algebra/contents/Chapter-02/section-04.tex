...
\end{align*}
若 \( c \) 是 \( a \) 的一个非平凡因子，则存在$u_1\in U$以及$n_i'\leqslant n_i$且$n_i'\in \mathbb{N}(i=1,2,\cdots,r)$,使
\begin{align*}
...
\end{gather*}
若还有$d$是$a,b$的公因子,则存在$w\in U$以及$n_i'\leqslant \min \left\{ n_i,m_i \right\} $且$n_i'\in \mathbb{N}(i=1,2,\cdots,r)$,使
\begin{align*}
