...
\end{proposition}
\begin{proof}
由\reflemma{lemma:HN<G的条件}可知$(I+J,+)<(R,+)$。因此我们只须证明乘法的 “吸收” 性。
\begin{align*}
...
\end{proposition}
\begin{proof}
首先，由\refproposition{proposition:理想的加法还是理想}可知 $I + J$ 是一个理想。而 $I + J \supset I + \{0\} = I$，同理 $I + J \supset J$，故 $I + J \supset I \cup J$。这就证明了 $I + J$ 是一个包含了 $I \cup J$ 的理想。
...
\end{definition}
\begin{remark}
由\refproposition{proposition:由子集生成的理想还是理想}可知,上述定义的$IJ$仍是$R$的一个理想.
\end{remark}
...
\end{lemma}
\begin{proof}
证明是不难的。由\refproposition{proposition:理想的乘法表示形式}可知$(I \cap J)(I + J)=\{\sum_i (a_i(b_i + c_i)):a_i \in I \cap J, b_i \in I, c_i \in J\}.$于是任取$\sum_i (a_i(b_i + c_i)) \in (I \cap J)(I + J)$,则$a_i(b_i + c_i) \in (I \cap J)\cdot (I + J)$，其中 $a_i \in I \cap J, b_i \in I, c_i \in J$，从而
\begin{align*}
...
\end{proposition}
\begin{proof}
一方面，若 $I + J = R$，则根据\reflemma{lemma:理想是整个环的充要条件}可知 $1 \in R = I + J$，故存在 $a \in I$，$b \in J$，使得 $a + b = 1$。
...
\end{proposition}
\begin{proof}
由\reflemma{lemma:IJ、I与J的交、I+J的关系}可知
\begin{align*}
IJ \subset I \cap J.
\end{align*}
故只须证明
...
I \cap J \subset IJ.
\end{align*}
由$I,J$互素可知$I+J=R$.又由\refproposition{proposition:理想的任意交还是理想}可知$I\cap J$仍是$R$的理想,从而$I \cap J = (I \cap J)R .$于是由\reflemma{lemma:I与J的交、I+J的乘积包含于IJ}可得
\begin{align*}
...
\end{proposition}
\begin{proof}
就加法子群而言，由\refproposition{proposition:环同态的等价条件}可知 $0 = f^{-1}(0) \in R$,并且若 $a = f^{-1}(a'), b = f^{-1}(b') \in f^{-1}(I')$，则
\begin{align*}
