...
\begin{definition}
若交换幺环的每个理想都是主理想，则称此环为\textbf{主理想环}．一个主理想环若又是整环，则称此环为\textbf{主理想整环}，记为$\mathbf{p}.\mathbf{i}.\mathbf{d}.$或$\mathbf{PID}$.
\end{definition}

\begin{proposition}\label{proposition:Z是主理想整环}
整环$\mathbb{Z}$是主理想整环．
\end{proposition}
\begin{proof}
事实上，设$I$为$\mathbb{Z}$的一个非平凡理想，于是$\exists m \in I$满足
\begin{align*}
m=\min\{|k| \mid k \in I, k \neq 0\}.
\end{align*}
$\forall k \in I$，若$k=0$，则$k=0 \cdot m$；若$k \neq 0$，则$\exists q, r \in \mathbb{Z}$，满足$k=q m + r$（$0 \leqslant r < m$），由$I\lhd \mathbb{Z}$和$m\in I$知$qm\in I$,于是$r \in I$．由$m$的取法知$r=0$，即$k=q m$，否则与$m$的最小值定义矛盾!故$I=\{xm\mid x\in \mathbb{Z}\}=\langle m \rangle$，因而$\mathbb{Z}$是主理想整环．
...
\end{example}
\begin{proof}
事实上，若$\mathbb{Z}[x]$是主理想整环，则有$g(x)$，使得$\langle 2, x^2 + 1\rangle=\langle g(x) \rangle$.由\rrefthe{theorem:主理想和有限生成理想的形状}{theorem:主理想和有限生成理想的形状-2}知
\begin{align}\label{eq::90j3g434}
\left\{ 2u\left( x \right) +\left( x^2+1 \right) v\left( x \right) \mid u\left( x \right) ,v\left( x \right) \in \mathbb{Z}\left[ x \right] \right\} =\langle 2,x^2+1\rangle =\langle g(x)\rangle =\left\{ u\left( x \right) g\left( x \right) \mid u\left( x \right) \in \mathbb{Z}\left[ x \right] \right\} .
\end{align}
因为$2\in \langle 2,x^2+1\rangle$,所以由\eqref{eq::90j3g434}式知存在$f(x)\in \mathbb{Z}\left[ x \right],$使$2=f(x)g(x)$,即$g(x) \mid 2$，故$g(x)=\pm 1, \pm 2$．另一方面，由$g(x) \in \langle 2, x^2 + 1 \rangle$，故由\eqref{eq::90j3g434}式有$u(x), v(x) \in \mathbb{Z}[x]$，使得
\begin{align*}
g(x)=2 u(x) + (x^2 + 1) v(x).
\end{align*}
令$x=1$，则有$g(1)=2(u(1) + v(1))$．于是$g(x)=\pm 2$，但$\pm 2 \nmid (x^2 + 1)$，即$g(x)\nmid (x^2 + 1)$,从而$x^2 + 1 \notin \langle g(x) \rangle$．这与\eqref{eq::90j3g434}式矛盾!因而$\mathbb{Z}[x]$不是主理想整环．
...
\end{align*}
一定存在$m\in \mathbb{N}$，使得当$n \geqslant m$时，$\langle a_n \rangle = \langle a_m \rangle$.
\end{enumerate}
\end{theorem}
...
\langle a_1 \rangle \subseteq \langle a_2 \rangle \subseteq \cdots \subseteq \langle a_n \rangle \subseteq \langle a_{n+1} \rangle \subseteq \cdots,
\end{align*}
由\hyperref[theorem:整除与主理想的关系-2]{结论\ref{theorem:整除与主理想的关系-2}}知$a_{n+1}\mid a_n(n\in \mathbb{N})$.故
\begin{align*}
a_1,a_2,\cdots ,a_n,a_{n+1},\cdots 
\end{align*}
是$R$的因子链.
若$R$满足因子链条件,则存在$m\in \mathbb{N},$使得当$n\geqslant m$时,有$a_n\sim a_m$.由\hyperref[theorem:整除与主理想的关系-2]{结论\ref{theorem:整除与主理想的关系-2}},此即$\langle a_n \rangle = \langle a_m \rangle$.

若存在$m\in \mathbb{N}$，使得当$n \geqslant m$时，$\langle a_n \rangle = \langle a_m \rangle$.由\hyperref[theorem:整除与主理想的关系-2]{结论\ref{theorem:整除与主理想的关系-2}},此即$a_n\sim a_m$.故此时$R$满足因子链条件.

\end{enumerate}

\end{proof}

\begin{theorem}\label{theorem:p.i.d必是UFD}
主理想整环一定是唯一析因环．
\end{theorem}
\begin{proof}
...
\end{align*}
是$R$中一个主理想升链．令$I = \bigcup\limits_{i=1}^{\infty} \langle a_i \rangle$．若$a, b \in I$，则$\exists i, j \in \mathbb{N}$，使$a \in \langle a_i \rangle$，$b \in \langle a_j \rangle$．不妨设$j \geqslant i$．由此知$a - b \in \langle a_j \rangle \subseteq I$，故$I$是$R$中加法子群,也是Abel群.显然$I$对乘法封闭且满足结合律,故$I$是$R$的子环.又由\rrefthe{theorem:主理想和有限生成理想的形状}{theorem:主理想和有限生成理想的形状-2}知$\forall c \in R$，$ca \in \langle a_i \rangle \subseteq I$，故$I$是$R$中理想．由$R$是主理想整环知$\exists d \in R$，使$I = \langle d \rangle$．因$d \in I$，故$\exists m \in \mathbb{N}$，使$d \in \langle a_m \rangle$，因而当$n \geqslant m$时，由\refthe{theorem:主理想和有限生成理想的形状}有
\begin{align*}
...
\begin{corollary}\label{corollary:最大公因子的性质-1}
设$R$是主理想整环,若$d$为$a, b$的最大公因子，则存在$a_1, b_1 \in R$，使得$a=da_1,b=db_1$且$(a_1,b_1)=1.$
\end{corollary}
\begin{proof}
由$d\mid a,b$知存在$a_1,b_1\in R$，使$a=da_1$，$b=db_1$。于是由\rreflem{lemma:最大公因子条件的基本结论}{lemma:最大公因子条件的基本结论-4}知
$d=(a,b)=(da_1,db_1)\sim d(a_1,b_1)$。
从而存在$r\in R$，使$d=d(a_1,b_1)r$。由\rrefpro{proposition:整环的一些性质}{proposition:整环的一些性质-2}知$R^*$对乘法满足消去律,故$1=(a_1,b_1)r$。因此$(a_1,b_1)\in U$，再由\rrefthe{theorem:单位群整除的基本性质}{theorem:单位群整除的基本性质-7}知$(a_1,b_1)\sim 1$。

\end{proof}

\begin{corollary}\label{corollary:主理想整环中互素的充要条件}
...
\begin{definition}[Euclid环]\label{definition:Euclid环的定义}
设$R$为交换整环. 若存在$R$到非负整数集$\mathbb{N}\cup\{0\}$的映射$\delta$, 使得$\forall\ a,b\in R$, $b\neq 0$, $\exists q,r\in R$满足
\begin{align}\label{eq:::09gj3ety4s34wygew3tygwef23g2.5.3}
a=qb+r,\quad \delta(r)<\delta(b),
\end{align}
则称$R$为$\mathbf{Euclid}$\textbf{环}.
\end{definition}
...
\end{example}
\begin{proof}
事实上,任何两个整数之间都可做带余除法,故只需取$\delta(m)=|m|$即可验证$\delta$满足定义.

\end{proof}

\begin{example}
设$\mathbb{P}$为数域, 则$\mathbb{P}[x]$是Euclid环.定义$\delta$为
\begin{align*}
\delta(f(x))=
\begin{cases}
2^{\deg f(x)},\ &f(x)\neq 0,\\
...
\end{cases}
\end{align*}
不难验证$\delta$满足\hyperref[definition:Euclid环的定义]{Euclid环}所要求的条件.
\end{example}

\begin{example}
Gauss整数环$\mathbb{Z}[\sqrt{-1}]=\{a+b\sqrt{-1}\mid a,b\in\mathbb{Z}\}$是Euclid环.
\end{example}
\begin{proof}
...
\alpha\beta^{-1}=\mu+\nu\sqrt{-1},\quad \mu,\nu\in\mathbb{Q}.
\end{align*}
于是$\exists c,d\in\mathbb{Z}$, 使得$|c-\mu|\leqslant \frac{1}{2}$, $|d-\nu|\leqslant \frac{1}{2}$. 令$\varepsilon=\mu-c$, $\eta=\nu-d$, 则有$|\varepsilon|\leqslant \frac{1}{2}$, $|\eta|\leqslant \frac{1}{2}$, 而
\begin{align*}
...
\end{align*}
故$\mathbb{Z}[\sqrt{-1}]$为Euclid环.

\end{proof}

\begin{theorem}\label{theorem:Euclid环必是主理想整环}
Euclid环是主理想整环.因而也是唯一析因环.
\end{theorem}
\begin{remark}
确有主理想整环不是Euclid环. 例如, 环
\begin{align*}
...
\begin{align}
\delta(b)=\min\{\delta(c)\mid c\in I,c\neq 0\}.\label{eq:::09gj3ety4s34wygew3tygwef23g2.5.4}
\end{align}
设$a\in I$, 则有$q,r\in R$, 使
\begin{align*}
a=qb+r,\quad \delta(r)<\delta(b).
\end{align*}
因$a,b\in I$, 故$r=a-qb\in I$. 由$b$的取法知$r\notin I\setminus\{0\}$,否则与$\delta(b)$的最小值定义矛盾! 故$r=0$, 因而$a\in\langle b\rangle$, 故$I=\langle b\rangle$. 即$R$为主理想环.又$R$是整环,故$R$为主理想整环.再由\refthe{theorem:p.i.d必是UFD}知Euclid环也是唯一析因环.

\end{proof}

\begin{proposition}[辗转相除法]
设$R$是Euclid环,$R^*=R\setminus \{0\}$,$a,b\in R^*$,求$a$与$b$的最大公因子.
\end{proposition}
\begin{note}
...
不妨设$\delta(a)\geqslant\delta(b)$, 并记$a=a_1$, $b=a_2$. 于是$\exists q_1,a_3\in R$, 使
\begin{align*}
a_1=q_1a_2+a_3,\quad \delta(a_3)<\delta(a_2).
\end{align*}
若$a_3=0$, 则由\rreflem{lemma:最大公因子条件的基本结论}{lemma:最大公因子条件的基本结论-4}和\rrefthe{theorem:单位群整除的基本性质}{theorem:单位群整除的基本性质-2}知
$$
(a_1,a_2)=\left( q_1a_2,a_2 \right) =\left( q_1,1 \right) a_2\sim a_2,
$$
设$a_3\neq 0,$
由\refcor{corollary:最大公因子的性质-1}知存在$a_{2}^{\prime},a_{3}^{\prime}\in R$，使$a_2=a_{2}^{\prime}(a_2,a_3)$，$a_3=a_{3}^{\prime}(a_2,a_3)$且$(a_{2}^{\prime},a_{3}^{\prime})=1$。再由\refcor{corollary:主理想整环中互素的充要条件}知存在$u,v\in R$，使
\begin{align*}
ua_{2}^{\prime}+va_{3}^{\prime}=1.
\end{align*}
从而
\begin{align*}
v(q_1a_{2}^{\prime}+a_{3}^{\prime})+(u-vq_1)a_{2}^{\prime}=ua_{2}^{\prime}+va_{3}^{\prime}=1.
\end{align*}
又$v,u-vq_1\in R$，故由\refcor{corollary:主理想整环中互素的充要条件}知$(q_1a_{2}^{\prime}+a_{3}^{\prime},a_{2}^{\prime})\sim 1$。再利用\rreflem{lemma:最大公因子条件的基本结论}{lemma:最大公因子条件的基本结论-4}和\rrefthe{theorem:单位群整除的基本性质}{theorem:单位群整除的基本性质-2}得
\begin{align*}
(a_1,a_2)=(q_1a_2+a_3,a_2)=(q_1a_{2}^{\prime}(a_2,a_3)+a_{3}^{\prime}(a_2,a_3),a_{2}^{\prime}(a_2,a_3))\sim (q_1a_{2}^{\prime}+a_{3}^{\prime},a_{2}^{\prime})(a_2,a_3)\sim (a_2,a_3).
\end{align*}
再对$a_2,a_3$作除法运算
\begin{align*}
...
\begin{gather*}
a_1=q_1a_2+a_3,\quad \delta \left( a_3 \right) <\delta \left( a_2 \right) ;
\\
a_2=q_2a_3+a_4,\quad \delta \left( a_4 \right) <\delta \left( a_3 \right) ;
\\
\cdots \cdots \cdots \cdots 
\\
a_{n-2}=q_{n-2}a_{n-1}+a_n,\quad \delta \left( a_n \right) <\delta \left( a_{n-1} \right) ;
\\
a_{n-1}=q_{n-1}a_n,\quad \delta \left( a_n \right) <\delta \left( a_{n-1} \right) .
\end{gather*}
并且
\begin{align*}
\left( a_1,a_2 \right) \sim \left( a_2,a_3 \right) \sim \cdots \sim \left( a_{n-1},a_n \right) \sim a_n.
\end{align*}
