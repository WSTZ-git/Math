...
a=qb+r,\quad \delta(r)<\delta(b).
\end{align*}
因$a,b\in I$, 故$r=a-qb\in I$. 由$b$的取法知$r\notin I\setminus\{0\}$,否则与$\delta(b)$的最小值定义矛盾! 故$r=0$, 因而$a\in\langle b\rangle$, 故$I=\langle b\rangle$. 即$R$为主理想环.再由\refthe{theorem:p.i.d必是UFD}知Euclid环也是唯一析因环.
