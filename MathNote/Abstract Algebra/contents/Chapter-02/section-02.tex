...
\end{align*}
注意到$i_u(R[x])=R[u]$,故$i_u$是满同态.于是由\rrefpro{proposition:群同态的核是定义域的子群,像是陪域的子群-抽象代数}{proposition:群同态的核是定义域的子群,像是陪域的子群-抽象代数-2}知$I=\ker i_u$为$R[x]$中理想，$R[u]\cong R[x]/I$. 又若$a\in R\cap I$，则$0=i_u(a)=i(a)=a$，故$R\cap I=\{0\}$. 由于$u$为$R$上代数元当且仅当存在$a_n\ne 0$,使得$\sum\limits_{i=0}^n a_iu^i=0$.这也当且仅当
\begin{align*}
