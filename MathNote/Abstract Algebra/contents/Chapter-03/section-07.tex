...
\begin{lemma}[Zassenhaus定理(蝴蝶引理)]\label{lemma:抽象代数-引理4.7.1-Zassenhaus定理(蝴蝶引理)}
设$H, K$是群$G$的子群, 又$H^*, K^*$分别是$H, K$的正规子群, 则
\begin{gather*}
H^*(H\cap K^*)\lhd H^*(H\cap K),\quad K^*(H^*\cap K)\lhd K^*(H\cap K),
\\
...
\\
&\cong (H\cap K)H^*/(H\cap K^*)H^*\cong (H\cap K)K^*/(H^*\cap K)K^*
\\
...
\begin{figure}[H]
\centering
% https://q.uiver.app/#q=
\begin{tikzcd}
& H && K \\
& {H^*(H\cap K)} && {(H\cap K)K^*} \\
&& {H\cap K} \\
...
\arrow["{*}"{marking, allow upside down}, no head, from=2-2, to=4-2]
\arrow[no head, from=2-4, to=3-3]
\arrow["{*}"{marking, allow upside down}, no head, from=2-4, to=4-4]
\arrow["{*}"{marking, allow upside down}, no head, from=3-3, to=5-3]
...
\begin{gather}
H^*(H\cap K^*)\lhd H^*(H\cap K),\label{eq::j2190i092ir0HSU-1}
\\
H^*(H\cap K)/H^*(H\cap K^*) \cong (H\cap K)/(H\cap K^*)(H^*\cap K).\nonumber
\end{gather}
同理可得
\begin{gather}
K^*(H^*\cap K)\lhd K^*(H\cap K),\label{eq::j2190i092ir0HSU-2}
\\
K^*(H\cap K)/K^*(H^*\cap K) \cong (H\cap K)/(H\cap K^*)(H^*\cap K).\nonumber
\end{gather}
故
\begin{align}\label{eq::j2190i092ir0HSU-3}
H^*(H\cap K)/H^*(H\cap K^*) \cong (H\cap K)/(H\cap K^*)(H^*\cap K)\cong K^*(H\cap K)/K^*(H^*\cap K).
\end{align}
综上,同理可得
\begin{gather}
(H\cap K^*)H^*\lhd (H\cap K)H^*,\quad (H^*\cap K)K^*\lhd (H\cap K)K^*,\label{eq::j2190i092ir0HSU-4}
\\
(H\cap K)H^*/(H\cap K^*)H^*\cong (H\cap K)/(H\cap K^*)(H^*\cap K)\cong (H\cap K)K^*/(H^*\cap K)K^*.\label{eq::j2190i092ir0HSU-5}
\end{gather}
再结合\eqref{eq::j2190i092ir0HSU-1}\eqref{eq::j2190i092ir0HSU-2}\eqref{eq::j2190i092ir0HSU-3}\eqref{eq::j2190i092ir0HSU-4}\eqref{eq::j2190i092ir0HSU-5}即得结论.
...
H_{s,r} &= \{1\}.
\end{align*}
由$G_{k+1}\lhd G_k(1\leqslant k\leqslant r-1),H_{k+1}\lhd H_k(1\leqslant k\leqslant s-1)$及\hyperref[lemma:抽象代数-引理4.7.1-Zassenhaus定理(蝴蝶引理)]{Zassenhaus定理}可得
\begin{align*}
...
\end{align}
由\hyperref[lemma:抽象代数-引理4.7.1-Zassenhaus定理(蝴蝶引理)]{Zassenhaus定理}有
\begin{gather*}
