...
若 \( j \in \bar{F}_\tau \)，则$\tau =(i_1i_2)\left( i_3i_4 \right) \cdots \left( j\tau ^{-1}\left( j \right) \right) \cdots $且$i_1,i_2,i_3,i_4,j,\tau ^{-1}\left( j \right) $互不相同.由 \( j \neq i_1, i_2, i_3, i_4 \)知$|\bar{F}_\tau| \geqslant 5$,又$\tau$可写成对换之积,故$|\bar{F}_\tau|$必为偶数,因此 \( |\bar{F}_\tau| \geqslant 6 \). 此时由\rrefpro{proposition:对换与轮换的基本性质}{proposition:对换与轮换的基本性质-3}可得
\begin{align*}
...
\end{align*}
因为 \( (i_1i_2i_3i_4) \) 为奇置换，故 \( \tau \neq (i_1i_2i_3i_4) \)，由此知 \( |\bar{F}_\tau| > 4 \)，即$|\bar{F}_\tau|\geqslant 5$.因而有 \( j, k \in \bar{F}_\tau \). 令 \( \phi = (i_3jk) \)，\( \tau_1 = \tau^{-1}\phi\tau\phi^{-1} \)，由 \( H \lhd A_n \) 有 \( \tau_1 = \tau^{-1}(\phi\tau\phi^{-1}) \in H \).于是由\rrefpro{proposition:对换与轮换的基本性质}{proposition:对换与轮换的基本性质-3}可得
\begin{align*}
