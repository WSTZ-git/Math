...
另一方面, 对$g\in F_A$有$gA=A$,即$g(a)=ga\in A(\forall a\in A)$. 于是$F_A\cdot a\subseteq A$, 故再由\rrefthe{theorem:子群陪集相关性质}{theorem:子群陪集相关性质-5}知
$$
...
特别地, 若$H$也是$G$的一个Sylow $p$子群,则$|H|=p^l$,再由\rrefthe{theorem:子群陪集相关性质}{theorem:子群陪集相关性质-5}知$|H|=p^l=|P|=|gPg^{-1}|$. 又由之前证明知$H\subseteq gPg^{-1}$,从而$H=gPg^{-1}$.由\refthe{theorem:共轭子群和正规化子}知$H,P$相互共轭.
...
又由\rrefthe{theorem:子群陪集相关性质}{theorem:子群陪集相关性质-5}知$|P|=|gPg^{-1}|=p^l$,故$gPg^{-1}$也是$G$的Sylow $p$子群.
...
$$
故$h^{-1}gh\in F_P(\forall g\in P)$,从而$hPh^{-1}\subseteq F_P$. 因此$h^{-1}Ph$, $P$均为$F_P$的子群.由\eqref{eq::iogjio30uv33}式知$t\mid m$,又因为$(p,m)=1$,所以$(p,t)=1.$而由\eqref{eq::90j243gy5yhserfgdjirzz}知$|F_p|=p^lt,|P|=p^l$,再由\rrefthe{theorem:子群陪集相关性质}{theorem:子群陪集相关性质-5}知$|h^{-1}Ph|=|P|=p^l$,故$h^{-1}Ph$, $P$均为$F_P$的Sylow $p$子群. 又$P\lhd F_P$, 故由结论(1)知$h^{-1}Ph=P$, 故$P=P_1$. 这就说明包含一个元素的$X$的轨道仅有一个. 注意到
\begin{align*}
