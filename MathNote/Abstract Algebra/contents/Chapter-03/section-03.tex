...
特别地, 若$H$也是$G$的一个Sylow $p$子群,则$|H|=p^l$,再由\refpro{proposition:陪集aH的阶与H相同}知$|H|=p^l=|P|=|gPg^{-1}|$. 又由之前证明知$H\subseteq gPg^{-1}$,从而$H=gPg^{-1}$.由\refdef{definition:两个子群共轭的定义}知$H,P$相互共轭.
...
\begin{proof}
\begin{enumerate}[(1)]
\item 设$P$是$G$的一Sylow $p$子群.任取$g\in G$,对$\forall p_1,p_2\in P$,有$(gp_1g^{-1})(gp_2g^{-1})^{-1}=gp_1p_2^{-1}g^{-1}\in gPg^{-1},$因此$gPg^{-1}$是$G$的子群.
...
\item 由(1)的证明可知,$X=\{gPg^{-1}|g\in G\}$是$G$中Sylow $p$子群的集合.现设$|X|=k$, 则$G\times X$到$X$的映射
\begin{align*}
...
若$t=1$, 则$k=4$. 设$X=\{P_1,P_2,P_3,P_4\}$为$G$的Sylow 3子群的集合, $G$在$X$上的作用可递, 由\refthe{theorem:抽象代数--定理4.2.}知有$G$到$S_X=S_4$中的同态$\sigma$. 于是由\hyperref[theorem:群的同态基本定理]{群的同态基本定理}知$\ker \sigma \lhd G$且$G/\ker\sigma$与$S_4$的一个子群$\sigma(G)$同构, 而$|S_4|=24<72$,于是
\begin{align*}
