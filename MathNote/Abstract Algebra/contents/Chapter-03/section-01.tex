...
\end{align*}
故由\refthe{theorem:生成子群的元素的形式}知$G_1=\{a,a^{-1}\}$。从而$G_1$为$S_3$的2阶子群且$b \notin G_1$，于是$G_1 \subset \langle \{a, b\} \rangle$. 设$\langle \{a, b\} \rangle$的阶为$n$,则由\hyperref[theorem:Lagrange定理--抽象代数]{Lagrange定理}知$2\mid n$且$2 < n$.又因为$\langle \{a, b\} \rangle$是$G$的子群，所以
由\hyperref[theorem:Lagrange定理--抽象代数]{Lagrange定理}知$n\mid 6$.因而有$n = 6$，由此知$S_3 = \langle \{a, b\} \rangle$.
