...
\begin{proposition}\label{proposition:对称群正规子群的分类}
设 \(S_n\) 是 \(n\) 次对称群，\(n\) 为正整数。则 \(S_n\) 的所有正规子群如下：
\begin{enumerate}[(1)]
\item 若 \(n = 1\)，则正规子群为 \(S_1=\{1\}\)；

\item 若 \(n = 2\)，则正规子群为 \(A_2=\{1\}\)和 \(S_2\)；

\item 若 \(n = 3\)，则正规子群为 \(\{1\}\)、\(A_3\) 和 \(S_3\)；

\item 若 \(n = 4\)，则正规子群为 \(\{1\}\)、\(K_4\)、\(A_4\) 和 \(S_4\)；

\item 若 \(n \geqslant 5\)，则正规子群为 \(\{1\}\)、\(A_n\) 和 \(S_n\)。
\end{enumerate}
其中 \(A_n\) 表示 \(n\) 次交错群，\(K_4 = \{1, (12)(34), (13)(24), (14)(23)\}\)表示Klein四元群.
\end{proposition}
\begin{proof}
