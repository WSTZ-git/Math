...
设$H, K$是群$G$的子群，则有
\begin{enumerate}[(1)]
\item\label{lemma:换位子群的基本性质-1} $[H, K] = \{1\}\iff H \subseteq C_G(K)$;

\item\label{lemma:换位子群的基本性质-2} $[H, K] \subseteq K\iff H \subseteq N_G(K)$,
\\
$[H, K] \subseteq H\iff K \subseteq N_G(H)$;

\item\label{lemma:换位子群的基本性质-3} 若$H \lhd G, K \lhd G$，则$[H, K] \lhd G$且$[H, K] \subseteq H \cap K$.特别地,由$G\lhd G$知$[G,G]\lhd G$;
