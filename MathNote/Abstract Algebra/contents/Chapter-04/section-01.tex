...
\begin{align*}
F[S]\triangleq \left\{ \sum_{i_1,i_2,\cdots ,i_n\geqslant 0}{\alpha _{i_1i_2\cdots i_n}a_{1}^{i_1}a_{2}^{i_2}}\cdots a_{n}^{i_n}\mid a_j\in S,\,j=1,2,\cdots ,n,\,\,\alpha _{i_1i_2\cdots i_n}\in F \right\}.
\end{align*}
...
若$\alpha$是$F$上的代数元,称$K=F(\alpha)$为$F$的\textbf{单代数扩域}.

若$\alpha$是$F$上的超越元,称$K=F(\alpha)$为$F$的\textbf{单超越扩域}.
\end{definition}
\begin{remark}
