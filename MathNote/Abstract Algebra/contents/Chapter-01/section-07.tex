...
\begin{enumerate}[(1)]
\item\label{theorem:群的同态基本定理-1} 若$G$的子群$G'$满足$G'\supseteq \ker f$,则$\ker f \lhd G'$;
...
\item 由\hyperref[theorem:群的同态基本定理]{群的同态基本定理\ref{theorem:群的同态基本定理-1}}知$\ker f\lhd G_1$,再由\rrefpro{proposition:正规子群的基本性质}{proposition:正规子群的基本性质-2}知$K\lhd G_1$,再结合条件可得
\begin{align*}
K\lhd G_1\lhd G.
\end{align*}
