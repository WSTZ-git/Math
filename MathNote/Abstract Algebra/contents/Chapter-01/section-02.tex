...
\begin{align*}
\mathbb{Z}_p^* = \{ \overline{1},\overline{2},\cdots,\overline{p-1} \}.
\end{align*}
\end{theorem}
\begin{remark}
...
\begin{align*}
\phi(m) = (p_1^{r_1} - p_1^{r_1 - 1})(p_2^{r_2} - p_2^{r_2 - 1})\cdots (p_s^{r_s} - p_s^{r_s - 1}) = m \prod\limits_{i=1}^s \left( 1 - \frac{1}{p_i} \right).
\end{align*}
\end{remark}
\begin{proof}
