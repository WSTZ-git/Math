...
\begin{align*}
\overline{K}=\overline{E}(\zeta,\alpha_1,\cdots,\alpha_r)\supseteq F_{m-1}(\zeta,\theta)=K,
\end{align*}
存在中间域链
\begin{align*}
...
\begin{corollary}
设$x_1,x_2,\cdots,x_n$为域$F$上的不定元，$p_1,p_2,\cdots,p_n$为其初等对称多项式。当$n\geqslant5$时，$g(x)=\prod\limits_{i=1}^n(x-x_i)$在$F(p_1,p_2,\cdots,p_n)$上不可用根式解。
\end{corollary}
\begin{proof}
由已知结论，$G(g(x),F(p_1,\cdots,p_n))\cong S_n$。$n\geqslant5$时对称群$S_n$非可解群，故$g(x)=0$不可用根式解.
