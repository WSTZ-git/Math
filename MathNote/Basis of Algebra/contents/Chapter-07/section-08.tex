...
\end{pmatrix},
\end{align*}
其中每个 $J_i$ 都是形如\reflem{lemma:Jordan块的初等因子组}中的矩阵，$J_i$ 的初等因子组为 $(\lambda - \lambda_i)^{r_i}$，则 $J$ 的初等因子组为
\begin{align*}
...
\end{pmatrix},
\end{align*}
其中 $H_i = \mathrm{diag}\{1,\cdots,1,(\lambda - \lambda_i)^{r_i}\}$。再由\reflem{lemma:初等因子组等于准素因子组}即得结论。
\end{proof}
