...
\end{theorem}
\begin{note}
\href{https://www.doc88.com/p-9827401091114.html}{谢启鸿博客}中利用循环子空间证明双中心化子定理.
\end{note}
\begin{proof}
由\refthe{theorem:循环子空间的刻画}、\refpro{proposition:极小多项式对应Jordan标准型的最大块}、\refthe{theorem:AX-XB相关命题3}、\refcor{corollary:AX-XB相关命题3}知除第一个,第二个和最后一个等价外,其余都是显然的.

$(9)\iff (3)$见\refthe{theorem:极小多项式等于特征多项式的充要条件}.
\begin{enumerate}[(1)]
