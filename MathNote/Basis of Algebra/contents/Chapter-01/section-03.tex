...
+\sum_{1\leqslant slant k\leqslant slant n-2}{\sum_{2\leqslant  j_1\leqslant  j_2\leqslant  \cdots\leqslant  j_k\leqslant  n}{\begin{array}{c}
...
\end{array}}}
\\
&\quad +\sum_{1\leqslant slant k\leqslant slant n-2}{\sum_{2\leqslant  j_1\leqslant  j_2\leqslant  \cdots\leqslant  j_k\leqslant  n}{\begin{array}{c}
\begin{array}{c@{}c@{}c@{}c@{}c@{}c@{}c@{}c@{}c@{}c@{}c@{}}
& 1 & \cdots & j_1 &\cdots &j_2 &\cdots &j_k &\cdots &n \\
\left.\right|
...
\end{example}
\begin{solution}
假设等式对$\forall n\leqslant  k-1,k\in \mathbb{N}_+$都成立.则当$n=k$时,将行列式$(a_1a_2,\cdots,a_k)$按第一列展开得
\begin{align*}
...
\end{matrix}\right|=\prod_{k = 1}^{n}(y - x_k)\prod_{1\leqslant slant i < j\leqslant slant n}(x_j - x_i).
\end{align*}
...
|\boldsymbol{B}|=(-1)^{n + 2}B_{n + 1,1}+\sum_{i = 2}^{n + 1}(-1)^{n + i + 1}B_{n + 1,i}y^{i - 2}(y - a)=\prod_{k = 1}^{n}(y - x_k)\prod_{1\leqslant slant i < j\leqslant slant n}(x_j - x_i).
\end{align}
...
\begin{align*}
(-1)^{n + 3}|\boldsymbol{A}|=(-1)^{n + 3}B_{n + 1,2}=\prod_{1\leqslant slant i < j\leqslant slant n}(x_j - x_i)\left(\sum_{i = 1}^{n}(-x_1)\cdots (-x_{i - 1})(-x_{i + 1})\cdots (-x_n)\right).
\end{align*}
于是\(|\boldsymbol{A}|=(-1)^{n + 3}(-1)^{n - 1}\prod_{1\leqslant slant i < j\leqslant slant n}(x_j - x_i)\left(\sum_{i = 1}^{n}x_1\cdots x_{i - 1}x_{i + 1}\cdots x_n\right)=\prod_{1\leqslant slant i < j\leqslant slant n}(x_j - x_i)\left(\sum_{i = 1}^{n}x_1\cdots x_{i - 1}x_{i + 1}\cdots x_n\right)\).
...
(-1)^{n + 2}B_{n + 1,1}-a(-1)^{n + 3}B_{n + 1,2}=\prod_{1\leqslant slant i < j\leqslant slant n}(x_j - x_i)\prod_{k = 1}^{n}(-x_k).
\end{align}
又因为
\begin{align*}
...
\end{matrix}\right|=\prod_{i = 1}^{n}(x_i - a)\prod_{1\leqslant slant i < j\leqslant slant n}(x_j - x_i).
\end{align*}
所以再结合等式\eqref{eq:等式1.2}可得
\begin{align*}
-a(-1)^{n + 3}|\boldsymbol{A}|&=-a(-1)^{n + 3}B_{n + 1,2}=\prod_{1\leqslant slant i < j\leqslant slant n}(x_j - x_i)\prod_{k = 1}^{n}(-x_k)-(-1)^{n + 2}B_{n + 1,1}
\\
&=(-1)^n\prod_{k = 1}^{n}x_k\prod_{1\leqslant slant i < j\leqslant slant n}(x_j - x_i)+(-1)^{n + 1}\prod_{i = 1}^{n}(x_i - a)\prod_{1\leqslant slant i < j\leqslant slant n}(x_j - x_i)
\\
&=(-1)^n\prod_{1\leqslant slant i < j\leqslant slant n}(x_j - x_i)\left[\prod_{k = 1}^{n}x_k-\prod_{i = 1}^{n}(x_i - a)\right].
\end{align*}
故此时\(|\boldsymbol{A}|=\prod_{1\leqslant slant i < j\leqslant slant n}(x_j - x_i)\left(\prod_{k = 1}^{n}x_k-\prod_{i = 1}^{n}(x_i - a)\right)\).
\end{solution}
...
1 & x & \cdots & x^{n - 1} & x^n
\end{matrix}\right|
= n!\prod_{1\leqslant slant i < j\leqslant slant n}(j - i)\prod_{k = 0}^{n}(x - k).
\end{align*}
因此
\begin{align*}
I &= \frac{G(n)}{n}=\frac{\int_{0}^{n}G'(x)\mathrm{d}x}{n}=(n - 1)!\prod_{1\leqslant slant i < j\leqslant slant n}(j - i)\int_{0}^{n}\prod_{k = 0}^{n}(x - k)\mathrm{d}x
\\
&\stackrel{\text{区间再现}}{=}(n - 1)!\prod_{1\leqslant slant i < j\leqslant slant n}(j - i)\int_{0}^{n}\prod_{k = 0}^{n}(n - k - x)\mathrm{d}x
\\
&= (-1)^{n + 1}(n - 1)!\prod_{1\leqslant slant i < j\leqslant slant n}(j - i)\int_{0}^{n}\prod_{k = 0}^{n}(x - k)\mathrm{d}x
\\
&= (-1)^{n + 1}I.
\end{align*}      
