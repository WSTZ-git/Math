...
+\sum_{1\leqslant k\leqslant n-2}{\sum_{2\leqslant  j_1\leqslant  j_2\leqslant  \cdots\leqslant  j_k\leqslant  n}{\begin{array}{c}
...
\end{array}}}
\\
&\quad +\sum_{1\leqslant k\leqslant n-2}{\sum_{2\leqslant  j_1\leqslant  j_2\leqslant  \cdots\leqslant  j_k\leqslant  n}{\begin{array}{c}
\begin{array}{c@{}c@{}c@{}c@{}c@{}c@{}c@{}c@{}c@{}c@{}c@{}}
& 1 & \cdots & j_1 &\cdots &j_2 &\cdots &j_k &\cdots &n \\
\left.\right|
...
\]
\[
A_{nn} = (-1)^{n + n} \prod_{\substack{j < i \\ i, j \in \{1, 2, \cdots, n - 1\}}} (a_i - a_j),
\]
所以
\[
