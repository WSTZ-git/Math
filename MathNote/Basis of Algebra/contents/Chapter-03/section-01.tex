...
\end{pmatrix}=ACB=O.
\end{align*}
于是由\hyperref[proposition:Sylvester不等式]{Sylvester不等式}得
\begin{align*}
\mathrm{r}( AC ) =\mathrm{r}( AC ) +\mathrm{r}( B ) -q\leqslant slant r( ACB ) =0\leqslant slant \mathrm{r}( AC ).
\end{align*}
故$\mathrm{r}( AC )=0$，因此$AC=O$。再由\hyperref[proposition:Sylvester不等式]{Sylvester不等式}得
\begin{align*}
\mathrm{r}( C ) =\mathrm{r}( A ) +\mathrm{r}( C ) -p\leqslant slant r( AC ) =0\leqslant slant \mathrm{r}( C ).
\end{align*}
