...
\end{align*}
故$\mathrm{r}( C )=0$，因此$C=O$，即$\{\boldsymbol{\alpha }_i\cdot \boldsymbol{\beta }_{j}^{\prime}\mid 1\leqslant i\leqslant p,1\leqslant j\leqslant q\}$线性无关.
\end{proof}
...
\end{align*}
从而 $\overline{x}_1A + \overline{x}_2B + \overline{x}_3C$ 为可逆矩阵.
\end{proof}
