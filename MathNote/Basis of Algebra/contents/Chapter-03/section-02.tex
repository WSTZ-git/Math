...
\begin{proposition}\label{proposition:命题31654668486}
$L\left( \alpha _1,\cdots ,\alpha _n,\beta _1,\cdots ,\beta _m \right) =L\left( \alpha _1,\cdots ,\alpha _n \right) +L\left( \beta _1,\cdots ,\beta _m \right) .$
\end{proposition}
\begin{proof}
证明是显然的.
\end{proof}

\begin{corollary}\label{corollary:推论rA,,B=dimImA+ImB}
$\mathrm{r}\left( A\,,\,B \right) =\mathrm{dim}\,\left( \mathrm{Im}A+\mathrm{Im}B \right) .$
\end{corollary}
\begin{proof}
将$A,B$看作其所有列向量构成的列向量组,然后利用\refpro{proposition:命题31654668486}立得.
\end{proof}

\begin{example}\label{example:一些常见线性空间的基}[$\,\,$一些常见线性空间的基]
\begin{enumerate}[(1)]
