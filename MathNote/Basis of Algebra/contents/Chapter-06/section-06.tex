...
\begin{align*}
\boldsymbol{A}=\left( \boldsymbol{k}_{\mathbf{1}}\boldsymbol{\alpha },\boldsymbol{k}_{\mathbb{2}}\boldsymbol{\alpha },\cdots ,\boldsymbol{k}_{\boldsymbol{n}}\boldsymbol{\alpha } \right)  .
\end{align*}
其中$\boldsymbol{k}_{\mathbf{1}},\boldsymbol{k}_{\mathbb{2}},\cdots ,\boldsymbol{k}_{\boldsymbol{n}}$为不全为零的实数.否则,$\boldsymbol{A}=\boldsymbol{O}$矛盾!于是令$\boldsymbol{\beta }=\left( \boldsymbol{k}_{\mathbf{1}},\boldsymbol{k}_{\mathbb{2}},\cdots ,\boldsymbol{k}_{\boldsymbol{n}} \right)'\ne \mathbb{0}$,则
\begin{align*}
