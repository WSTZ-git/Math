...
当 $\boldsymbol{\alpha}_i$ 是 $\boldsymbol{A}^k\boldsymbol{B}(0\leqslant slant k\leqslant slant n - 2)$ 的某一列向量时，则 $\boldsymbol{A}\boldsymbol{\alpha}_i$ 一定是 $\boldsymbol{A}^{k + 1}\boldsymbol{B}$ 的某一列向量，又由于 $1\leqslant slant k + 1\leqslant slant n - 1$，因此 $\boldsymbol{A}\boldsymbol{\alpha}_i$ 仍是 $(\boldsymbol{B},\boldsymbol{AB},\cdots,\boldsymbol{A}^{n - 2}\boldsymbol{B},\boldsymbol{A}^{n - 1}\boldsymbol{B})$ 的某一列向量，从而 $\boldsymbol{A}\boldsymbol{\alpha}_i$ 可由 $\boldsymbol{\alpha}_1,\cdots,\boldsymbol{\alpha}_r$ 线性表出.
