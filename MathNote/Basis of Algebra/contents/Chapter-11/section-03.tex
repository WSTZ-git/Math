...
\end{example}
\begin{proof}
由\refpro{proposition:有理数域上线性变换与向量组线性无关的命题}可知
...
1=\prod_{j=1}^n (1 + \lambda_j) = 1 + \sum_{j=1}^n \lambda_j + \sum_{1 \leqslant i < j \leqslant n} \lambda_i \lambda_j + \cdots + \lambda_1 \lambda_2 \cdots \lambda_n.
\end{align}
