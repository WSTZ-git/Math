...
\end{example}
\begin{proof}
由\hyperref[proposition:矩阵秩的基本公式-]{proposition:矩阵秩的基本公式}和\refpro{proposition:AA转置秩与A秩相等}可知
...
\end{align}
又\(r(A) = r(B)\)，故由\hyperref[proposition:矩阵秩的基本公式-]{proposition:矩阵秩的基本公式}知
\begin{align*}
