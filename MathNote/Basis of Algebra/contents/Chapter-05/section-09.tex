...
\end{align}
其中 $c_0(x_2, \cdots, x_m) \neq 0, d \geqslant  1$ 为次数。假设存在互异的多项式 $g_1(x_2, \cdots, x_m), \cdots, g_d(x_2, \cdots, x_m)$，使得当 $x_1 = g_i(x_2, \cdots, x_m) (1 \leqslant  i \leqslant  d)$ 时 $|A| = 0$，证明：
\begin{align*}
