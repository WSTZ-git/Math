...
\end{align}
令\(v(x)=f(x)q(x)+k(x)\)，则\(\mathrm{deg}\,v(x)<\mathrm{deg}\,f(x)\)。否则，若\(\mathrm{deg}\,v(x)\geqslant slant \mathrm{deg}\,f(x)\)，则由\eqref{corollary5.2-1.2}式可知
\begin{align}
f(x)u(x)+g(x)v(x)=1. \label{corollary5.2-1.3}  
\end{align}
从而由\(\mathrm{deg}\,v(x)\geqslant slant \mathrm{deg}\,f(x)\)及\(\mathrm{deg}\,u(x)<\mathrm{deg}\,g(x)\)可得
\[
