...
\[
|g(z)| \leq \frac{1}{r} \, (\text{当} \ |z| < r \ \text{时}).
\]
让 \( r \to 1 \)，即得 \( |g(z)| \leq 1 \)（\( z \in B(0,1) \)），即 \( |f(z)| \leq |z| \)，结论(i)成立。
...
\begin{align}
|g'(0)| \leq 1.\label{eq::::1--1---1-1-1-1}
\end{align}
由于 \( g^{-1} \in \text{Aut}(B(0,1)) \)，且 \( g^{-1}(0) = 0 \)，故对 \( g^{-1} \) 用\hyperref[theorem:Schwarz引理-定理4.5.3]{Schwarz引理}，得 \( |(g^{-1})'(0)| \leq 1 \)。但由\refthe{theorem:定理4.4.9}，有
\[
|(g^{-1})'(0)| = \frac{1}{|g'(0)|},
\]
由此即得
...
\begin{align}
|\varphi_b \circ f \circ \varphi_a(\zeta)| \leq |\zeta|, \, \zeta \in B(0,1) \label{eq::::--2-2-2-2-2}
\end{align}
和
\begin{align}
|(\varphi_b \circ f \circ \varphi_a)'(0)| \leq 1. \label{eq::::--2-2-2-2-3}
\end{align}
令 \( z = \varphi_a(\zeta) \)，则 \( \zeta = \varphi_a(z) \)，于是 \(\eqref{eq::::--2-2-2-2-2}\) 式变成
\begin{align}
|\varphi_b(f(z))| \leq |\varphi_a(z)|. \label{eq::::--2-2-2-2-4}
\end{align}
这就是(i)。
...
\begin{align}
|f'(a)| \leq \frac{1 - |b|^2}{1 - |a|^2}. \label{eq::::--2-2-2-2-5}
\end{align}
这就是(ii)。
