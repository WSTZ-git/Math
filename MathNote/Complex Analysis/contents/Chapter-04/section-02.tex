...
\begin{align}
\sum_{n=1}^{\infty} \frac{\mathrm{e}^{\mathrm{i}n\theta}}{n} = -\ln(1 - \mathrm{e}^{\mathrm{i}\theta}) = -\ln|1 - \mathrm{e}^{\mathrm{i}\theta}| - \mathrm{i}\arg(1 - \mathrm{e}^{\mathrm{i}\theta}). \label{eq:2-=------2}
\end{align}
