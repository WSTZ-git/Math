...
设\(z\)和\(w\)是两个复数，那么
\begin{enumerate}[(i)]
\item \(\mathrm{Re}z = \frac{1}{2}(z + \overline{z})\)，\(\quad \mathrm{Im}z = \frac{1}{2\mathrm{i}}(z - \overline{z})\)；

\item \(z\overline{z} = |z|^2\),\(\quad \overline{z} = \frac{|z|^2}{z}\);

\item \(\overline{z + w} = \overline{z} + \overline{w}\)，\(\quad \overline{zw} = \overline{z}\,\overline{w}\)；

\item\(|z| = |\overline{z}|\),$\quad |z|=|-z|$.
\end{enumerate}
\end{proposition}
\begin{proof}
\begin{enumerate}[(i)]
