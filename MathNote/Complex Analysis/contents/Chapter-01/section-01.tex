...
\begin{align*}
\alpha =k\beta \quad \text{或} \quad \beta =k\alpha
&\Longleftrightarrow z_i=k\overline{w_i}\left( i=1,2,\cdots ,n \right) \quad \text{或} \quad \overline{w_i}=kz_i\left( i=1,2,\cdots ,n \right) .
\end{align*}
