...
\item 设$z_1,z_2\in \mathbb{C}$且$z_1 \neq z_2$,证明:
\begin{enumerate}[(i)]
...
\begin{align*}
\frac{z_1-z_2}{w_1-w_2}=\frac{z_1-z_3}{w_1-w_3}=\frac{z_2-z_3}{w_2-w_3}
\Longleftrightarrow \left( z_1-z_2 \right) \left( w_2-w_3 \right) =\left( z_2-z_3 \right) \left( w_1-w_2 \right) \text{且}\left( z_1-z_3 \right) \left( w_2-w_3 \right) =\left( z_2-z_3 \right) \left( w_1-w_3 \right).
\end{align*}
又
\begin{gather*}
\left| \begin{matrix}
...
z_1-z_2&		w_1-w_2\\
z_2-z_3&		w_2-w_3\\
\end{matrix} \right|=\left( z_1-z_2 \right) \left( w_2-w_3 \right) -\left( z_2-z_3 \right) \left( w_1-w_2 \right) .
\end{gather*}
故
\begin{align*}
\left| \begin{matrix}
...
z_2& w_2& 1\\
z_3& w_3& 1\\
\end{matrix} \right|=0&\Longleftrightarrow \left( z_1-z_2 \right) \left( w_2-w_3 \right) =\left( z_2-z_3 \right) \left( w_1-w_2 \right) \text{且}\left( z_1-z_3 \right) \left( w_2-w_3 \right) =\left( z_2-z_3 \right) \left( w_1-w_3 \right).
\end{align*}
因此结论得证.
...
\item 从\reffig{figure:图1.4}可以看出，\(z_1, z_2, z_3, z_4\)四点共圆的充要条件是向量\(z_1 - z_3\)和\(z_1 - z_4\)的夹角等于向量\(z_2 - z_3\)和\(z_2 - z_4\)的夹角或互补（当\(z_2\)在\(z_3\)与\(z_4\)之间时），此时由\nrefpro{proposition:复平面向量垂直与平行的充要条件}{(2)}立得.即
\[
\begin{split}
