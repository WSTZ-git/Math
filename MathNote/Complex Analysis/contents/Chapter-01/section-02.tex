...
\begin{proposition}\label{proposition:复数的几何性质结论}
\begin{enumerate}[(1)]
\item\label{proposition:复数的几何性质结论-1} $z_1,z_2\in \mathbb{C}$,则
\begin{enumerate}[(i)]
\item $z_1\bot z_2 \iff z_1\overline{z_2}+\overline{z_1}z_2=0 \iff \mathrm{Re}(z_1\bar{z}_2) = 0$.

\item \(z_1\varparallel z_2\iff \iff z_1\overline{z_2}-\overline{z_1}z_2=0 \iff \mathrm{Im}(z_1\bar{z}_2) = 0\).
\end{enumerate}
...
\end{cases}\Longleftrightarrow \frac{z_1-z_3}{w_1-w_3}=\frac{z_2-z_3}{w_2-w_3}
\\
