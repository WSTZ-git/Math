...
\begin{definition}
设 $E$ 是复平面上一点集，如果对每一个 $z \in E$，按照某一规则有一确定的复数 $w$ 与之对应，我们就说在 $E$ 上确定了一个\textbf{单值复变函数}，记为 $w = f(z)$ 或 $f: E \to \mathbb{C}$。$E$ 称为 $f$ 的\textbf{定义域}，点集 $\{ f(z): z \in E\}$ 称为 $f$ 的\textbf{值域}。
