...
\]
为此，取 \( 0 < \varepsilon < r \)，使得 \( B(a,\varepsilon) \subset B(a,r) \subset D \)。根据\reflem{引理3.7.2}，存在 \( \varphi \in C^\infty(\mathbb{C}) \)，使得当 \( z \in B(a,\varepsilon) \) 时，\( \varphi(z) \equiv 1 \)；而当 \( z \notin B(a,r) \) 时，\( \varphi(z) \equiv 0 \)。记
\[
