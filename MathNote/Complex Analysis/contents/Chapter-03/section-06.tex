...
注意
\begin{align*}
\int_{\partial B_\eta} \frac{f(\zeta)}{\zeta - z} d\zeta = \int_{\partial B_\eta} \frac{f(\zeta) - f(z)}{\zeta - z} d\zeta + f(z) \int_{\partial B_\eta} \frac{d\zeta}{\zeta - z} \xlongequal{\text{\refpro{proposition:例3.1.4}}} \int_{\partial B_\eta} \frac{f(\zeta) - f(z)}{\zeta - z} d\zeta + 2\pi i f(z),
\end{align*}
而
\begin{align*}
