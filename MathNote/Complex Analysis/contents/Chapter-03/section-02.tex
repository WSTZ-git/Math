...
\end{theorem}
\begin{proof}  
由 \( \gamma \) 围成的区域记为 \( G \)，因为 \( f' \) 连续，即 \( \frac{\partial u}{\partial x}, \frac{\partial v}{\partial x}, \frac{\partial u}{\partial y}, \frac{\partial v}{\partial y} \) 连续，故可用 \hyperref[Basis Analytics-theorem:实变函数中的Green公式]{Green公式}. 又因 \( f \) 在 \( D \) 中全纯，故由\refthe{theorem:复变函数可微的充要条件2}可知 Cauchy-Riemann 方程成立. 于是由\hyperref[Basis Analytics-theorem:实变函数中的Green公式]{Green公式}可得
\[
