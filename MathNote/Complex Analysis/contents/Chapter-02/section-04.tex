...
\begin{align*}
f(z_2) = |f(z_2)| \mathrm{e}^{\mathrm{i}\Delta_C \mathrm{Arg} f(z)} \cdot \mathrm{e}^{\mathrm{i}(\mathrm{Arg} f(z_1)+2k\pi)},\ k=0,\pm 1,\cdots,
\end{align*}
...
&= |f(z_2)| \mathrm{e}^{\mathrm{i}\Delta_C \mathrm{Arg} f(z)} \cdot \mathrm{e}^{\mathrm{i}\left( \mathrm{Arg} f(z_1) + 2k\pi \right)}.
\end{align*}
再记$k = k_1 - k_0$,则
\begin{align*}
f(z_2) &= |f(z_2)| \mathrm{e}^{\mathrm{i}\Delta_C \mathrm{Arg} f(z)} \cdot \mathrm{e}^{\mathrm{i}\left( \mathrm{Arg} f(z_1) + 2k\pi \right)}, \quad k = 0, \pm 1, \cdots.
\end{align*}
