...
\end{matrix} \right|-\left( x_1-1 \right) \left( x_2-1 \right) \cdots \left( x_n-1 \right) \prod_{1\leqslant i<j\leqslant n}{\left( x_j-x_i \right)}
\\
&=2x_1x_2\cdots x_n\prod_{1\leqslant i<j\leqslant n}{\left( x_j-x_i \right)}-\left( x_1-1 \right) \left( x_2-1 \right) \cdots \left( x_n-1 \right) \prod_{1\leqslant i<j\leqslant n}{\left( x_j-x_i \right)}
\\
&=\left[ 2x_1x_2\cdots x_n-\left( x_1-1 \right) \left( x_2-1 \right) \cdots \left( x_n-1 \right) \right] \prod_{1\leqslant i<j\leqslant n}{\left( x_j-x_i \right)}.
\end{align*}
...
求下列$n$阶行列式的值($1\leqslant i\leqslant n-1$):
\begin{align*}
|\boldsymbol{A}|=\left| \begin{matrix}
