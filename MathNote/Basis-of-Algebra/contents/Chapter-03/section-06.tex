...
\item \label{矩阵秩的基本公式2}\(\mathrm{r}(\boldsymbol{A}\boldsymbol{B})\leqslant \min\{\mathrm{r}(\boldsymbol{A}),\mathrm{r}(\boldsymbol{B})\}\leqslant \mathrm{r}(\boldsymbol{A}),\mathrm{r}(\boldsymbol{B})\)；
...
\item \label{矩阵秩的基本公式5}\(|\mathrm{r}(\boldsymbol{A})-\mathrm{r}(\boldsymbol{B})|\leqslant \mathrm{r}\left( \boldsymbol{A}\pm \boldsymbol{B} \right) \leqslant \mathrm{r}\left( \begin{array}{c}
\boldsymbol{A}\\
\boldsymbol{B}\\
