...
\end{note}
\begin{proof}
我们只须证明$\mathbb{Z}_n $是一个循环群即可,也即$\mathbb{Z}_n = \langle 1 + n\mathbb{Z} \rangle$。任取$A\in \mathbb{Z}_n$,则由\refpro{proposition:枚举Z_n的所有元素}可知,$A=k+n\mathbb{Z}$,其中$0\leqslant  k\leqslant  n-1$.又由\refpro{proposition:nZ是Z的正规子群}可知$(n\mathbb{Z},+)\lhd (\mathbb{Z},+)$.从而
\begin{align*}
