...
\end{align*}
称$i$为 \( A_0 \) 到 \( A \) 中的\textbf{自然嵌入映射}. 显然,自然嵌入映射是单射.
...
\item\label{proposition:映射的基本性质-2} $f\left(\bigcup_{\alpha \in I} A_{\alpha}\right) = \bigcup_{\alpha \in I} f(A_{\alpha})$;$f^{-1}\left(\bigcup_{\alpha \in I} B_{\alpha}\right) = \bigcup_{\alpha \in I} f^{-1}(B_{\alpha})$.
