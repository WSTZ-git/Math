...
\end{align*}
则称$\mathscr{R}$为$X$上的一个\textbf{环}.特别地,如果还有$X \in \mathscr{R}$,就称$\mathscr{R}$为$X$上的一个\textbf{代数},或称为\textbf{域}.
...
\begin{proposition}\label{proposition:集合论--1.3-例题22}
设$X$为集合，$\mathscr{E}$为$X$上的集类. 证明：
\begin{enumerate}[(1)]
\item $\mathscr{A}(\mathscr{E})=\{E,X\setminus E\mid E\in\mathscr{R}(\mathscr{E})\}$.
\item $\mathscr{A}_\sigma(\mathscr{E})=\{E,X\setminus E\mid E\in\mathscr{R}_\sigma(\mathscr{E})\}$.
\end{enumerate}
\end{proposition}
\begin{proof}\begin{enumerate}[(1)]
\item 设$E\in\mathscr{R}(\mathscr{E})\subseteq\mathscr{A}(\mathscr{E})$,因$X\in\mathscr{A}(\mathscr{E})$,故$X\setminus E\in\mathscr{A}(\mathscr{E})$.于是
\begin{align*}
\{E,X\setminus E\mid E\in\mathscr{R}(\mathscr{E})\}\subseteq\mathscr{A}(\mathscr{E}).
\end{align*}
反之,下证$\{E,X\setminus E\mid E\in\mathscr{R}(\mathscr{E})\}$为含$\mathscr{E}$的代数,而$\mathscr{A}(\mathscr{E})$为含$\mathscr{E}$的最小代数.因此
\begin{align*}
\mathscr{A}(\mathscr{E})\subseteq\{E,X\setminus E\mid E\in\mathscr{R}(\mathscr{E})\}.
\end{align*}
综合上述,有
\begin{align*}
\mathscr{A}(\mathscr{E})=\{E,X\setminus E\mid E\in\mathscr{R}(\mathscr{E})\}.
\end{align*}
剩下的欲证$\{E,X\setminus E\mid E\in\mathscr{R}(\mathscr{E})\}$为含$\mathscr{E}$的代数.含$\mathscr{E}$是显然的,而$X=X\setminus\varnothing\in\{E,X\setminus E\mid E\in\mathscr{R}(\mathscr{E})\}$,故只需证$\{E,X\setminus E\mid E\in\mathscr{R}(\mathscr{E})\}$为一个环.事实上,对于$\forall A,B\in\mathscr{R}(\mathscr{E})$,由\refthe{theorem:集合论定理1.3..948h3}有
\begin{gather*}
A\cup B,A\setminus B\in\mathscr{R}(\mathscr{E})\subseteq\{E,X\setminus E\mid E\in\mathscr{R}(\mathscr{E})\}, \\
(X\setminus A)\cup(X\setminus B)=X\setminus A\cap B\in\{E,X\setminus E\mid E\in\mathscr{R}(\mathscr{E})\}, \\
(X\setminus A)\setminus(X\setminus B)=B\setminus A\in\mathscr{R}(\mathscr{E})\subseteq\{E,X\setminus E\mid E\in\mathscr{R}(\mathscr{E})\}, \\
(X\setminus B)\cup A=X\setminus(B\setminus A)\in\{E,X\setminus E\mid E\in\mathscr{R}(\mathscr{E})\}, \\
(X\setminus B)\setminus A=X\setminus(A\cup B)\in\{E,X\setminus E\mid E\in\mathscr{R}(\mathscr{E})\}, \\
A\setminus(X\setminus B)=A\cap B\in\mathscr{R}(\mathscr{E})\subseteq\{E,X\setminus E\mid E\in\mathscr{R}(\mathscr{E})\}.
\end{gather*}
这就证明了$\{E,X\setminus E\mid E\in\mathscr{R}(\mathscr{E})\}$为一个环.

\item 设$E\in\mathscr{R}_\sigma(\mathscr{E})\subseteq\mathscr{A}_\sigma(\mathscr{E})$,因$X\in\mathscr{A}_\sigma(\mathscr{E})$,故$X\setminus E\in\mathscr{A}_\sigma(\mathscr{E})$.于是
\begin{align*}
\{E,X\setminus E\mid E\in\mathscr{R}_\sigma(\mathscr{E})\}\subseteq\mathscr{A}_\sigma(\mathscr{E}).
\end{align*}
反之,下证$\{E,X\setminus E\mid E\in\mathscr{R}_\sigma(\mathscr{E})\}$为含$\mathscr{E}$的$\sigma$代数,而$\mathscr{A}_\sigma(\mathscr{E})$为含$\mathscr{E}$的最小$\sigma$代数.因此
\begin{align*}
\mathscr{A}_\sigma(\mathscr{E})\subseteq\{E,X\setminus E\mid E\in\mathscr{R}_\sigma(\mathscr{E})\}.
\end{align*}
综合上述,有
\begin{align*}
\mathscr{A}_\sigma(\mathscr{E})=\{E,X\setminus E\mid E\in\mathscr{R}_\sigma(\mathscr{E})\}.
\end{align*}
剩下的欲证$\{E,X\setminus E\mid E\in\mathscr{R}_\sigma(\mathscr{E})\}$为含$\mathscr{E}$的代数.含$\mathscr{E}$是显然的,而$X=X\setminus\varnothing\in\{E,X\setminus E\mid E\in\mathscr{R}_\sigma(\mathscr{E})\}$,故只需证$\{E,X\setminus E\mid E\in\mathscr{R}_\sigma(\mathscr{E})\}$为一个$\sigma$环.事实上,对于$\forall A,B,A_n,B_n(n\in\mathbb{N})\in\mathscr{R}_\sigma(\mathscr{E})$,有
\begin{gather*}
\bigcup_{n=1}^{\infty}A_n,A\setminus B\in\mathscr{R}_\sigma(\mathscr{E})\subseteq\{E,X\setminus E\mid E\in\mathscr{R}_\sigma(\mathscr{E})\}, \\
\bigcup_{n=1}^{\infty}{(X}\setminus A_n)\xlongequal{\mathrm{De} \text{Morgan公式}}X\setminus \bigcap_{n=1}^{\infty}{A_n}\in \{E,X\setminus E\mid E\in \mathscr{R} _{\sigma}(\mathscr{E} )\},\\
\left(\bigcup_{n=1}^{\infty}(X\setminus A_n)\right)\cup\left(\bigcup_{n=1}^{\infty}B_n\right)=\left(X\setminus\bigcap_{n=1}^{\infty}A_n\right)\cup\left(\bigcup_{n=1}^{\infty}B_n\right) \\
=X\setminus\left(\bigcap_{n=1}^{\infty}A_n\setminus\bigcup_{n=1}^{\infty}B_n\right)\in\{E,X\setminus E\mid E\in\mathscr{R}_\sigma(\mathscr{E})\}, \\
(X\setminus A)\setminus(X\setminus B)=B\setminus A\in\mathscr{R}_\sigma(\mathscr{E})\subseteq\{E,X\setminus E\mid E\in\mathscr{R}_\sigma(\mathscr{E})\}, \\
(X\setminus B)\setminus A=X\setminus(A\cup B)\in\{E,X\setminus E\mid E\in\mathscr{R}_\sigma(\mathscr{E})\}, \\
A\setminus(X\setminus B)=A\cap B\in\mathscr{R}(\mathscr{E})\subseteq\{E,X\setminus E\mid E\in\mathscr{R}_\sigma(\mathscr{E})\}.
\end{gather*}
这就证明了$\{E,X\setminus E\mid E\in\mathscr{R}_\sigma(\mathscr{E})\}$为一个$\sigma$环.
\end{enumerate}

\end{proof}

\begin{example}
设$X$为集合，$\mathscr{E}$为$X$上的非空集类. 在下列各种情况下分别求出$\mathscr{R}(\mathscr{E}),\mathscr{A}(\mathscr{E})$：
\begin{enumerate}[(1)]
\item $\mathscr{E}=\{E_1,E_2,\cdots,E_n\}$.
\item $X=\mathbb{R}^1$(实数直线)，$\mathscr{E}=\{(a,b)\mid -\infty<a<b<+\infty\}$.
\item $X=\mathbb{R}^1$，$\mathscr{E}=\{(-\infty,a)\mid a\in\mathbb{R}\}$.
\end{enumerate}
\end{example}
\begin{solution}\begin{enumerate}[(1)]
\item $\mathscr{R}(\mathscr{E})=\{$由$E_1,E_2,\cdots,E_n$中若干元素通过“$\cup$”，“$\setminus$”的有限次运算得到的集合$\}$.
\begin{align*}
\mathscr{A} (\mathscr{E} )&=\left\{ E_1,E_2,\cdots ,E_n\text{以及}X\text{中若干元素通过}“\cup ”,“\backslash ”\text{的有限次运算得到的集合} \right\} 
\\
&\xlongequal{\text{\refpro{proposition:集合论--1.3-例题22}}}\left\{ e,X\backslash E\mid E\in \mathscr{R} (\mathscr{E} ) \right\} 
\end{align*}

\item 由$\mathscr{R}(\mathscr{E})$的定义知，$\mathscr{E}\subseteq\mathscr{R}(\mathscr{E})$. 进而，当$a<c<b<d$时，有
\begin{align*}
(a,b)\setminus(c,d)=(a,c]\in\mathscr{R}(\mathscr{E}), \\
(c,d)\setminus(a,b)=[b,d)\in\mathscr{R}(\mathscr{E}).
\end{align*}
当$a<c<b$时，有
\begin{align*}
(a,c]\cap[c,b)=\{c\}\in\mathscr{R}(\mathscr{E}).
\end{align*}
于是，猜测并验证得到
\begin{align*}
\mathscr{R} \left( \mathscr{E} \right) &=\left\{ \text{有限个开区间与有限个点的并集} \right\} \\
&=\left\{ \text{有限个(开},\text{半开半闭},\text{半闭半开},\text{闭)区间与有限个点的并集} \right\} ,
\end{align*}
\begin{gather*}
\mathscr{A} (\mathscr{E} )\xlongequal{\text{\refpro{proposition:集合论--1.3-例题22}}}\{E,X\setminus E\mid E\in \mathscr{R} (\mathscr{E} )\}=\left\{ E,X\setminus E\mid E\text{为有限个开区间与有限个点的并集} \right\} .
\end{gather*}

\item 由$\mathscr{R}(\mathscr{E})$的定义知，$\mathscr{E}\subseteq\mathscr{R}(\mathscr{E})$. 进而，当$a<c<b<d$时，有
\begin{align*}
(-\infty,b)\setminus(-\infty,a)=[a,b)\in\mathscr{R}(\mathscr{E}), \\
(a,b)\setminus(c,d)=(a,c]\in\mathscr{R}(\mathscr{E}), \\
(c,d)\setminus(a,b)=[b,d)\in\mathscr{R}(\mathscr{E}),
\end{align*}
当$a<c<b$时，有
...
于是，猜测并验证得到
\begin{align*}
\mathscr{R} \left( \mathscr{E} \right) &=\left\{ \left( -\infty ,a \right) \text{与有限个开区间以及有限个点的并集} \right\} \\
&=\left\{ \left( -\infty ,a \right) \text{与有限个(开},\text{半开半闭},\text{半闭半开},\text{闭)区间以及有限个点的并集} \right\} ,
\end{align*}
\begin{gather*}
\mathscr{A} (\mathscr{E} )\xlongequal{\text{\refpro{proposition:集合论--1.3-例题22}}}\{E,X\setminus E\mid E\in \mathscr{R} (\mathscr{E} )\}=\left\{ E,X\setminus E\mid E\text{为}\left( -\infty ,a \right) \text{与有限个开区间以及有限个点的并集} \right\} .
\end{gather*}
\end{enumerate}
...
\begin{example}
设$\mathscr{E}=\{(a,b)\mid -\infty<a<b<+\infty\}$，$\mathscr{R}_0=\left\{\bigcup_{i=1}^{n}(a_i,b_i]\mid -\infty<a_i<b_i<+\infty,\,n\in\mathbb{N}\right\}$为$\mathbb{R}^1$上的两个集类. 证明：分别由$\mathscr{E}$与$\mathscr{R}_0$张成的$\sigma$环是一致的，并且
\begin{align*}
\mathscr{R}_\sigma(\mathscr{E})=\mathscr{R}_\sigma(\mathscr{R}_0)=\mathscr{B},
\end{align*}
其中$\mathscr{B}$为Borel集类，即$\mathscr{B}=\mathscr{A}_\sigma(\mathscr{T}_0)$，它是由$\mathbb{R}^1$的所有开集族$\mathscr{T}_0$所生成的$\sigma$代数.
\end{example}
\begin{proof}
取$a_1=a$，
\begin{align*}
a_2&=a+\frac{1}{2}(b-a), \\
a_3&=a+\left(\frac{1}{2}+\frac{1}{2^2}\right)(b-a), \\
&\cdots \\
a_i&=a+\left(\frac{1}{2}+\frac{1}{2^2}+\cdots+\frac{1}{2^{i-1}}\right)(b-a), \\
&\cdots
\end{align*}
则
\begin{align*}
(a,b)=\bigcup_{i=1}^{\infty}(a_i,a_{i+1}]\in\mathscr{R}_\sigma(\mathscr{R}_0),\quad \mathscr{E}\subseteq\mathscr{R}_\sigma(\mathscr{R}_0).
\end{align*}
这就证明了$\mathscr{R}_\sigma(\mathscr{R}_0)$为含$\mathscr{E}$的$\sigma$环. 而$\mathscr{R}_\sigma(\mathscr{E})$为含$\mathscr{E}$的最小$\sigma$环，故
\begin{align*}
\mathscr{R}_\sigma(\mathscr{E})\subseteq\mathscr{R}_\sigma(\mathscr{R}_0).
\end{align*}
另一方面，由于$(a,b]=\bigcap_{n=1}^{\infty}\left(a,b+\frac{1}{n}\right)\in\mathscr{R}_\sigma(\mathscr{E})$，$\mathscr{R}_0\subseteq\mathscr{R}_\sigma(\mathscr{E})$. 这就证明了$\mathscr{R}_\sigma(\mathscr{E})$为含$\mathscr{R}_0$的$\sigma$环. 而$\mathscr{R}_\sigma(\mathscr{R}_0)$为含$\mathscr{R}_0$的最小$\sigma$环，故
\begin{align*}
\mathscr{R}_\sigma(\mathscr{E})\supseteq\mathscr{R}_\sigma(\mathscr{R}_0).
\end{align*}
综合上述得到
\begin{align*}
\mathscr{R}_\sigma(\mathscr{E})=\mathscr{R}_\sigma(\mathscr{R}_0).
\end{align*}
因为$X=\mathbb{R}^1=\bigcup_{n=1}^{\infty}(-n,n)\in\mathscr{R}_\sigma(\mathscr{E})$，故$\mathscr{R}_\sigma(\mathscr{E})$为含$\mathscr{E}$的$\sigma$代数，而$\mathscr{T}_0$的每个元素（即$\mathbb{R}^1$中的开集），根据\hyperref[theorem:开集构造定理-1]{开集构造定理\ref{theorem:开集构造定理-1}}，它为$\mathscr{E}$中至多可数个两两不相交的元素的并. 因此，$\mathscr{T}_0\subseteq\mathscr{R}_\sigma(\mathscr{E})$. 又因为$\mathscr{B}=\mathscr{A}_\sigma(\mathscr{T}_0)$为含$\mathscr{T}_0$的最小$\sigma$代数，故
\begin{align*}
\mathscr{B}=\mathscr{A}_\sigma(\mathscr{T}_0)\subseteq\mathscr{R}_\sigma(\mathscr{E}).
\end{align*}
反之，因为$\mathscr{E}\subseteq\mathscr{T}_0\subseteq\mathscr{A}_\sigma(\mathscr{T}_0)$，而$\mathscr{R}_\sigma(\mathscr{E})$为含$\mathscr{E}$的最小$\sigma$环，故
\begin{align*}
\mathscr{R}_\sigma(\mathscr{E})\subseteq\mathscr{A}_\sigma(\mathscr{T}_0)=\mathscr{B}.
\end{align*}
综合上述得到
\begin{align*}
\mathscr{R}_\sigma(\mathscr{R}_0)=\mathscr{R}_\sigma(\mathscr{E})=\mathscr{A}_\sigma(\mathscr{T}_0)=\mathscr{B}.
\end{align*}

\end{proof}

\begin{proposition}
设$\mathscr{R}$为集合$X$上的一个非空集类. 证明：
\begin{enumerate}[(1)]
\item 以下三个结论等价:
\begin{enumerate}[(i)]
\item $\mathscr{R}$为一个环;

\item $\mathscr{R}$对“$\setminus$”运算和任意有限个互不相交集的“$\cup$”运算封闭;

\item $\mathscr{R}$对“$\setminus$”、“$\Delta$”、“$\cap$”运算封闭.
\end{enumerate}

\item $\mathscr{R}$为代数$\Leftrightarrow\mathscr{R}$对“$\cup$”、“$\cap$”、“余”运算封闭.
\end{enumerate}
\end{proposition}
\begin{proof}\begin{enumerate}[(1)]
\item (i)$\Rightarrow$(iii)由环的定义知，环$\mathscr{R}$对“$\setminus$”运算封闭.

进而，对$\forall E,F\in\mathscr{R}$，$E\setminus F\in\mathscr{R}$，$F\setminus E\in\mathscr{R}$，从而
\begin{align*}
E\Delta F=(E\setminus F)\cup(F\setminus E)\in\mathscr{R},
\end{align*}
即$\mathscr{R}$对“$\Delta$”运算封闭. 此外，由
\begin{align*}
E\cap F=(E\cup F)\setminus(E\Delta F)\in\mathscr{R}
\end{align*}
推得$\mathscr{R}$对“$\cap$”运算封闭. 这就证明了(iii)成立.

(i)$\Leftarrow$(iii)设$\mathscr{R}$对“$\setminus$”、“$\Delta$”、“$\cap$”运算封闭. 于是，对$\forall E,F\in\mathscr{R}$，有
\begin{align*}
E\Delta F=(E\setminus F)\cup(F\setminus E)\in\mathscr{R},\quad E\cap F\in\mathscr{R}, 
\end{align*}
\begin{align*}
E\cup F&=(E\Delta F)\cup(E\cap F) \\
&=(E\Delta F\setminus E\cap F)\cup(E\cap F\setminus E\Delta F) \\
&=(E\Delta F)\Delta(E\cap F)\in\mathscr{R},
\end{align*}
故$\mathscr{R}$对“$\cup$”运算封闭. 这就证明了$\mathscr{R}$为一个环，即(1)成立.

(i)$\Rightarrow$(ii)因为$\mathscr{R}$为一个环，故$\mathscr{R}$对“$\setminus$”运算和“$\cup$”运算封闭. 再由归纳法立知，$\mathscr{R}$对其任意有限个集($\mathscr{R}$的元素)的“$\cup$”运算封闭.

(i)$\Leftarrow$(ii)设(ii)成立，则对$\forall E,F\in\mathscr{R}$，有
\begin{align*}
E\setminus F\in\mathscr{R},\quad F\setminus E\in\mathscr{R}, \\
E\cap F=E\setminus(E\setminus F)\in\mathscr{R}.
\end{align*}
于是，根据(ii)中$\mathscr{R}$对任意有限个互不相交集的“$\cup$”运算的封闭性，有
\begin{align*}
E\cup F=(E\setminus F)\cup(F\setminus E)\cup(E\cap F)\in\mathscr{R}.
\end{align*}
这就证明了$\mathscr{R}$对“$\cup$”运算封闭. 因此，$\mathscr{R}$为一个环，即(i)成立.

\item $(\Rightarrow)$设$\mathscr{R}$为代数，则$X\in\mathscr{R}$，且$\mathscr{R}$对“$\setminus$”、“$\cup$”运算封闭. 于是，对$\forall E,F\in\mathscr{R}$，有
\begin{align*}
E^c=X\setminus E\in\mathscr{R}, \\
E\cap F=(E\cup F)\setminus(E\setminus F)\setminus(F\setminus E)\in\mathscr{R}.
\end{align*}
这就证明了$\mathscr{R}$对“$\cup$”、“$\cap$”、“余”运算封闭.

$(\Leftarrow)$设$\mathscr{R}$对“$\cup$”、“$\cap$”、“余”运算封闭. 因为$\mathscr{R}$为集合$X$上的非空集类，故$\exists E\in\mathscr{R}$. 于是，$E^c=X\setminus E\in\mathscr{R}$，$X=E\cup(X\setminus E)\in\mathscr{R}$. 进而，对$\forall E,F\in\mathscr{R}$，有
\begin{align*}
F^c\in\mathscr{R},\quad E\setminus F=E\cap F^c\in\mathscr{R}.
\end{align*}
这就证明了$\mathscr{R}$对“$\cup$”和“$\setminus$”运算封闭，即$\mathscr{R}$为一个环. 又因$X\in\mathscr{R}$，故$\mathscr{R}$为代数.
\end{enumerate}
\end{proof}

\begin{proposition}\label{proposition:集合论命题j8oj82r339008jr}
设$X$为集合，$A\subseteq X$. $\mathscr{R}$为$X$上某些子集所成的环. 记
\[
\mathscr{R}\cap A=\{E\cap A\mid E\in\mathscr{R}\}, \quad \mathscr{R}_\sigma(\mathscr{R})\cap A=\{E\cap A\mid E\in\mathscr{R}_\sigma(\mathscr{R})\}.
\]
证明：
\begin{enumerate}[(1)]
\item\label{proposition:集合论命题j8oj82r339008jr-1} $\mathscr{R}\cap A$为$A$上的一个环.
\item\label{proposition:集合论命题j8oj82r339008jr-2} $\mathscr{R}_\sigma(\mathscr{R})\cap A$为$A$上的一个$\sigma$环.
\item\label{proposition:集合论命题j8oj82r339008jr-3} $\mathscr{R}_\sigma(\mathscr{R})\cap A=\mathscr{R}_\sigma(\mathscr{R}\cap A)$.
\item\label{proposition:集合论命题j8oj82r339008jr-4} 当$\mathscr{R}$为代数或$A\in\mathscr{R}$时，$\mathscr{R}_\sigma(\mathscr{R})\cap A$为$A$上的$\sigma$代数.
\end{enumerate}
\end{proposition}
\begin{proof}\begin{enumerate}[(1)]
\item 对$\forall E\cap A\in\mathscr{R}\cap A$，$F\cap A\in\mathscr{R}\cap A$，有$E\in\mathscr{R}$，$F\in\mathscr{R}$，故$E\cup F\in\mathscr{R}$，$E\setminus F\in\mathscr{R}$，且
\begin{align*}
(E\cap A)\cup(F\cap A)=(E\cup F)\cap A\in\mathscr{R}\cap A, \\
(E\cap A)\setminus(F\cap A)=(E\setminus F)\cap A\in\mathscr{R}\cap A.
\end{align*}
这就证明了$\mathscr{R}\cap A$为$A$上的一个环.

\item 对$\forall E\cap A\in\mathscr{R}_\sigma(\mathscr{R})\cap A$，$F\cap A\in\mathscr{R}_\sigma(\mathscr{R})\cap A$，$E_n\cap A\in\mathscr{R}_\sigma(\mathscr{R})\cap A$，$n\in\mathbb{N}$，有$E\in\mathscr{R}_\sigma(\mathscr{R})$，$F\in\mathscr{R}_\sigma(\mathscr{R})$，$E_n\in\mathscr{R}_\sigma(\mathscr{R})$，$n\in\mathbb{N}$，且$\bigcup_{n=1}^{\infty}E_n\in\mathscr{R}_\sigma(\mathscr{R})$. 于是
\begin{align*}
(E\cap A)\setminus(F\cap A)=(E\setminus F)\cap A\in\mathscr{R}_\sigma(\mathscr{R})\cap A, \\
\bigcup_{n=1}^{\infty}(E_n\cap A)=\left(\bigcup_{n=1}^{\infty}E_n\right)\cap A\in\mathscr{R}_\sigma(\mathscr{R})\cap A.
\end{align*}
这就证明了$\mathscr{R}_\sigma(\mathscr{R})\cap A$为$A$上的一个$\sigma$环.

\item {\color{blue}证法一:} 因为$\mathscr{R}\subseteq\mathscr{R}_\sigma(\mathscr{R})$，故$\mathscr{R}\cap A\subseteq\mathscr{R}_\sigma(\mathscr{R})\cap A$. 显然，$\mathscr{R}_\sigma(\mathscr{R})\cap A$为含$\mathscr{R}\cap A$的$\sigma$环，而$\mathscr{R}_\sigma(\mathscr{R}\cap A)$为含$\mathscr{R}\cap A$的最小$\sigma$环，因此
\begin{align*}
\mathscr{R}_\sigma(\mathscr{R}\cap A)\subseteq\mathscr{R}_\sigma(\mathscr{R})\cap A.
\end{align*}
令
\[
\mathscr{F}=\{F\in\mathscr{R}_\sigma(\mathscr{R})\mid F\cap A\in\mathscr{R}_\sigma(\mathscr{R}\cap A)\},
\]
易见，$\mathscr{F}$为$\sigma$环.

由于$\mathscr{R}\subseteq\mathscr{F}$，故$\mathscr{R}_\sigma(\mathscr{R})\subseteq\mathscr{F}$. 于是
\begin{align*}
\mathscr{R}_\sigma(\mathscr{R})\cap A\subseteq\mathscr{F}\cap A\subseteq\mathscr{R}_\sigma(\mathscr{R}\cap A).
\end{align*}
综合上述得到
\begin{align*}
...
{\color{blue}证法二:}
\begin{align*}
\mathscr{R}_\sigma(\mathscr{R})\cap A&=\{\mathscr{R}\text{中至多可数个元素}E_1,E_2,\cdots,E_n,\cdots\text{的至多可数次“$\cup$”、“$\setminus$”运算后所得集与}A\text{的交}\} \\
&=\{\mathscr{R}\cap A\text{中至多可数个元素}E_1\cap A,E_2\cap A,\cdots,E_n\cap A,\cdots\text{的至多可数次“$\cup$”、“$\setminus$”运算后所得的集}\} \\
&=\mathscr{R}_\sigma(\mathscr{R}\cap A).
\end{align*}

\item 当$\mathscr{R}$为代数时，$X\in\mathscr{R}$，从而$A=X\cap A\in\mathscr{R}\cap A\subseteq\mathscr{R}_\sigma(\mathscr{R})\cap A$. 再由(2)知$\mathscr{R}_\sigma(\mathscr{R})\cap A$为$A$上的$\sigma$环，故$\mathscr{R}_\sigma(\mathscr{R}\cap A)$为$A$上的$\sigma$代数.

当$A\in\mathscr{R}$时，$A=A\cap A\in\mathscr{R}\cap A\subseteq\mathscr{R}_\sigma(\mathscr{R})\cap A$. 再由(2)知$\mathscr{R}_\sigma(\mathscr{R})\cap A$为$A$上的$\sigma$环，故$\mathscr{R}_\sigma(\mathscr{R}\cap A)$为$A$上的$\sigma$代数.
\end{enumerate}

\end{proof}

\begin{example}
设$X$为集合，$\mathscr{R}$、$\mathscr{U}$为$X$上的非空集类，$\mathscr{U}$为$X$上的环，且有
\begin{enumerate}[(1)]
\item $\mathscr{U}\supseteq\mathscr{R}$；
\item 当$E_1,E_2,\cdots,E_n,\cdots$为$\mathscr{U}$中的一列互不相交的元素时，$\bigcup_{n=1}^{\infty}E_n\in\mathscr{U}$.
\end{enumerate}
证明：$\mathscr{U}\supseteq\mathscr{R}_\sigma(\mathscr{R})$.
\end{example}
\begin{proof}
$\forall F_n\in\mathscr{U}$，$n\in\mathbb{N}$，令$E_1=F_1$，$E_2=F_2\setminus F_1$，$\cdots$，$E_n=F_n\setminus\bigcup_{i=1}^{n-1}F_i$，则$E_n(n\in\mathbb{N})$互不相交. 又因为$\mathscr{U}$为环，故$E_n\in\mathscr{U}$，$n\in\mathbb{N}$. 于是
\begin{align*}
\bigcup_{n=1}^{\infty}F_n=\bigcup_{n=1}^{\infty}E_n\stackrel{\text{由(2)}}{\subseteq}\mathscr{U}.
\end{align*}
因此，环$\mathscr{U}$为$\sigma$环. 再由(1)知$\mathscr{R}\subseteq\mathscr{U}$，而$\mathscr{R}_\sigma(\mathscr{R})$为含$\mathscr{R}$的最小$\sigma$环，故
\begin{align*}
\mathscr{U}\supseteq\mathscr{R}_\sigma(\mathscr{R}).
\end{align*}

\end{proof}

\begin{example}
设$\mathscr{R}$为$\mathbb{R}^1$上的一个环，$\mathbb{R}^2=\{(x,y)\mid x,y\in\mathbb{R}\}$. 对$\forall E\in\mathscr{R}$，令
\[
\widetilde{E}=\{(x,y)\mid x\in E\}\subseteq\mathbb{R}^2, \quad \widetilde{\mathscr{R}}=\{\widetilde{E}\mid E\in\mathscr{R}\}.
\]
证明：
\begin{enumerate}[(1)]
\item $\widetilde{\mathscr{R}}$为$\mathbb{R}^2$上的一个环.
\item $\mathscr{R}_\sigma(\widetilde{\mathscr{R}})\cap\mathbb{R}^1=\mathscr{R}_\sigma(\widetilde{\mathscr{R}}\cap\mathbb{R}^1)=\mathscr{R}_\sigma(\mathscr{R})$，其中$\mathbb{R}^1=\{(x,0)\mid x\in\mathbb{R}\}$.
\end{enumerate}
换言之，
\[
\mathscr{R}_\sigma(\widetilde{\mathscr{R}})=\{\widetilde{E}\mid E\in\mathscr{R}_\sigma(\mathscr{R})\}, \quad \mathscr{R}_\sigma(\mathscr{R})=\{E\mid \widetilde{E}\in\mathscr{R}_\sigma(\widetilde{\mathscr{R}})\}.
\]
\end{example}
\begin{proof}\begin{enumerate}[(1)]
\item 因为$\widetilde{E}_1=\{(x,y)\mid x\in E_1\}\in\widetilde{\mathscr{R}}$，$\widetilde{E}_2=\{(x,y)\mid x\in E_2\}\in\widetilde{\mathscr{R}}$，故$E_1\in\mathscr{R}$，$E_2\in\mathscr{R}$. 又因$\mathscr{R}$为$\mathbb{R}^1$上的一个环，所以$E_1\cup E_2\in\mathscr{R}$，$E_1\setminus E_2\in\mathscr{R}$. 于是
\begin{align*}
\widetilde{E}_1\cup\widetilde{E}_2=\{(x,y)\mid x\in E_1\}\cup\{(x,y)\mid x\in E_2\}=\{(x,y)\mid x\in E_1\cup E_2\}\in\widetilde{\mathscr{R}}, \\
\widetilde{E}_1\setminus\widetilde{E}_2=\{(x,y)\mid x\in E_1\}\setminus\{(x,y)\mid x\in E_2\}=\{(x,y)\mid x\in E_1\setminus E_2\}\in\widetilde{\mathscr{R}}.
\end{align*}
这就证明了$\widetilde{\mathscr{R}}$为$\mathbb{R}^2$上的一个环.

\item $\mathscr{R} _{\sigma}(\widetilde{\mathscr{R} })\cap \mathbb{R} ^1\xlongequal{\text{\rrefpro{proposition:集合论命题j8oj82r339008jr}{proposition:集合论命题j8oj82r339008jr-3}}}\mathscr{R} _{\sigma}(\widetilde{\mathscr{R} }\cap \mathbb{R} ^1)=\mathscr{R} _{\sigma}(\mathscr{R} ).$
\end{enumerate}
