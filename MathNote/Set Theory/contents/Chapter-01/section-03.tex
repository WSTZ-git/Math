...
\end{align*}
由\hyperref[proposition:可列集的性质(8)]{命题\ref{proposition:可列集的性质}\ref{proposition:可列集的性质(8)}}知 $P_n$ 可列. 又 $\mathbb{P} = \bigcup_{n = 0}^{\infty} P_n$, 由可列集性质知 $\mathbb{P}$ 可列.
...
\begin{theorem}[无最大基数定理]\label{theorem:无最大基数定理2}
