...
\end{align*}
易知, $f$ 是从 $\mathcal{F}_{\mathbb{N}}$ 到 $(0, 1]$ 的单射, 故\refpro{definition:集合的基数大小关系}可知$\overline{\overline{\mathcal{F}_{\mathbb{N}}}} \leqslant slant \overline{\overline{(0, 1]}}$.
...
\end{align*}
易知, $g$ 是从 $(0, 1]$ 到 $\mathcal{F}_{\mathbb{N}}$ 的单射, 故由\refpro{definition:集合的基数大小关系}可知$\overline{\overline{(0, 1]}} \leqslant slant \overline{\overline{\mathcal{F}_{\mathbb{N}}}}$.
