...
\begin{align*}
a_0 + \frac{a_1}{p} + \dots + \frac{a_{n-1}}{p^{n-1}} + \frac{a_n}{p^n} \leqslant x
\end{align*}
的最大整数。证明：
\begin{enumerate}[(1)]
\item 对任意 $k \in \mathbb{N}_+$，$0 \leqslant a_k \leqslant p-1$。
\item 若记 $r_n = a_0 + \frac{a_1}{p} + \dots + \frac{a_{n-1}}{p^{n-1}} + \frac{a_n}{p^n}, n \in \mathbb{N}_+$，则 $\sup\limits_{n} r_n = x$。
\end{enumerate}
\end{example}
\begin{proof}
\begin{enumerate}[(1)]
