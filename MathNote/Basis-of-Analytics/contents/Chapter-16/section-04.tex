...
那么，
\begin{align}
\lim\limits_{t\to x}\phi_n(t) = f'_n(x) \quad (n=1,2,3,\dots).
...
由\refthe{theorem:开区间上的连续函数是一致连续的充要条件111}及\(f \in C^1(\mathbb{R})\)可知\(f'\)内闭一致连续性，于是对任何\(\varepsilon > 0\)，存在\(\delta > 0\)使得当\(x \in [a, b]\)，\(t \in [0, \delta]\)，我们有
\[
