...
\\
\iff \int_{2a-b}^b{|f(x)|^2\mathrm{d}x}-\frac{1}{2(b-a)}\left( \int_{2a-b}^b{f(x)\mathrm{d}x} \right) ^2\leqslant \frac{(b-a)^2}{\pi ^2}\int_{2b-a}^b{|f^{\prime}(x)|^2\mathrm{d}x}.
\end{gather*}
利用对称性，就有
\begin{align*}
...
\\
\Longleftrightarrow \int_a^b{|f(x)|^2\mathrm{d}x}-\frac{1}{b-a}\left( \int_a^b{f(x)\mathrm{d}x} \right) ^2\leqslant \frac{(b-a)^2}{4\pi ^2}\int_a^b{|f^{\prime}(x)|^2\mathrm{d}x},
\end{gather*}
等号成立条件是
\begin{align*}
