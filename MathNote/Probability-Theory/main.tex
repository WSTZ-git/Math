...
\externaldocument[Analytic-Geometry-]{../Analytic-Geometry/main}
...
\externaldocument[Differential-Geometry-]{../Differential-Geometry/main}
...
若随机变量序列$\left\{ X_n,n\geqslant 1 \right\}$满足Markov条件,即
\begin{align*}
