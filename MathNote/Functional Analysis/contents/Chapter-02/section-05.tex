...
\end{remark}
\begin{proof}
对任意$g\in L^q[0,1]$，由\hyperref[Real Analysis-theorem:实变函数--Hölder不等式]{Hölder不等式}
\begin{align*}
...
是有界的。由\hyperref[Complex Analysis-theorem:Bolzano-Weierstrass定理]{Bolzano-Weierstrass定理}和对角线法则,存在子列$\{f_{n_k}\}_{k=1}^{\infty}$，使得对$\forall m\in\mathbb{N}$，
