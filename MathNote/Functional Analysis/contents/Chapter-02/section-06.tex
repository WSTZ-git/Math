...
\begin{proposition}
设$(\mathscr{X},(\cdot,\cdot))$为Hilbert空间，$U\in\mathscr{L}(\mathscr{X})$为酉算子，则$\sigma(U)\subseteq S^1=\{e^{\mathrm{i}\theta }\mid\theta\in[0,2\pi]\}$，且$\sigma_r(U)=\varnothing $。
\end{proposition}
\begin{proof}
