...
\end{align}
根据特征函数系 $\{\sin(n\pi x/l)\}$ 在 $[0,l]$ 上的完备性，$\varphi$ 和 $\psi$ 可展开为 Fourier 正弦级数：
\begin{align*}
...
\end{align*}
这与 \eqref{eq:w-g} 矛盾，故 $w\equiv 0$。唯一性获证。\end{proof}
...
\end{align*}
移项即得 \eqref{eq:weak-energy}。\end{proof}
...
\end{align*}
即 $u$ 满足广义解定义。存在性得证。唯一性已由定理给出。\end{proof}
