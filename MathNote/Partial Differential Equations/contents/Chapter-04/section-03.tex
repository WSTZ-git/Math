...
对于 $n\ge 1$，方程 $T''+a^2\lambda_n T=0$ 的通解为
\begin{align*}
...
u_n(x,t)=\left(A_n\cos\frac{na\pi}{l}t+B_n\sin\frac{na\pi}{l}t\right)\cos\frac{n\pi}{l}x,\quad n\ge 1.
\end{align*}
由叠加原理，构造
\begin{align*}
u(x,t)=\frac{A_0+B_0t}{2}+\sum_{n=1}^{\infty}\left(A_n\cos\frac{na\pi}{l}t+B_n\sin\frac{na\pi}{l}t\right)\cos\frac{n\pi}{l}x.
...
常数 $1$ 的余弦展开只有常数项，故
\begin{align*}
\frac{A_0}{2}=1,\quad A_n=0\ (n\ge 1),\qquad
\frac{B_0}{2}=1,\quad B_n=0\ (n\ge 1).
\end{align*}
因此 $A_0=2$，$B_0=2$，$A_n=B_n=0$（$n\ge 1$）.
代入得
\begin{align*}
...
V_n''(t)+n^2V_n(t)=0\quad(n\ge 1).
\end{align*}
由初值条件 $v(x,0)=0$，$v_t(x,0)=-\Phi(x)$，得
\begin{align*}
V_0(0)=0,\qquad V_n(0)=0\quad(n\ge 1),
\end{align*}
\begin{align*}
...
\end{align*}
解 $V_n$（$n\ge 1$）：$V_n''+n^2V_n=0$，且 $V_n(0)=0$，故
\begin{align*}
