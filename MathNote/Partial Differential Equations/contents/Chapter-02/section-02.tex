...
且上述极限关于 $y$ 一致收敛。于是
\begin{align*}
\frac{\partial u}{\partial x_i} = \int_{\mathbb{R}^n} \Gamma(y) \frac{\partial}{\partial x_i} f(x-y)\,\mathrm{d}y \quad (i=1,2,\dots,n).
\end{align*}
同理我们得到
\begin{align*}
\frac{\partial^2 u}{\partial x_i\partial x_j} = \int_{\mathbb{R}^n} \Gamma(y) \frac{\partial^2}{\partial x_i\partial x_j} f(x-y)\,\mathrm{d}y \quad (i,j=1,2,\dots,n).
\end{align*}
...
对于 $x=(x_1,\dots,x_n)\in\mathbb{R}_+^n$，记它关于边界 $\partial\mathbb{R}_+^n=\mathbb{R}^{n-1}$ 的反射点为 $\tilde{x}=(x_1,\dots,x_{n-1},-x_n)$。取
\begin{align*}
...
\end{align*}
且边界 $\partial\mathbb{R}_+^n$ 的单位外法向量 $n=(0,\dots,0,-1)$。因此，当 $x\in\mathbb{R}_+^n$，$y\in\partial\mathbb{R}_+^n$ 时，有
\begin{align}
...
&= -\frac{y_i(1-|x|^2)}{n\alpha(n)|y-x|^n},\quad i=1,2,\dots,n.
\end{align*}
由于单位球 $B(0,1)$ 上的单位外法向量 $n=(y_1,y_2,\dots,y_n)$ 且
\begin{align*}
