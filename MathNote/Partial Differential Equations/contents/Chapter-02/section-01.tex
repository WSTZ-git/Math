...
\end{align*}
这与\eqref{eq::HOUFHwie22312}式矛盾!故$\Delta u(x)=0.$(也可由积分中值定理再令$r\to 0^+$得到)
\end{proof}
...
\begin{align*}
u(x)&=\int_{B\left( x,2r \right)}{u\left( z \right) \mathrm{d}z}=\frac{1}{\left| B\left( x,2r \right) \right|}\int_{B\left( x,2r \right)}{u\left( z \right) \mathrm{d}z}
\\
