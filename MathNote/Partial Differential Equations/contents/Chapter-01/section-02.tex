...
\end{pmatrix},
\end{align*}
且 $b_i(x)\equiv 0$ $(i=1,2,\dots,n)$，$c(x)\equiv 0$；对于热方程 \eqref{eq:heat}，取 $m=n+1$，$t=x_{n+1}$，则
\begin{align*}
A = \begin{pmatrix}
-a^2 & \cdots & 0 & 0 \\
\vdots & \ddots & 0 & \vdots \\
...
\end{pmatrix},
\end{align*}
且 $b_i(x)\equiv 0$ $(i=1,2,\dots,n)$，$b_{n+1}(x)\equiv 1$，$c(x)\equiv 0$；对于波动方程 \eqref{eq:wave}，取 $m=n+1$，$t=x_{n+1}$，则
\begin{align*}
A = \begin{pmatrix}
-a^2 & \cdots & 0 & 0 \\
\vdots & \ddots & 0 & \vdots \\
