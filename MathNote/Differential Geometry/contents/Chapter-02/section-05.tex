...
\begin{example}
证明螺旋面$\boldsymbol{r}=(u\cos v,u\sin v,u+v)$与旋转双曲面$\boldsymbol{r}=(\rho\cos\theta,\rho\sin\theta,\sqrt{\rho^2-1})\,(\rho\geqslant1,0\leqslant\theta\leqslant2\pi)$之间可建立保长对应。\begin{solution}
计算螺旋面的第一基本形式：
\begin{align*}
